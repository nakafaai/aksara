...
it("rejects attention fillers and formulaic utility transitions", () => {
  const samples = {
...
it("rejects personified methods and audience understanding claims", () => {
  const samples = {
...
it("rejects bare claims that a result is clear", () => {
  const samples = {
...
it("rejects complete flow and tool for reading metaphors", () => {
  const samples = {
...
it("rejects motion reading and observer seat metaphors", () => {
  const samples = {
...
it("rejects formulas personified as information providers", () => {
  const samples = {
...
it("rejects Indonesian important to understand fillers", () => {
  const source = [
...
it("rejects questions assigned to abstract lesson concepts", () => {
  const failures = {
...
it("rejects empty example prefaces and unsupported evaluation labels", () => {
  const failures = {

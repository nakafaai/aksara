...
test("rejects vague claims that a result is easy to see", () => {
  const samples = {
...
test("rejects personified teaching aids and vague metawriting", () => {
  const samples = {
    de: [
...
test("rejects generic importance headings tables and attention labels", () => {
  const samples = {
    de: [
...
test("rejects vague utility labels instead of the actual operation", () => {
  const samples = {
    de: [
...
test("rejects unsupported method praise and stiff process labels", () => {
  const samples = {
    de: [
...
test("keeps comparisons that name the quantity mechanism or prevented error", () => {
  const samples = {
...
test("rejects repeated mechanical conclusion and explanation openers", () => {
  const samples = {
    de: [
...
test("allows two conclusion openers when each step needs one", () => {
  const samples = {
...
test("rejects generic real world labels and picture transformations", () => {
  const samples = {

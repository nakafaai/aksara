...
test("rejects abstract subjects that read an idea or state", () => {
  const samples = {
...
test("rejects formulaic claims about making ideas visible", () => {
  const samples = {
...
test("rejects visible abstract ideas while preserving visible objects", () => {
...
test("rejects invisible original values after grouping", () => {
  const vague = {
...
test("rejects abstract visibility claims and preserves concrete visibility", () => {
  const samples = {
...
test("rejects formulaic observation filler", () => {
  const samples = {
...
test("rejects passive observation filler", () => {
  const samples = {
...
test("rejects generic observed openers but preserves an observation condition", () => {
  const samples = {
...
test("rejects stock visual handoffs and preserves named graph evidence", () => {
  const samples = {

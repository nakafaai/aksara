...
test("accepts the same teaching structure in natural locale prose", () => {
  const siblings = [
    document("id", "## Langkah\n\n1. Baca soal\n2. Hitung hasil\n"),
    document(
      "en",
...
test("reports a list flattened in one locale", () => {
  const siblings = [
    document("id", "## Langkah\n\n1. Baca soal\n2. Hitung hasil\n"),
    document(
      "en",
...
test("tracks table shape and learner-facing flow components", () => {
...
test("allows inline math counts to follow the grammar of each locale", () => {
  const siblings = [

...
test("rejects empty utility claims and decorative code metaphors", () => {
  const samples = {
...
test("rejects important role labels without the actual mechanism", () => {
  const samples = {
...
test("rejects empty big idea labels", () => {
  const samples = {
...
test("rejects causative claims that only label something useful", () => {
  const samples = {
...
test("rejects importance labels placed before the actual reason", () => {
  const samples = {
...
test("rejects stock usefulness and more direct way transitions", () => {
  const samples = {
...
test("rejects empty lesson choreography before the actual explanation", () => {
  const samples = {
    de: [
...
test("rejects a section focus announcement and preserves the direct relation", () => {
  const samples = {
...
test("rejects stock rhetorical openers that delay the claim", () => {
  const samples = {
...
test("rejects empty usefulness questions before the reason", () => {
  const samples = {
...
test("rejects rhetorical not only contrasts but keeps factual negation", () => {
  const samples = {
...
test("rejects a vague transformation of uncertainty into usefulness", () => {
  const samples = {

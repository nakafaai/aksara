...
export const CLAIM_VOICE_RULES = [
  ...
  },
  {
    ...
    patterns: {
      ...
      en: /\b(?:very important|important (?:advantage|application|characteristic|chemical|component|concept|condition|consequence|definition|difference|element|form|information|note|part|point|properties|property|purpose|relationship|result|rule|setting|starting point|type|use)|(?:one|two|three|four|several|many|some) important|interesting (?:pattern|properties|result|results)|elegant block form|most intuitive way|remarkably tight)\b/iu,

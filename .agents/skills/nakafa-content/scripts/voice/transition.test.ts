...
it("rejects generic easiest way and good news transitions", () => {
  const samples = {
...
it("rejects most basic way claims", () => {
  const samples = {
...
it("rejects fastest way claims without a measured comparison", () => {
  const samples = {
...
it("rejects stock transitions and vague procedural praise", () => {
  const samples = {
    de: [
...
it("rejects empty superlatives before a foundational result", () => {
  const samples = {
...
it("rejects abstract foundation transitions and preserves direct use", () => {
  const samples = {
...
it("rejects vague paths and visual ways instead of named operations", () => {
  const samples = {
...
it("rejects abstract efficient paths", () => {
  const samples = {

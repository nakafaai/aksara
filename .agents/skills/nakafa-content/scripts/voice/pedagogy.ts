...
export const PEDAGOGY_VOICE_RULES = [
  ...
  },
  {
    ...
    patterns: {
      ...
      id: /\bsubbagian\b|\bbagian (?:di bawah ini|berikutnya|berikut|selanjutnya|di atas)\b|\bsetiap pembahasan\b|\bdengan urutan berikut\s*[.!?]|\bdi sepanjang pelajaran ini\b/iu,
    },
  },
  {
    id: "german-bare-im-folgenden",
    patterns: {
      de: /\bim Folgenden\b/u,
    },
  },

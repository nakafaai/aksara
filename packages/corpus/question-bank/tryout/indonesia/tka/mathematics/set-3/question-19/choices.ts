...
const choices: QuestionChoices = {
  de: [
    ...
    {
      label: "$$x \\leq \\frac{2}{3}$$ oder $$x \\geq 1$$",
      value: false,
    },
    {
      label: "$$\\frac{1}{2} < x \\leq \\frac{2}{3}$$ oder $$1 \\leq x < 2$$",
      value: true,
    },
    {
      label:
        "$$\\frac{1}{2} \\leq x \\leq \\frac{2}{3}$$ oder $$1 \\leq x \\leq 2$$",
      value: false,
    },
    {
      label: "$$x \\leq \\frac{1}{2}$$ oder $$x > 2$$",
      value: false,
    },
  ],
  en: [

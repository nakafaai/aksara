      ...
      options: [
        {
          isCorrect: false,
          label:
            "in this passage, an assumption that never needs to be examined in a food pantry at closing time",
        },
        {
          isCorrect: false,
          label:
        ...
        },
        {
          isCorrect: true,
          label:
            "an object or action that recurs and reinforces a central idea",
        },
        {
          isCorrect: false,
          label:

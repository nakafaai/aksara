      ...
      options: [
        {
          isCorrect: false,
          label:
            "in this passage, an assumption that never needs to be examined in a youth translation club",
        },
        {
          isCorrect: true,
          label:
            "the social meaning and level of formality carried by a word or phrase",
        },
        {
          isCorrect: false,
          label:

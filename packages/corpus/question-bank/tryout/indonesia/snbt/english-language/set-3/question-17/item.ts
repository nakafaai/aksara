    ...
    en: {
      ...
      options: [
        ...
        },
        {
          isCorrect: true,
          label:
            "Rotating the recurring map and retracing the route changes it from a staff-facing reference into a passenger-facing guide, a shift confirmed when the child finds the platform.",
        },
        {
          isCorrect: false,
          label:

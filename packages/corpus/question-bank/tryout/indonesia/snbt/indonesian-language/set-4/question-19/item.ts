      ...
      options: [
        {
          isCorrect: false,
          label:
            "dalam bacaan, berarti dugaan yang tidak perlu diperiksa pada tur bangunan bersejarah",
        },
        {
          isCorrect: false,
          label:
        ...
        },
        {
          isCorrect: true,
          label:
            "penafsiran yang dibangun dengan membandingkan lebih dari satu jenis bukti",
        },
        {
          isCorrect: false,
          label:

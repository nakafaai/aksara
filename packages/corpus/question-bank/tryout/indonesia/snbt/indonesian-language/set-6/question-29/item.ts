      ...
      options: [
        {
          isCorrect: false,
          label:
            "dalam bacaan, berarti dugaan yang tidak perlu diperiksa pada ruang penyimpanan karya seni pada malam hari",
        },
        {
          isCorrect: false,
          label:
        ...
        },
        {
          isCorrect: true,
          label:
            "sudut pandang yang membatasi pembaca pada pikiran dan pengamatan satu tokoh",
        },
        {
          isCorrect: false,
          label:

    ...
    id: {
      ...
      options: [
        ...
        },
        {
          isCorrect: true,
          label:
            "Definisi *dukungan sebaya* menjelaskan hubungan yang relatif setara antarpasangan belajar, sehingga kartu tujuan dibahas dan direvisi dengan mempertimbangkan masukan peserta.",
        },
        {
          isCorrect: false,
          label:

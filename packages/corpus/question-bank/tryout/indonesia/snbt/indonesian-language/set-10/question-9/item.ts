      ...
      options: [
        {
          isCorrect: false,
          label:
            "dalam bacaan, berarti dugaan yang tidak perlu diperiksa pada kolom infiltrasi dari tiga jenis tanah",
        },
        {
          isCorrect: false,
          label:
        ...
        {
          isCorrect: true,
          label: "proses masuknya air dari permukaan ke dalam tanah",
        },
        {
          isCorrect: false,
          label:

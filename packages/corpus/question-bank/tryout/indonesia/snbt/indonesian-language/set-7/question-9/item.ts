      ...
      options: [
        {
          isCorrect: false,
          label:
            "dalam bacaan, berarti dugaan yang tidak perlu diperiksa pada simulasi populasi dengan keping warna",
        },
        {
          isCorrect: false,
          label:
        ...
        },
        {
          isCorrect: true,
          label:
            "jumlah maksimum individu yang dapat didukung lingkungan secara berkelanjutan",
        },
      ],
    },
  },

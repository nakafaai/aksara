  ...
  responses: {
    de: {
      ...
      options: [
        ...
        {
          isCorrect: true,
          label: "steht in direktem Zusammenhang mit dem behandelten Thema",
        },
        {
          isCorrect: false,
    ...
    en: {
      ...
      options: [
        ...
        {
          isCorrect: true,
          label: "directly connected to the issue being discussed",
        },
        {
          isCorrect: false,
    ...
    id: {
      ...
      options: [
        ...
        {
          isCorrect: true,
          label: "berkaitan langsung dengan masalah yang dibahas",
        },
        {
          isCorrect: false,

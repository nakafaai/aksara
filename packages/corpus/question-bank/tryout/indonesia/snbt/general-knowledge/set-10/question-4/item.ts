  ...
  responses: {
    de: {
      ...
      options: [
        ...
        {
          isCorrect: true,
          label: "bis zur Prüfung weiterer Belege nur zeitweise geltend",
        },
        {
          isCorrect: false,
    ...
    en: {
      ...
      options: [
        ...
        {
          isCorrect: true,
          label: "accepted temporarily until further evidence is examined",
        },
        {
          isCorrect: false,
    ...
    id: {
      ...
      options: [
        ...
        {
          isCorrect: true,
          label: "diterima sementara sampai bukti tambahan diperiksa",
        },
        {
          isCorrect: false,

    ...
    en: {
      ...
      options: [
        ...
        },
        {
          isCorrect: false,
          label:
            "the team's followup study of a form with structured location choices in this setting (lost-property service)",
        },
        {
          isCorrect: false,
          label:
      ...
      options: [
        {
          isCorrect: false,
          label:
            "kerjasama tim dalam uji formulir dengan pilihan lokasi yang terstruktur di layanan pencarian barang hilang",
        },
        {
          isCorrect: false,
          label:

      ...
      options: [
        {
          isCorrect: false,
          label:
            "eine Wirksamkeitsanalise zur geprüften Änderung im Kontext „Informationsstelle im Stadtpark“",
        },
        {
          isCorrect: false,
          label:
      ...
      options: [
        {
          isCorrect: false,
          label:
            "an analyse of the effectiveness of small maps showing walking times in this setting (city park information desk)",
        },
        {
          isCorrect: false,
          label:
      ...
      options: [
        {
          isCorrect: false,
          label:
            "analisa efektivitas peta kecil yang menampilkan waktu tempuh di pusat informasi taman kota",
        },
        {
          isCorrect: false,
          label:

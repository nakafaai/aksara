...
const choices: QuestionChoices = {
  ...
  en: [
    ...
    { label: "Only $$(1)$$ and $$(3)$$ are correct.", value: false },
    { label: "Only $$(2)$$ and $$(4)$$ are correct.", value: true },
  ...
  id: [
    ...
    { label: "Hanya $$(1)$$ dan $$(3)$$ yang benar.", value: false },
    { label: "Hanya $$(2)$$ dan $$(4)$$ yang benar.", value: true },

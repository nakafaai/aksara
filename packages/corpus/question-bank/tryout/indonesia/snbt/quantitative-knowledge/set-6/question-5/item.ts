  ...
  responses: {
    ...
    en: {
      ...
      options: [
        ...
        { isCorrect: true, label: "Only $$(1)$$ and $$(3)$$ are correct." },
        { isCorrect: false, label: "Only $$(2)$$ and $$(4)$$ are correct." },
    ...
    id: {
      ...
      options: [
        ...
        { isCorrect: true, label: "Hanya $$(1)$$ dan $$(3)$$ yang benar." },
        { isCorrect: false, label: "Hanya $$(2)$$ dan $$(4)$$ yang benar." },

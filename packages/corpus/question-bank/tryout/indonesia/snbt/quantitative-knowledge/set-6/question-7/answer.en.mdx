...
For a <InlineMath math="2 \times 2" /> matrix <InlineMath math="\begin{pmatrix} a & b \\ c & d \end{pmatrix}" />, the determinant is <InlineMath math="ad-bc" />. We use this rule on both sides.

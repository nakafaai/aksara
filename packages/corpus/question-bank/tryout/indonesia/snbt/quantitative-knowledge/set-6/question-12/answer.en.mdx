...
Consider the **small triangle at the bottom**. The sum of angles in a triangle is <InlineMath math="180^\circ" />. Its top vertex angle is <InlineMath math="100^\circ" />. So, the sum of the two base angles is:

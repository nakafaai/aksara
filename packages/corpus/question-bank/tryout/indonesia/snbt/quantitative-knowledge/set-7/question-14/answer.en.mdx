...
The function <InlineMath math="g(x) = 2^x - 1" /> is an exponential function rather than a linear function. A linear function has the general form <InlineMath math="y = mx + c" />, whereas this is an exponential form. Therefore, statement <InlineMath math="(1)" /> is **incorrect**.

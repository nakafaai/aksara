...
1. <InlineMath math="g(x)" /> is a linear function with a gradient of <InlineMath math="2" />.
...
<Set7Question14Graph title="Function Graph" description={<>Graph of functions <InlineMath math="f(x)" /> and <InlineMath math="g(x)" />.</>} />

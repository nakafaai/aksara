...
Pernyataan <InlineMath math="(2)" /> menyebutkan bahwa <InlineMath math="PC" /> membagi dua <InlineMath math="\angle ACB" /> dan memotong sisi <InlineMath math="AB" /> di titik <InlineMath math="P" />.

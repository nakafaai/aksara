  ...
  responses: {
    ...
    en: {
      ...
      options: [
        ...
        { isCorrect: true, label: "$$(1)$$ and $$(3)$$ are correct." },
        { isCorrect: false, label: "$$(2)$$ and $$(4)$$ are correct." },
    ...
    id: {
      ...
      options: [
        ...
        { isCorrect: true, label: "$$(1)$$ dan $$(3)$$ benar." },
        { isCorrect: false, label: "$$(2)$$ dan $$(4)$$ benar." },

...
A code consists of <InlineMath math="2" /> vowels and <InlineMath math="2" /> digits in an alternating sequence, starting with a letter. The formation of the code follows these rules: The available vowels are <InlineMath math="\{A,I,U,E,O\}" />.

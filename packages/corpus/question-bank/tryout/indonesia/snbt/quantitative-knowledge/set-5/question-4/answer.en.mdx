...
Compare the **simplified algebraic expressions**. Since <InlineMath math="0<x<1" />, we have <InlineMath math="1-x^3>0" />, so the denominator factor can be cancelled.
...
We calculate the **second quantity minus the first**:

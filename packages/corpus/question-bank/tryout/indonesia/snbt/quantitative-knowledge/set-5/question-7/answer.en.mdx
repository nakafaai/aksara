...
We are given the function <InlineMath math="f(x) = 2x + 3" /> and the equation <InlineMath math="3(f(x))^2 = f(x) + 7" />.
We want to find the **sum of both roots**, which is <InlineMath math="x_1 + x_2" />.

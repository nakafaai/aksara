...
The given number series is <InlineMath math="72, x, 65, 60, 30, 27, y, 8" />. Analyze the pattern:
...
1. subtracting the decreasing odd numbers <InlineMath math="7, 5, 3, 1" /> and
2. dividing by the increasing integers <InlineMath math="1, 2, 3" />.

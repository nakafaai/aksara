...
Let the **two equal natural numbers** being added be <InlineMath math="x" />.
...
The data are **already sorted**. Since the number of data points <InlineMath math="n = 9" /> (odd), the median is the <InlineMath math="\frac{9+1}{2} = 5" />-th data point.

<BlockMath math="m=8" />

#### Calculating the First Quantity

The value of <InlineMath math="P" /> is defined as the **new median minus the new mean**.

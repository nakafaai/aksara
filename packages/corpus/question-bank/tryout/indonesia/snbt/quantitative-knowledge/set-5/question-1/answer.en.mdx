...
**Add 18 to both sides** to isolate the third term:
...
We can directly find **twice the fourth term**, <InlineMath math="2a_4" /> (since the question asks for <InlineMath math="a_3 + 2a_4" />):

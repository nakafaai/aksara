...
1. **Statement (1)**: The graph intersects the <InlineMath math="y" />-axis at <InlineMath math="4" /> and <InlineMath math="-2" />. So the intersection points are <InlineMath math="(0, 4)" /> and <InlineMath math="(0, -2)" />. Statement (1) is **CORRECT**.

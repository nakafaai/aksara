...
Consider the quadratic function <InlineMath math="y = -2x^2 - 5x + 7" />. We need to find the **equation of the tangent line** at the point with abscissa <InlineMath math="x_1 = 2" />.

First, we find the **ordinate of the tangent point** (<InlineMath math="y_1" />) by substituting <InlineMath math="x_1 = 2" /> into the curve equation:

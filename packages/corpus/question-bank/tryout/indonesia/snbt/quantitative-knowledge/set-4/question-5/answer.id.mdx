...
Grafik memotong sumbu <InlineMath math="y" /> di titik <InlineMath math="(0, 3)" /> dan <InlineMath math="(0, -1)" />. Pernyataan <InlineMath math="(1)" /> menyebut titik <InlineMath math="(0, 2)" />, sehingga **salah**.

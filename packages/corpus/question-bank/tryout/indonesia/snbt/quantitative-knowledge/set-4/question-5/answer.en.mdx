...
So statement <InlineMath math="(1)" /> is **false**, because the graph intersects the <InlineMath math="y" />-axis at <InlineMath math="(0, 3)" /> and <InlineMath math="(0, -1)" /> rather than at <InlineMath math="(0, 2)" />.

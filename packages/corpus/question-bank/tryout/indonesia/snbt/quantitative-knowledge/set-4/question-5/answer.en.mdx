...
The graph intersects the <InlineMath math="y" />-axis at <InlineMath math="(0, 3)" /> and <InlineMath math="(0, -1)" />. Statement <InlineMath math="(1)" /> gives <InlineMath math="(0, 2)" />, so it is **false**.

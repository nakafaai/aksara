...
The length <InlineMath math="EF" /> is the distance from the center of the circle to side <InlineMath math="AD" />.
...
After finding the radius <InlineMath math="r = 15 \text{ cm}" />, we calculate the **circle area** by squaring the radius:

...
Kita akan mencari jari-jari lingkaran (<InlineMath math="r" />) dengan menggunakan **teorema Pythagoras pada segitiga siku-siku** <InlineMath math="\triangle AEF" />.
...
Setelah mengetahui jari-jari lingkaran <InlineMath math="r = 15 \text{ cm}" />, kita menghitung **luas lingkaran** dengan menguadratkan jari-jari:

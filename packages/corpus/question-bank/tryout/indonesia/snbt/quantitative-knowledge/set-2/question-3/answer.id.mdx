...
Karena <InlineMath math="D > 0" />, maka fungsi <InlineMath math="g" /> memotong sumbu-<InlineMath math="x" /> di **dua titik berbeda** dan bukan satu titik.
...
Pernyataan <InlineMath math="(3)" /> **Salah** (seharusnya dikurang <InlineMath math="\frac{5}{2}" /> dan bukan ditambah).

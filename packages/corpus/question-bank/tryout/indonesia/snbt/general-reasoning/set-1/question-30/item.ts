  ...
  responses: {
    ...
    en: {
      ...
      options: [
        ...
        { isCorrect: false, label: [{ kind: "text", text: "Class C" }] },
        { isCorrect: true, label: [{ kind: "text", text: "Class D" }] },
    ...
    id: {
      ...
      options: [
        ...
        { isCorrect: false, label: [{ kind: "text", text: "Kelas C" }] },
        { isCorrect: true, label: [{ kind: "text", text: "Kelas D" }] },

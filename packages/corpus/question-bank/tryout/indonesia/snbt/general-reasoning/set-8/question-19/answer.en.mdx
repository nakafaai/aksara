...
The visitor data for tourist spot <InlineMath math="\text{A}" /> over five days is: <InlineMath math="41, 44, 49, 52, 57" />. Observe the difference between terms:
...
The visitor data for zoo <InlineMath math="\text{B}" /> over five days is: <InlineMath math="110, 115, 125, 130, 140" />. Observe the difference between terms:
...
Therefore, tourist attraction <InlineMath math="\text{A}" /> receives <InlineMath math="60" /> visitors and zoo <InlineMath math="\text{B}" /> receives <InlineMath math="145" /> visitors on the sixth day.

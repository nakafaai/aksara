...
const item: QuestionItem = {
  responses: {
    de: {
      kind: "single-choice",
      options: [
        { isCorrect: false, label: "Jeder Pausensnack ist unsicher" },
        {
          isCorrect: false,
    ...
    en: {
      kind: "single-choice",
      options: [
        { isCorrect: false, label: "Every school snack is unsafe" },
        {
          isCorrect: false,
    ...
    id: {
      kind: "single-choice",
      options: [
        { isCorrect: false, label: "Semua jajanan sekolah tidak aman" },
        {
          isCorrect: false,

...
const item: QuestionItem = {
  responses: {
    de: {
      kind: "single-choice",
      options: [
        { isCorrect: false, label: "Die Art ist nur in Papua heimisch" },
        {
          isCorrect: false,
    ...
    en: {
      kind: "single-choice",
      options: [
        { isCorrect: false, label: "The species is native only to Papua" },
        {
          isCorrect: false,
    ...
    id: {
      kind: "single-choice",
      options: [
        { isCorrect: false, label: "Spesies ini hanya berasal dari Papua" },
        {
          isCorrect: false,
          label:
        ...
        { isCorrect: false, label: "Spesies ini merupakan herba, bukan pohon" },
      ],
    },
  },
};

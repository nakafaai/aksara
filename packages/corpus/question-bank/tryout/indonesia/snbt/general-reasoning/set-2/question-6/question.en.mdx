...
<Set2Question5SalesChart
  description={<> Sales of shirts, pants, and suits from <InlineMath math="2011" /> to <InlineMath math="2015" />. </>}
...
Assume that each series continues the shortest repeating pattern shown by its year-to-year changes. Which prediction for <InlineMath math="2016" /> is incorrect?

...
const item: QuestionItem = {
  responses: {
    ...
    en: {
      kind: "single-choice",
      options: [
        { isCorrect: false, label: "Pants sales are $$10$$ fewer than shirts" },
        { isCorrect: false, label: "Suits sales are $$35$$ more than pants" },
        {
          isCorrect: true,
          label:
            "The combined number of shirts and pants sold is less than $$70$$",
        },
        { isCorrect: false, label: "Shirts sales are $$10$$ more than pants" },
        { isCorrect: false, label: "Pants sales are $$35$$ less than suits" },
      ],
    },
    id: {
      kind: "single-choice",

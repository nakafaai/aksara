  ...
  responses: {
    ...
    en: {
      ...
      options: [
        ...
        { isCorrect: true, label: [{ kind: "text", text: "Division C" }] },
        { isCorrect: false, label: [{ kind: "text", text: "Division D" }] },
    ...
    id: {
      ...
      options: [
        ...
        { isCorrect: true, label: [{ kind: "text", text: "Divisi C" }] },
        { isCorrect: false, label: [{ kind: "text", text: "Divisi D" }] },

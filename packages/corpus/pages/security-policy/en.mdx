...
Operational error reports contain sanitized stack frames and bounded technical context without a user, account, or product-analytics identifier. Optional product-usage events are separate and require an effective analytics consent decision.

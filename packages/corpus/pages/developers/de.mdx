...
Diese öffentlichen Schnittstellen wurden live gegen den Nakafa-Commit [`927d7f681a43acb205d8abcbd63101a8ecd31b41`](https://github.com/nakafaai/nakafa.com/commit/927d7f681a43acb205d8abcbd63101a8ecd31b41) verifiziert: REST-Index, OpenAPI-Vertrag und MCP-Endpunkt liefern dieselbe Release-Identität, und `@nakafa/cli@0.1.1` ist über npm mit überprüfbarer Herkunft verfügbar.

In dieser Revision besitzt [`api.ts`](https://github.com/nakafaai/nakafa.com/blob/927d7f681a43acb205d8abcbd63101a8ecd31b41/packages/backend/convex/routes/agent/api.ts) REST, [`route.ts`](https://github.com/nakafaai/nakafa.com/blob/927d7f681a43acb205d8abcbd63101a8ecd31b41/packages/backend/convex/routes/agent/mcp/route.ts) MCP, [`document.ts`](https://github.com/nakafaai/nakafa.com/blob/927d7f681a43acb205d8abcbd63101a8ecd31b41/packages/backend/agent/openapi/document.ts) erzeugt OpenAPI und [`program.ts`](https://github.com/nakafaai/nakafa.com/blob/927d7f681a43acb205d8abcbd63101a8ecd31b41/packages/cli/src/program.ts) besitzt die CLI-Befehlsoberfläche.
...
Die Suche liefert standardmäßig 10 Ergebnisse und akzeptiert höchstens 10 Ergebnisse pro Anfrage. Das Suchfenster enthält höchstens 10 Ergebnisse, mit `offset` von 0 bis 9. Bei einem kleineren `limit` zeigen `has_more` und `next_offset` die nächste Seite innerhalb dieses Fensters an. Clients sollten höchstens 120 Anfragen pro 60 Sekunden von einer IP einplanen und HTTP-429-Antworten mit einem Backoff behandeln.

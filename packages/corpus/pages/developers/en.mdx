...
The official Node 24 package is `nakafa-cli`, with the executable `nakafa`. It calls the public REST API and prints compact JSON by default. Add `--pretty` for readable output or `--api-base` when verifying an isolated deployment.

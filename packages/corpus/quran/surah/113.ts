export const quranSurah113 = {
  ...
  verses: [
    {
      audio: {
        primary: "https://cdn.alquran.cloud/media/audio/ayah/ar.alafasy/6226",
        secondary: [
          "https://cdn.islamic.network/quran/audio/128/ar.alafasy/6226.mp3",
          "https://cdn.islamic.network/quran/audio/64/ar.alafasy/6226.mp3",
        ],
      },
      meta: {
        hizbQuarter: 240,
      ...
      tafsir: {
        id: {
          long: "Dalam ayat-ayat berikut ini, Allah memerintahkan kepada Nabi Muhammad dan seluruh kaum Muslimin supaya selalu berlindung kepada Tuhan Pencipta semua makhluk agar terpelihara dari segala macam kejahatan atau akibat kejahatan yang ditimbulkan oleh makhluk-makhluk yang telah diciptakan-Nya.",
          short:
    ...
    {
      audio: {
        primary: "https://cdn.alquran.cloud/media/audio/ayah/ar.alafasy/6227",
        secondary: [
          "https://cdn.islamic.network/quran/audio/128/ar.alafasy/6227.mp3",
          "https://cdn.islamic.network/quran/audio/64/ar.alafasy/6227.mp3",
        ],
      },
      meta: {
        hizbQuarter: 240,
    ...
    {
      audio: {
        primary: "https://cdn.alquran.cloud/media/audio/ayah/ar.alafasy/6228",
        secondary: [
          "https://cdn.islamic.network/quran/audio/128/ar.alafasy/6228.mp3",
          "https://cdn.islamic.network/quran/audio/64/ar.alafasy/6228.mp3",
        ],
      },
      meta: {
        hizbQuarter: 240,
      ...
      tafsir: {
        id: {
          long: "Kemudian Allah menerangkan bahwa sebagian makhluk-Nya sering menimbulkan kejahatan pada waktu malam bila segala sesuatu telah diliputi oleh kegelapan. Sementara itu, keadaan malam yang gelap gulita menimbulkan rasa takut dan gelisah, seakan-akan ada sesuatu yang tersembunyi dalam kegelapan malam itu yang akan menyakiti manusia.",
          short:
      ...
      text: {
        ...
        transliteration: {
          en: "Wa min sharri ghasiqin iza waqab",
        },
      },
      translation: {
    ...
    {
      audio: {
        primary: "https://cdn.alquran.cloud/media/audio/ayah/ar.alafasy/6229",
        secondary: [
          "https://cdn.islamic.network/quran/audio/128/ar.alafasy/6229.mp3",
          "https://cdn.islamic.network/quran/audio/64/ar.alafasy/6229.mp3",
        ],
      },
      meta: {
        hizbQuarter: 240,
      ...
      text: {
        ...
        transliteration: {
          en: "Wa min sharrin-naffaa-thaati fil 'uqad",
        },
      },
      translation: {
    ...
    {
      audio: {
        primary: "https://cdn.alquran.cloud/media/audio/ayah/ar.alafasy/6230",
        secondary: [
          "https://cdn.islamic.network/quran/audio/128/ar.alafasy/6230.mp3",
          "https://cdn.islamic.network/quran/audio/64/ar.alafasy/6230.mp3",
        ],
      },
      meta: {
        hizbQuarter: 240,
      ...
      text: {
        ...
        transliteration: {
          en: "Wa min shar ri haasidin iza hasad",
        },
      },
      translation: {

export const quranSurah97 = {
  ...
  verses: [
    {
      audio: {
        primary: "https://cdn.alquran.cloud/media/audio/ayah/ar.alafasy/6126",
        secondary: [
          "https://cdn.islamic.network/quran/audio/128/ar.alafasy/6126.mp3",
          "https://cdn.islamic.network/quran/audio/64/ar.alafasy/6126.mp3",
        ],
      },
      meta: {
        hizbQuarter: 239,
      ...
      text: {
        ...
        transliteration: {
          en: "Innaa anzalnaahu fee lailatil qadr",
        },
      },
      translation: {
        en: "Indeed, We sent the Qur'an down during the Night of Decree.",
        id: "Sesungguhnya Kami telah menurunkannya (Al-Qur'an) pada malam qadar.",
      },
    },
    {
      audio: {
        primary: "https://cdn.alquran.cloud/media/audio/ayah/ar.alafasy/6127",
        secondary: [
          "https://cdn.islamic.network/quran/audio/128/ar.alafasy/6127.mp3",
          "https://cdn.islamic.network/quran/audio/64/ar.alafasy/6127.mp3",
        ],
      },
      meta: {
        hizbQuarter: 239,
      ...
      text: {
        ...
        transliteration: {
          en: "Wa maa adraaka ma lailatul qadr",
        },
      },
      translation: {
    ...
    {
      audio: {
        primary: "https://cdn.alquran.cloud/media/audio/ayah/ar.alafasy/6128",
        secondary: [
          "https://cdn.islamic.network/quran/audio/128/ar.alafasy/6128.mp3",
          "https://cdn.islamic.network/quran/audio/64/ar.alafasy/6128.mp3",
        ],
      },
      meta: {
        hizbQuarter: 239,
      ...
      text: {
        ...
        transliteration: {
          en: "Lailatul qadri khairum min alfee shahr",
        },
      },
      translation: {
        en: "The Night of Decree is better than a thousand months.",
        id: "Malam kemuliaan itu lebih baik daripada seribu bulan.",
      },
    },
    {
      audio: {
        primary: "https://cdn.alquran.cloud/media/audio/ayah/ar.alafasy/6129",
        secondary: [
          "https://cdn.islamic.network/quran/audio/128/ar.alafasy/6129.mp3",
          "https://cdn.islamic.network/quran/audio/64/ar.alafasy/6129.mp3",
        ],
      },
      meta: {
        hizbQuarter: 239,
      ...
      text: {
        ...
        transliteration: {
          en: "Tanaz zalul malaa-ikatu war roohu feeha bi izni-rab bihim min kulli amr",
        },
      },
      translation: {
        en: "The angels and the Spirit descend therein by permission of their Lord for every matter.",
        id: "Pada malam itu turun para malaikat dan Ruh (Jibril) dengan izin Tuhannya untuk mengatur semua urusan.",
      },
    },
    {
      audio: {
        primary: "https://cdn.alquran.cloud/media/audio/ayah/ar.alafasy/6130",
        secondary: [
          "https://cdn.islamic.network/quran/audio/128/ar.alafasy/6130.mp3",
          "https://cdn.islamic.network/quran/audio/64/ar.alafasy/6130.mp3",
        ],
      },
      meta: {
        hizbQuarter: 239,
      ...
      tafsir: {
        id: {
          long: "Dalam ayat ini, Allah menyatakan bahwa malam tersebut dipenuhi kebajikan dan keberkahan dari permulaan sampai terbit fajar, karena turunnya Al-Qur'an yang disaksikan oleh para malaikat ketika Allah melapangkan dada Nabi-Nya dan memudahkan jalan untuk menyampaikan petunjuk serta bimbingan kepada umatnya.",
          short:
      ...
      text: {
        ...
        transliteration: {
          en: "Salaamun hiya hattaa mat la'il fajr",
        },
      },
      translation: {
        en: "Peace it is until the emergence of dawn.",
        id: "Sejahteralah (malam itu) sampai terbit fajar.",
      },
    },
  ],
};

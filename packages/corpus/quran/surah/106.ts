export const quranSurah106 = {
  ...
  verses: [
    {
      audio: {
        primary: "https://cdn.alquran.cloud/media/audio/ayah/ar.alafasy/6194",
        secondary: [
          "https://cdn.islamic.network/quran/audio/128/ar.alafasy/6194.mp3",
          "https://cdn.islamic.network/quran/audio/64/ar.alafasy/6194.mp3",
        ],
      },
      meta: {
        hizbQuarter: 240,
    ...
    {
      audio: {
        primary: "https://cdn.alquran.cloud/media/audio/ayah/ar.alafasy/6195",
        secondary: [
          "https://cdn.islamic.network/quran/audio/128/ar.alafasy/6195.mp3",
          "https://cdn.islamic.network/quran/audio/64/ar.alafasy/6195.mp3",
        ],
      },
      meta: {
        hizbQuarter: 240,
      ...
      text: {
        ...
        transliteration: {
          en: "Elaafihim rihlatash shitaa-i wass saif",
        },
      },
      translation: {
    ...
    {
      audio: {
        primary: "https://cdn.alquran.cloud/media/audio/ayah/ar.alafasy/6196",
        secondary: [
          "https://cdn.islamic.network/quran/audio/128/ar.alafasy/6196.mp3",
          "https://cdn.islamic.network/quran/audio/64/ar.alafasy/6196.mp3",
        ],
      },
      meta: {
        hizbQuarter: 240,
      ...
      tafsir: {
        id: {
          long: "Dalam ayat ini, Allah memerintahkan orang-orang Quraisy agar mereka menyembah Tuhan Pemilik Ka'bah yang telah menyelamatkan mereka dari serangan orang Ethiopia yang bergabung dalam tentara gajah. Seyogyanya mereka hanya menyembah Allah dan mengagungkan-Nya.",
          short:
      ...
      text: {
        ...
        transliteration: {
          en: "Fal y'abudu rabba haazal-bait",
        },
      },
      translation: {
    ...
    {
      audio: {
        primary: "https://cdn.alquran.cloud/media/audio/ayah/ar.alafasy/6197",
        secondary: [
          "https://cdn.islamic.network/quran/audio/128/ar.alafasy/6197.mp3",
          "https://cdn.islamic.network/quran/audio/64/ar.alafasy/6197.mp3",
        ],
      },
      meta: {
        hizbQuarter: 240,
      ...
      text: {
        ...
        transliteration: {
          en: "Allazi at'amahum min ju'inw-wa-aamana hum min khawf",
        },
      },
      translation: {
        en: "Who has fed them, [saving them] from hunger and made them safe, [saving them] from fear.",
        id: "yang telah memberi makanan kepada mereka untuk menghilangkan lapar dan mengamankan mereka dari rasa ketakutan.",
      },
    },
  ],
};

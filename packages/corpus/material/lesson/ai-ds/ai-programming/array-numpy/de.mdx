...
Das zentrale Objekt `ndarray` ist ein n-dimensionaler Behälter fester Größe, dessen Elemente einen gemeinsamen Datentyp besitzen. Dadurch kann ein einziger Ausdruck dieselbe Operation auf das gesamte Array anwenden. [NumPy](https://numpy.org/doc/stable/)

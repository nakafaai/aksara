...
The core `ndarray` object represents an n-dimensional, fixed-size container whose elements share one data type. This design enables vectorized operations, where one expression describes work over an entire array. [NumPy](https://numpy.org/doc/stable/) provides tutorials and further examples.

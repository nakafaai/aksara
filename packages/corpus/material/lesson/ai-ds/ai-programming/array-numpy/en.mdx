...
Vectorization means expressing one operation for an entire array. NumPy still works through the elements internally, but that loop runs in optimized compiled code.

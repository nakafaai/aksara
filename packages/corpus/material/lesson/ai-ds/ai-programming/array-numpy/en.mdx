...
The `np.fromfunction` function creates an array by calling a function with the index of each position. The returned value becomes the element at that position.

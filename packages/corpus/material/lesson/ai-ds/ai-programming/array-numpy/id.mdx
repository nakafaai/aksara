...
Fungsi `np.fromfunction` membuat array dengan memanggil suatu fungsi untuk indeks setiap posisi. Nilai yang dikembalikan menjadi elemen pada posisi tersebut.

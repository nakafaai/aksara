...
Objek inti `ndarray` adalah array n-dimensi berukuran tetap yang seluruh elemennya memakai satu tipe data. Dengan `ndarray`, satu ekspresi dapat menjalankan operasi yang sama pada seluruh array. [NumPy](https://numpy.org/doc/stable/)

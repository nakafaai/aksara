...
Python beginnt seine Indexnummern bei <InlineMath math="0" />. Das erste Element hat den Index <InlineMath math="0" />, das zweite den Index <InlineMath math="1" /> und so weiter. Python unterstützt außerdem negative Indizes, die vom Ende rückwärts zählen.

...
Python has three built-in numeric types: `int` for integers, `float` for approximate real-number calculations, and `complex` for complex numbers. The type determines how Python represents a value and performs arithmetic with it.

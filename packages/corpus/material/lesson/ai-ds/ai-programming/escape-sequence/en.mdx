...
Quotes and backslashes need care inside a string, because Python reads them before the string exists. The subsections below take the cases that most often break a string literal.

...
String formatting controls how values appear as text. It can align table columns, choose a numeric notation, control precision, and insert values into readable messages. Python provides the `str.format()` method and f-strings for this work.

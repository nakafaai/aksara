...
Broadcasting ist NumPys Regel zum Verknüpfen von Arrays mit unterschiedlichen, aber kompatiblen Shapes. Eine Dimension der Größe eins wird so behandelt, als hätte sie dieselbe Größe wie die entsprechende Dimension des anderen Arrays, ohne die Daten in ein größeres Array zu kopieren. [NumPy](https://numpy.org/doc/stable/user/basics.broadcasting.html)

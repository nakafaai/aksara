export const metadata = {
    title: "Array-Operationen mit NumPy",
    description: "Lerne Broadcasting, elementweise Arithmetik, Reduktionen, Achsen, Formoperationen und Z-Standardisierung mit NumPy kennen.",
...
2. **Regel** <InlineMath math="2" />: Zwei ausgerichtete Dimensionen sind kompatibel, wenn ihre Größen gleich sind oder eine von ihnen die Größe <InlineMath math="1" /> hat. Eine Dimension der Größe eins wird virtuell auf die Größe ihres Gegenstücks erweitert

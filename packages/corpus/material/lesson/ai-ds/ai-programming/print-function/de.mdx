...
Ein einfacher `print()`-Aufruf reicht für einen schnellen Blick, und eine saubere Ausgabe braucht ein weiteres Werkzeug. Die folgenden Unterabschnitte behandeln die drei Techniken aus Python-Code.

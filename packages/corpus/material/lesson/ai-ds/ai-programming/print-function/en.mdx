...
A plain `print()` call is enough for a quick look, and formatted output needs one more tool. The subsections below take the three techniques you meet in Python code.

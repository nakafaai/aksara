...
Python mendukung beberapa cara menyusun program. Gaya prosedural mengatur program sebagai urutan langkah. Gaya fungsional mengolah data dengan fungsi. Gaya berorientasi objek menyatukan data dan tindakan yang berkaitan. Ketiganya dapat dipakai bersama.
...
Tipe sebuah objek menentukan data dan tindakan yang tersedia melalui atribut serta method. Karena aturan ini berlaku untuk semua objek, fungsi dapat disimpan di list, class dapat diberikan ke fungsi lain, dan bilangan dapat memiliki method. Kamu tetap dapat memilih cara menyusun program yang paling sesuai.

## Membandingkan Cara Menyusun Program

### Gaya Prosedural

Dalam gaya prosedural, program disusun sebagai rangkaian operasi dengan aliran data yang jelas. Struktur data dan fungsi yang mengolahnya dapat ditulis secara terpisah, termasuk dalam bahasa yang mendukung class.

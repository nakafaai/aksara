...
The same object model supports several ways to organize a program. The subsections below compare the three styles so you can recognise each one in code you read.

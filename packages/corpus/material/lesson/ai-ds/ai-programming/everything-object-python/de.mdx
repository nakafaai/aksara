...
Die Python-Version speichert die Regeln und Operationen des Parksystems in einer Klasse. Die Klasse hält ihren Zustand gültig, indem sie jede Eingabe prüft und direkte Änderungen an ihren internen Daten verhindert.

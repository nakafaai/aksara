export const metadata = {
    ...
    description: "Lerne, warum in Python Zahlen, Zeichenketten, Listen und Funktionen Objekte mit eigenen Attributen und Methoden sind.",
...
Der Typ eines Objekts bestimmt seine Attribute und Methoden. Da diese Regel für alle Objekte gilt, kann eine Funktion in einer Liste stehen, eine Klasse an eine andere Funktion übergeben werden und eine Zahl Methoden haben. Der Aufbau des Programms kann trotzdem passend zur Aufgabe gewählt werden.
...
Die Python-Version bündelt Parkinvarianten und Operationen in einer Klasse. Diese Grenze schützt gültigen Zustand aber nur, wenn ihre Methoden Eingaben prüfen und veränderliche Interna nicht unbedacht offenlegen.
...
Wir wollen ein komplexeres Beispiel erstellen, um zu verstehen, wie OOP in realen Szenarien angewendet wird.
...
Pythons Objektmodell erklärt, warum Werte, Funktionen und Klassen dieselben Sprachmechanismen durchlaufen können. Nutze objektorientierte Komposition, wenn Zustand und Verhalten eine sinnvolle Grenze bilden. Ein prozedurales oder funktionales Design bleibt besser, wenn es das Problem direkter ausdrückt.

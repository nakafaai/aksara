...
Container gruppieren Werte und bestimmen, wie Code darauf zugreift. Eine Sequenz bewahrt Positionen, ein Mapping verbindet Schlüssel mit Werten und ein Set beschreibt eindeutige Mitglieder. Entscheidend sind dieses Verhalten und die Form der Klammern.
...
Mit Slicing wird ein Teil einer Liste ausgewählt. Der Stride legt den Abstand zwischen den ausgewählten Elementen fest.

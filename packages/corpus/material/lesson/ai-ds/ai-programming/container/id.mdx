...
Container mengelompokkan nilai dan menentukan cara kode mengaksesnya. Sequence mempertahankan posisi, mapping menghubungkan kunci dengan nilai, sedangkan set merepresentasikan anggota unik. Pilih container berdasarkan perilaku yang dibutuhkan oleh kode.
...
Slicing adalah teknik untuk mengambil sebagian elemen dari list. Stride menentukan jarak antar elemen yang diambil.

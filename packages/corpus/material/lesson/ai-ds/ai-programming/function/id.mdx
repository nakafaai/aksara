...
## Memakai Ulang Kode melalui Fungsi

Fungsi <Highlight>memberi nama pada sekumpulan instruksi agar logika yang sama dapat dijalankan tanpa menyalin kode</Highlight>. Parameter menyatakan input yang diterima, function body berisi kode yang dijalankan, dan statement `return` mengirimkan hasil kepada pemanggil.
...
<Highlight>Aturan pencarian variabel mengikuti urutan LEGB</Highlight>:

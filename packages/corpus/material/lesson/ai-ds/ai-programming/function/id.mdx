...
Fungsi <Highlight>memberi nama pada operasi yang dapat dipakai ulang</Highlight>. Parameter menyatakan input yang diterima, function body berisi kode yang dijalankan, dan statement `return` mengirimkan hasil kepada pemanggil.
...
Pencarian nama mengikuti **urutan LEGB**:
...
<CodeBlock
  data={[
    ...
    """
    Menghitung faktorial dari bilangan bulat nonnegatif.

...
Alle Elemente eines gewöhnlichen NumPy-Arrays verwenden denselben Datentyp. Dadurch können die von NumPy in C ausgeführten Schleifen die Elemente verarbeiten, ohne den Typ jedes Werts einzeln zu prüfen. [NumPy](https://numpy.org/doc/stable/user/basics.types.html) nennt die technischen Details und Speichergrößen der einzelnen Datentypen.

...
Semua elemen dalam array NumPy biasa berbagi satu tipe data. Objek `numpy.dtype` menjelaskan cara nilai tersebut disimpan dan diinterpretasikan dalam memori. Jika masukan memiliki tipe berbeda, NumPy memakai aturan promosi tipe untuk mencari dtype bersama yang kompatibel. Hasilnya bergantung pada presisi dan kategori tipe dan bukan pada tipe yang paling sering muncul.
...
Konversi tipe data memungkinkan kamu memilih representasi lain untuk analisis berikutnya. Metode `astype()` mengembalikan array hasil konversi dan tidak mengubah array asal secara langsung. Konversi nilai titik mengambang ke integer memotong bagian pecahan menuju nol dan bukan membulatkannya.

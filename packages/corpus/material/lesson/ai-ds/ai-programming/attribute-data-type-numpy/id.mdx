...
Semua elemen dalam array NumPy biasa berbagi satu tipe data. Objek `numpy.dtype` menjelaskan cara nilai tersebut disimpan dan dibaca di dalam memori. Jika input memiliki tipe berbeda, NumPy memakai aturan promosi tipe untuk mencari dtype bersama yang cocok. Presisi dan kategori tipe input menentukan dtype hasil. Frekuensi kemunculan setiap tipe tidak memengaruhi aturan ini.

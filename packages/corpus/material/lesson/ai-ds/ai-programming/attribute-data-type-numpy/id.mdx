...
Semua elemen dalam array NumPy biasa berbagi satu tipe data. Objek `numpy.dtype` menjelaskan cara nilai tersebut disimpan dan dibaca di dalam memori. Jika masukan memiliki tipe berbeda, NumPy memakai aturan promosi tipe untuk mencari dtype bersama yang cocok. Presisi dan kategori tipe menentukan hasilnya. Banyaknya kemunculan setiap tipe tidak memengaruhi aturan ini.
...
Konversi tipe data memungkinkan kamu memilih bentuk lain untuk analisis berikutnya. Metode `astype()` mengembalikan array hasil konversi dan tidak mengubah array asal secara langsung. Saat mengubah nilai desimal menjadi integer, NumPy memotong bagian pecahan menuju nol.

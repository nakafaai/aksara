...
Semua elemen dalam array NumPy biasa memakai tipe data yang sama. Dengan susunan ini, loop yang dijalankan NumPy dalam kode C dapat memproses elemen tanpa memeriksa tipe setiap nilai satu per satu. [NumPy](https://numpy.org/doc/stable/user/basics.types.html)

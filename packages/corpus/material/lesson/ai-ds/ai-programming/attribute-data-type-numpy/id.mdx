...
Setiap elemen dalam array NumPy <Highlight>memiliki tipe yang menentukan representasinya di memori dan operasi yang dapat dilakukan NumPy terhadapnya</Highlight>. Boolean NumPy memakai satu byte, sedangkan bilangan kompleks menyimpan komponen real dan imajiner secara terpisah.
...
Setiap array NumPy menyediakan atribut yang menjelaskan bentuk, jumlah elemen, tipe data, dan penggunaan memorinya. Membaca atribut tersebut hampir tidak memakan waktu karena nilainya tersimpan bersama array, bukan dihitung dengan menelusuri elemen satu per satu.
...
Tipe data yang dipakai sebuah array saat dibuat jarang menjadi tipe yang dibutuhkan di akhir perhitungan. Konversi berguna untuk memperkecil penggunaan memori, memenuhi kebutuhan fungsi yang mensyaratkan tipe tertentu, dan menjaga aritmetika bilangan bulat agar tidak berubah menjadi bilangan pecahan. Sebelum mengonversi, periksa dulu tipe apa yang benar-benar dibutuhkan hasil perhitungan.

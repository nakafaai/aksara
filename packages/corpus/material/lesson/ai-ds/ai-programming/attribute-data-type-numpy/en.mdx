...
Data type conversion lets you choose another representation for later analysis. The `astype()` method returns a converted array; it does not change the original array in place. When converting a floating-point value to an integer, NumPy cuts off the fractional part toward zero.
...
Array attributes help you find bugs, improve performance, and work with scientific data.

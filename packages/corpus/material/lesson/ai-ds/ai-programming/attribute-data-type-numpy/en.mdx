...
Every element in a regular NumPy array uses the same data type. This layout lets loops implemented by NumPy in C process elements without checking each value's type one by one. [NumPy](https://numpy.org/doc/stable/user/basics.types.html)

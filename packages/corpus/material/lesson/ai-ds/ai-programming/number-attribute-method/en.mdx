...
Complex numbers carry their own methods. The subsections below take the ones you reach for most often.
...
Attributes and methods also support checks and conversions. The subsections below cover validation and the calculations that follow it.

...
Enthält ein Ausdruck mehrere arithmetische Operatoren, braucht Python eine feste Reihenfolge, um zu entscheiden, welche Rechnung zuerst läuft. Diese Reihenfolge ergibt sich aus drei Prioritätsstufen. Ein Operator einer höheren Stufe ist immer vor einem Operator einer niedrigeren Stufe fertig, sodass die Stufe jedes Operators die Reihenfolge der Rechnungen festlegt.

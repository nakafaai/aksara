...
Python besitzt sieben grundlegende arithmetische Operatoren. Enthält ein Ausdruck mehrere Operatoren, bestimmt ihre Priorität die Reihenfolge der Rechnungen.

...
Der Ausdruck `6 / 2 * 4` wird als `(6 / 2) * 4 = 3 * 4 = 12` ausgewertet und nicht als `6 / (2 * 4) = 6 / 8 = 0.75`.
...
Der Ausdruck `2 ** 3 ** 2` wird als `2 ** (3 ** 2) = 2 ** 9 = 512` ausgewertet und nicht als `(2 ** 3) ** 2 = 8 ** 2 = 64`.

...
Pembagian lantai selalu membulatkan ke arah negatif tak hingga. Karena itu, `-7 // 2` menghasilkan `-4`, bukan `-3`. Jika salah satu operand berupa float, Python tetap menerapkan pembulatan lantai, tetapi mengembalikan float.

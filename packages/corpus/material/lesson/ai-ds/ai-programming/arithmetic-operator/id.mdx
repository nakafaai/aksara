...
Operator `//` melakukan pembagian lantai. Hasil bagi dibulatkan ke bawah, yaitu ke bilangan bulat terbesar yang lebih kecil atau sama dengan hasil tepatnya.
...
Pembagian lantai selalu membulatkan ke arah negatif tak hingga. Untuk `-7 // 2`, Python memperoleh `-3.5` lalu membulatkannya ke bawah menjadi `-4`. Jika salah satu operand berupa float, Python tetap menerapkan pembulatan lantai, tetapi mengembalikan float.
...
| **Menengah** | `//` | Pembagian lantai | Kiri |

...
CLI work is valuable because commands can be inspected, repeated, scripted, and reviewed. That power also makes exact paths and destructive flags important: the shell executes what you wrote rather than what you intended.

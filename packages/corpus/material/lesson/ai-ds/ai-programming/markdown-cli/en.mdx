...
CLI work is valuable because commands can be inspected, repeated, scripted, and reviewed. Exact paths and destructive flags matter because the shell follows the written command exactly. Check the command before you run it.

...
In Python, lists are data structures that can be modified after they are created. Understand how lists behave when we perform certain operations.
...
Assignment gives a name a new value, while in-place modification changes the existing object.

...
Python has other compact syntax for common operations. These forms can improve readability, but they do not guarantee better runtime performance. The sections below show each form next to the longer version it replaces.

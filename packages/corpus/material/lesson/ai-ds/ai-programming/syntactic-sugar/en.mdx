...
Python offers several compact forms for common patterns. They do not automatically make a program run faster, and they are not interchangeable in every detail. The goal is clearer intent rather than the fewest possible characters.
...
See how list comprehension works in practice:

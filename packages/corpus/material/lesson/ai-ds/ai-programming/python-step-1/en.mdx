...
For details about the language and its standard library, use the [official Python documentation](https://docs.python.org). It is the authoritative reference for the Python version you are using.
...
Learn some basic Python concepts that you'll use frequently.
...
Try some simple exercises to practice what we've learned:

...
Operator precedence determines how Python groups an expression when parentheses do not state the grouping explicitly. This rule describes the grouping. Python may evaluate the operands in a different order from the one you see on the page.

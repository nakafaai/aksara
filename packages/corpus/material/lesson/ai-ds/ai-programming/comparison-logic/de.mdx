...
Die Operatorrangfolge <Highlight>bestimmt, wie Python einen Ausdruck gruppiert, wenn Klammern diese Gruppierung nicht ausdrücklich festlegen</Highlight>. Sie ist eine Parsing-Regel und keine Zusage, dass jeder Operand in derselben sichtbaren Reihenfolge ausgewertet wird.
...
Das Diagramm verfolgt den Weg eines Dezimalwerts in die binäre Gleitkommadarstellung, und genau dort entsteht die Überraschung beim Vergleich.

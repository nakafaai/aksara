...
`zip()` liefert einen Iterator, deshalb brauchst du oft eine konkrete Sammlung, bevor du die Paare lesen kannst. Das Beispiel wandelt das Ergebnis in eine Liste und ein Wörterbuch um.

...
Assignment `y = x` menjamin kedua nama merujuk pada objek yang sama pada saat itu. Membuat nilai lain yang setara hanya menjamin equality dan bukan identity. Beberapa implementasi Python menggunakan ulang objek immutable, tetapi kode yang benar tidak bergantung pada optimasi tersebut.

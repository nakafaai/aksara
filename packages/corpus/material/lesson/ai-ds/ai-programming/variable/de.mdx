export const metadata = {
    title: "Variablen",
    description: "Verstehe Python-Namensbindungen, Objektidentität, dynamische Typisierung, Identifier und reservierte Schlüsselwörter anhand überprüfbarer Beispiele.",
...
## Schlüsselwörter, die nicht verwendet werden können
...
Obwohl Python bei der Benennung von Variablen viel Freiheit bietet, helfen einige bewährte Vorgehensweisen dabei, den Code lesbar und wartbar zu halten.
...
Wir betrachten, wie Variablen in einem einfachen Programm verwendet werden, das die Fläche und den Umfang eines Rechtecks berechnet.
...
Das obige Beispielprogramm zeigt die Verwendung von Variablen mit aussagekräftigen Namen, mathematische Berechnungen und Datenvalidierung. Jede Variable hat einen klaren Zweck und einen Namen, der ihren Inhalt erklärt.

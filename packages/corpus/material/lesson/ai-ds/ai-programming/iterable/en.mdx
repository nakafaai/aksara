...
The same syntax works in function calls and in collection displays. Use it when expansion is part of the intended interface, not when a function already accepts one iterable directly.

...
In Python, an iterable is <Highlight>an object that can produce one item at a time for a loop or another consumer</Highlight>. Strings, lists, tuples, sets, dictionaries, files, and generators are all iterable even though they organize and produce items differently.

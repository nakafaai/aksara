...
# Marker check only rather than full email validation
...
The same syntax works in function calls and in collection displays. Use it when expansion is part of the intended interface rather than when a function already accepts one iterable directly.

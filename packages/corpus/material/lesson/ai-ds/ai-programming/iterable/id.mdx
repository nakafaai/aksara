export const metadata = {
    title: "Iterable",
    description: "Pelajari cara iterable Python mendukung perulangan, pemeriksaan keanggotaan, uji truthiness, dan positional unpacking.",
...
Sequence bawaan memeriksa item hingga menemukan kecocokan atau mencapai akhir. Set dan dictionary memakai mekanisme pencariannya sendiri, dan pemeriksaan keanggotaan dictionary berlaku pada kunci dan bukan nilai.
...
# Pemeriksaan penanda saja dan bukan validasi email lengkap
...
`all()` mengembalikan `False` setelah menemukan item falsy pertama. Jika iterasi selesai tanpa item tersebut, hasilnya `True`. Ini juga menjelaskan kasus kosong: tidak ada item yang melanggar kondisi.
...
Sintaks yang sama bekerja dalam pemanggilan fungsi dan tampilan collection. Gunakan ketika ekspansi memang menjadi bagian antarmuka yang dituju dan bukan ketika fungsi sudah menerima satu iterable secara langsung.

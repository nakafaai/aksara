...
String Python bersifat immutable, sehingga isi objek string tidak dapat diedit langsung. Operasi pada string menghasilkan string baru. Variabel dapat diarahkan ke objek baru tersebut, sedangkan objek string asal tetap tidak berubah.

...
Diese Methoden liefern einen neuen String und lassen den ursprünglichen unverändert. Die folgenden Unterabschnitte gruppieren sie nach der Änderung, die sie vornehmen.
...
Eine Gruppe von Methoden findet Textstellen, eine andere beantwortet Ja-Nein-Fragen dazu. Die folgenden Unterabschnitte trennen beide.
...
Diese beiden Methoden zerlegen einen String und setzen ihn wieder zusammen. Die folgenden Unterabschnitte behandeln zuerst das Ersetzen und danach das Aufteilen.

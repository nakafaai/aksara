...
The following small examples combine string methods with stated assumptions. They teach how the methods work. Production validators and parsers need rules written for their real data.

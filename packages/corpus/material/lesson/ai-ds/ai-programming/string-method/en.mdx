...
Python provides predicates that classify the code points in a string. They answer questions about character categories. A complete business format needs its own validation rules.

...
These methods return a new string and leave the original unchanged. The subsections below group them by the change they make.
...
One group of methods locates text, and another group answers yes-or-no questions about it. The subsections below separate the two.
...
These two methods cut a string apart and put it back together. The subsections below take replacement first and splitting second.

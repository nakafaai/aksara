...
Sifat-sifat ini membuat <InlineMath math="\|\cdot\|_2" /> benar-benar sebuah norma. Operasi adjoint menjaga agar panjang, ortogonalitas, dan proyeksi kompleks tetap konsisten dengan padanannya pada ruang real.

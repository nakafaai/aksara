...
Sebagai contoh, entri seperti <InlineMath math="2+3i" /> dan <InlineMath math="-1-4i" /> merupakan anggota <InlineMath math="\mathbb C" />. Karena konjugasi berperan dalam panjang dan sudut, transpose biasa tidak lagi menjadi operasi yang tepat untuk setiap perhitungan geometris.

## Matriks Adjoint

Untuk matriks kompleks, padanan geometris transpose adalah **adjoint**, yang juga disebut transpose konjugat. Operasi ini mentranspose matriks sekaligus mengonjugasi setiap entrinya.
...
Untuk <InlineMath math="v=(1+i,2-i)^T" />, perhitungannya dapat dilihat langsung:
...
Sifat-sifat ini membuat <InlineMath math="\|\cdot\|_2" /> benar-benar sebuah norma. Jadi, adjoint bukan sekadar notasi: operasi inilah yang menjaga agar panjang, ortogonalitas, dan proyeksi kompleks tetap konsisten dengan padanannya pada ruang real.

...
Dabei sind die Indizes in <InlineMath math="A_{ji}" /> vertauscht und nicht in der Reihenfolge <InlineMath math="A_{ij}" />.
...
für <InlineMath math="j = 1, 2, \ldots, n" />.
...
mithilfe der Laplace-Entwicklung nach der <InlineMath math="j" />-ten Spalte.
...
gilt, ist die Matrix <InlineMath math="A" /> invertierbar und das System besitzt genau eine Lösung.

...
Dalam teori matriks, diagonalisasi menuliskan ulang transformasi linear dalam basis yang tidak lagi mencampur antarkoordinat. Bentuk yang lebih sederhana ini memudahkan analisis dan perhitungan berulang.
...
Secara ekuivalen, <InlineMath math="A = S\Lambda S^{-1}" />. Bentuk ini sangat memudahkan penerapan berulang:
...
Mengapa begitu? Vektor eigen untuk nilai eigen yang berbeda secara berpasangan dari <InlineMath math="A" /> selalu bebas linear. Dengan <InlineMath math="n" /> nilai eigen seperti itu, vektor-vektor tersebut membentuk basis dari <InlineMath math="\mathbb{K}^n" />.

Namun, bagaimana jika <InlineMath math="A" /> memiliki nilai eigen berulang? Kita harus memeriksanya lebih cermat. Nilai eigen memiliki multiplisitas aljabar <InlineMath math="\mu_A(\lambda_i)" /> dan multiplisitas geometris <InlineMath math="\dim E_A(\lambda_i)" /> dengan hubungan:

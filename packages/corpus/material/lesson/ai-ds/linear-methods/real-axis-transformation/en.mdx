...
The cross term in a quadratic equation can hide its geometry. Writing the equation as a quadratic form exposes the symmetric matrix that controls its principal directions. In two dimensions, let

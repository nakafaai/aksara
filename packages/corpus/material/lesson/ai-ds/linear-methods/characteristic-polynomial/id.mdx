...
Sekarang, lihat hubungan yang sangat penting: <InlineMath math="\lambda \in \mathbb{K}" /> adalah nilai eigen dari <InlineMath math="A" /> jika dan hanya jika <InlineMath math="\det(A - \lambda \cdot I) = 0" />.

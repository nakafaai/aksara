export const metadata = {
   ...
   description: "Gunakan polinomial karakteristik untuk mencari nilai eigen, menentukan multiplisitas aljabar, dan menghubungkan koefisiennya dengan jejak matriks.",
...
Polinom berderajat <InlineMath math="n" /> dalam <InlineMath math="t" /> dengan koefisien <InlineMath math="a_0,\ldots,a_n\in\mathbb{K}" /> ini disebut **polinom karakteristik** dari <InlineMath math="A" />. Materi ini memakai konvensi <InlineMath math="\det(A-tI)" />. Konvensi <InlineMath math="\det(tI-A)" /> juga sering digunakan dan hanya berbeda dengan faktor <InlineMath math="(-1)^n" />, sehingga akar keduanya tetap sama.
...
Sekarang kita terapkan definisinya dan menggunakan hubungan koefisien sebagai pemeriksa hasil perhitungan.

...
Jadi, kalau air yang terbentuk massanya berbeda, perbandingan massa hidrogen terhadap oksigen yang benar-benar bereaksi tetap <InlineMath math="1:8" /> dengan nilai pembulatan yang dipakai di atas. PubChem mencatat rumus <InlineMath math="\mathrm{H_2O}" /> di [water property record](https://pubchem.ncbi.nlm.nih.gov/rest/pug/compound/name/water/property/MolecularFormula/JSON). [Bobot atom standar ringkas CIAAW 2024](https://www.ciaaw.org/abridged-atomic-weights.htm), yaitu <InlineMath math="A_r\mathrm{(H)}=1{,}0080" /> dan <InlineMath math="A_r\mathrm{(O)}=15{,}999" />, memberi massa molar yang lebih teliti:
...
Untuk senyawa besi(III) oksida, rumusnya <InlineMath math="\mathrm{Fe_2O_3}" />. Data PubChem untuk ferric oxide juga mencatat rumus <InlineMath math="\mathrm{Fe_2O_3}" /> di [ferric oxide property record](https://pubchem.ncbi.nlm.nih.gov/rest/pug/compound/name/ferric%20oxide/property/MolecularFormula/JSON).

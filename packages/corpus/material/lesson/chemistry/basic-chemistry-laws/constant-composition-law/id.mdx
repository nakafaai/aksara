...
Model ini dipakai untuk menghitung massa, bukan untuk menggambarkan mekanisme molekuler secara harfiah. Label <InlineMath math="\mathrm{H}" /> dan <InlineMath math="\mathrm{O}" /> menunjukkan massa unsur yang sedang dihitung. Dalam persamaan pembentukan setara, hidrogen dan oksigen unsur ditulis sebagai <InlineMath math="\mathrm{H_2}" /> dan <InlineMath math="\mathrm{O_2}" />:

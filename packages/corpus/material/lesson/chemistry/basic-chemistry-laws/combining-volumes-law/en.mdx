...
When all gas volumes are measured at the same temperature and pressure, their ratios follow the coefficients in the balanced equation. [OpenStax Chemistry 2e](https://openstax.org/books/chemistry-2e/pages/9-3-stoichiometry-of-gaseous-substances-mixtures-and-reactions) Hydrogen and oxygen combine by volume in a <InlineMath math="2:1" /> ratio to form water. [Britannica](https://www.britannica.com/science/Gay-Lussacs-law-of-combining-volumes)

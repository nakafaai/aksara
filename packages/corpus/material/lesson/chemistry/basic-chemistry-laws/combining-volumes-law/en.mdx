...
export const metadata = {
  ...
  description:
    "Read gas volume ratios from reaction coefficients when temperature and pressure are kept the same.",
...
[OpenStax Chemistry 2e](https://openstax.org/books/chemistry-2e/pages/9-3-stoichiometry-of-gaseous-substances-mixtures-and-reactions) explains that gas volume ratios in a reaction are given by the coefficients in the balanced equation when all gas volumes are measured at the same temperature and pressure. [Britannica](https://www.britannica.com/science/Gay-Lussacs-law-of-combining-volumes) also summarizes Gay-Lussac's finding that hydrogen and oxygen combine by volume in a <InlineMath math="2:1" /> ratio to form water.

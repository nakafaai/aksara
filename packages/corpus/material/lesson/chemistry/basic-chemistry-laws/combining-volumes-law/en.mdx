...
export const metadata = {
  ...
  description:
    "At the same temperature and pressure, the coefficients in a balanced equation give the volume ratio of reacting gases.",
...
The law of combining volumes states that reacting gases, and gaseous products, have <Highlight>volumes in simple whole-number ratios</Highlight> when measured at the same temperature and pressure. This law is also known as Gay-Lussac's law of combining gas volumes.

When all gas volumes are measured at the same temperature and pressure, their ratios follow the coefficients in the balanced equation. Hydrogen and oxygen combine by volume in a <InlineMath math="2:1" /> ratio to form water.
...
## Gas Volume Ratio Model

Choose a reaction below. Each tube represents one volume part of gas at the same temperature and pressure.

<CombiningVolumesLab
  title={<>Gas Volume Ratio Model</>}
  description={
    <>
      The tube heights compare gas volumes at the same temperature and pressure, so their ratios follow the reaction coefficients.
    </>
  }
  labels={{
    ...
    modes: {
      "water-vapor": {
        ...
        helperCaption: (
          <>
            Two equal-volume portions of <InlineMath math="\mathrm{H_2}" /> react
            with one equal-volume portion of <InlineMath math="\mathrm{O_2}" />
            and form two equal-volume portions of{" "}
            <InlineMath math="\mathrm{H_2O(g)}" /> at the same temperature and
            pressure.
          </>
        ),
        ratio: (
        ...
        example: (
          <>
            ...
            <InlineMath math="\mathrm{H_2}" /> reacts with{" "}
      ...
      "ammonia-synthesis": {
        ...
        helperCaption: (
          <>
            One volume of <InlineMath math="\mathrm{N_2}" /> reacts with three
            volumes of <InlineMath math="\mathrm{H_2}" /> to form two volumes of{" "}
        ...
        example: (
          <>
            ...
            <InlineMath math="\mathrm{N_2}" /> reacts with{" "}
...
Use the reaction coefficients as gas volume ratios only when all of these conditions are met.
...
When these conditions are met, the coefficients give both the mole ratio and the gas volume ratio.

...
[Perserikatan Bangsa-Bangsa (PBB)](https://sdgs.un.org/goals) memakai istilah **Tujuan Pembangunan Berkelanjutan (Sustainable Development Goals, SDGs)** untuk <InlineMath math="17" /> tujuan global dalam Agenda <InlineMath math="2030" />. Kimia hijau tidak menggantikan SDGs, dan label SDG bukan bukti bahwa suatu kegiatan termasuk kimia hijau. Kimia hijau dapat mendukung beberapa tujuan ketika desain kimia mengurangi bahaya bahan dan limbah, menekan pemakaian energi, serta mengurangi pencemaran air dan udara secara terukur.

Kimia dapat membantu menjawab beberapa tantangan dalam [Tujuan Pembangunan Berkelanjutan](https://www.acs.org/green-chemistry-sustainability/education/chemistry-sustainable-development-goals.html), termasuk kesehatan, energi bersih, dan produksi yang lebih bertanggung jawab.
...
Klaim hijau <Highlight>baru dapat diuji jika disertai bukti</Highlight>. Kata "alami", "hemat", atau "ramah lingkungan" belum menjelaskan bahaya atau limbah apa yang berkurang. Perbandingan juga harus mempertahankan fungsi yang sama. Memakai lebih sedikit pembersih bukan perbaikan jika permukaannya tetap kotor, dan bahan pengganti harus mampu menjalankan fungsi yang sama.
...
Sebagai **contoh data rekaan**, dua formula pembersih diuji pada noda dan luas permukaan yang sama. Formula A memerlukan <InlineMath math="10 \mathrm{mL}" />, sedangkan formula B memerlukan <InlineMath math="8 \mathrm{mL}" /> untuk hasil kebersihan yang sama. Pengurangan volume produk adalah:

<BlockMath math="\frac{10-8}{10}\times100\%=\frac{2}{10}\times100\%=20\%" />

Hasil ini membuktikan pengurangan volume produk pada uji tersebut. Untuk menyatakan B lebih aman atau lebih hemat air, kita masih perlu data komposisi, bahaya, dan air bilas.
...
[Kimia hijau](https://www.epa.gov/greenchemistry/basics-green-chemistry) merancang produk dan proses kimia untuk mengurangi atau menghilangkan zat berbahaya sepanjang daur hidupnya. Kimia hijau berfokus pada pencegahan polusi sejak awal. Pengolahan tetap diperlukan jika polusi sudah terbentuk.

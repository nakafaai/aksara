...
[Green chemistry](https://www.epa.gov/greenchemistry/basics-green-chemistry) applies across the life cycle of a chemical product, from design to final disposal, and emphasizes preventing pollution at its source.
...
The [twelve green chemistry principles](https://www.acs.org/green-chemistry-sustainability/principles/12-principles-of-green-chemistry.html) form a framework for making greener chemicals, processes, and products.
...
Let <InlineMath math="m_P" /> be the sum of the stoichiometric formula masses of the desired products, and <InlineMath math="m_R" /> the corresponding sum for all reactants.

<BlockMath math="\text{atom economy}=\frac{m_P}{m_R}\times100\%" />

[Percent atom economy](https://www.acs.org/green-chemistry-sustainability/principles/12-principles-of-green-chemistry.html) is the formula weight of the desired product or products divided by the sum of the formula weights of all reactants in the balanced equation. This theoretical metric is different from experimental percent yield and does not by itself count solvent, excess reagent, or processing waste. When atom economy is high, more reactant atoms enter the desired product. When it is low, more atoms enter side products.

Take methanol synthesis, with **methanol as the desired product**. Use rounded relative atomic masses <InlineMath math="A_r(\mathrm{C})=12" />, <InlineMath math="A_r(\mathrm{H})=1" />, and <InlineMath math="A_r(\mathrm{O})=16" />.

<BlockMath math="\mathrm{CO_2}+3\mathrm{H_2}\rightarrow\mathrm{CH_3OH}+\mathrm{H_2O}" />

<BlockMath math="\begin{aligned} m_R &= (12+2\times16)+3(2\times1)=50 \\ m_P &=12+4\times1+16=32 \\ \text{atom economy} &=\frac{32}{50}\times100\%=64\% \end{aligned}" />

The remaining formula mass, <InlineMath math="50-32=18" />, enters water as a by-product. The <InlineMath math="64\%" /> value comes from the equation, not from measuring reaction yield.
...
Natural materials can also be hazardous. [Capsaicin](https://pubchem.ncbi.nlm.nih.gov/compound/Capsaicin) can irritate skin and eyes. [Ethanol](https://pubchem.ncbi.nlm.nih.gov/compound/Ethanol) is highly flammable. A substance's properties determine its intrinsic hazards, such as flammability or irritation. Dose, concentration, and route of exposure <Highlight>affect the level of risk</Highlight>. Intrinsic hazards, dose, concentration, and exposure route must be checked for both natural and synthetic materials. A synthetic material can be designed for low toxicity, useful stability, and safer degradation after use.

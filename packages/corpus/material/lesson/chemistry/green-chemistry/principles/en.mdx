...
Natural materials are not automatically safe. [Capsaicin](https://pubchem.ncbi.nlm.nih.gov/compound/Capsaicin) in chili can irritate skin and eyes, while [ethanol](https://pubchem.ncbi.nlm.nih.gov/compound/Ethanol) is highly flammable. Hazard depends on the substance, dose, concentration, and route of exposure rather than on whether the source is natural or synthetic. A synthetic material is not automatically bad either if it is designed for low toxicity, useful stability, and safer degradation after use.
...
Renewable feedstocks also need careful reading. Fruit peels, starch, and plant oils can be replenished, but growing, transporting, extracting, and processing them still uses land, water, and energy. Green chemistry asks us to judge the full pathway rather than one keyword.

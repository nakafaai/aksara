...
Natural materials are not automatically safe. [Capsaicin](https://pubchem.ncbi.nlm.nih.gov/compound/Capsaicin) in chili can irritate skin and eyes, while [ethanol](https://pubchem.ncbi.nlm.nih.gov/compound/Ethanol) is highly flammable. Hazard depends on the substance, dose, concentration, and route of exposure, not on whether the source is natural or synthetic. A synthetic material is not automatically bad either if it is designed for low toxicity, useful stability, and safer degradation after use.

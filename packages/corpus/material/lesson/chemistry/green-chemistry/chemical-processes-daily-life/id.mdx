...
Sebelum menilai sebuah aktivitas sebagai "hijau" atau "tidak hijau", kita perlu tahu <Highlight>proses kimia apa yang sedang terjadi</Highlight>. Membakar sampah, mencuci pakaian, membuat kompos, memasak, fotosintesis pada tanaman, dan besi berkarat sama-sama melibatkan perubahan zat atau interaksi antarzat.

[Kimia hijau](https://www.epa.gov/greenchemistry/basics-green-chemistry) menilai rancangan produk atau proses kimia sejak awal. Rancangan tersebut perlu mengurangi bahaya, limbah, penggunaan energi yang berlebihan, bahan sekali pakai, dan risiko kecelakaan. Kimia hijau juga bertujuan mengurangi penggunaan atau pembentukan zat berbahaya.
...
[Atom](https://goldbook.iupac.org/terms/view/A00493) adalah bagian terkecil dari suatu unsur yang masih memiliki sifat unsur tersebut. [Unsur kimia](https://goldbook.iupac.org/terms/view/C01022) tersusun dari atom-atom dengan jumlah proton yang sama. [Molekul](https://goldbook.iupac.org/terms/view/M04002) tersusun dari dua atom atau lebih yang terikat dan memiliki muatan total nol.
  ...
  labels={{
    ...
    modes: {
      atom: {
        ...
        tabLabel: "Atom",
        helperCaption: (
          <>Satu partikel pada diagram ini mewakili satu atom.</>
        ),
        category: (
          <>
...
Mulai dari enam atom karbon dalam satu molekul gula. Kita membutuhkan <InlineMath math="6\mathrm{CO_2}" /> agar sisi kiri juga memuat enam karbon. Dua belas hidrogen pada gula membutuhkan <InlineMath math="6\mathrm{H_2O}" />. Sekarang oksigen di kiri berjumlah <InlineMath math="6\times2+6=18" />. Gula sudah memuat enam oksigen, jadi sisa <InlineMath math="18-6=12" /> atom oksigen membentuk <InlineMath math="6\mathrm{O_2}" />:

<BlockMath math="\begin{aligned} &amp;6\mathrm{CO_2(g)} + 6\mathrm{H_2O(l)} \\ &amp;\xrightarrow{\text{cahaya}} \mathrm{C_6H_{12}O_6} + 6\mathrm{O_2(g)} \end{aligned}" />
...
Untuk menyetarakan persamaan, pertahankan setiap rumus kimia, <Highlight>ubah hanya koefisiennya</Highlight>, lalu pastikan kedua sisi memuat jumlah atom yang sama untuk setiap unsur.
...
| :----------------- | :-------------------- | :------------------ |
| Membakar sampah plastik | Zat organik dalam plastik bereaksi dengan oksigen dan melepaskan panas. Asap dan produk gas dapat terbentuk. | Tidak sejalan karena dapat menghasilkan asap berbahaya dan tidak mencegah limbah dari sumbernya. |
...
Jangan mencampur [pemutih rumah tangga atau disinfektan](https://www.cdc.gov/hygiene/about/cleaning-and-disinfecting-with-bleach.html) dengan pembersih lain. Campuran tersebut dapat melepaskan uap yang berbahaya jika terhirup. Ikuti label produk dan petunjuk ventilasi.

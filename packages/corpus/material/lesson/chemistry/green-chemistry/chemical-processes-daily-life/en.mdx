...
In a chemical equation, reactants are written on the left and products on the right. Plus signs separate substances, and coefficients show relative amounts. [OpenStax Chemistry 2e](https://openstax.org/books/chemistry-2e/pages/4-1-writing-and-balancing-chemical-equations)
...
Photosynthesis is often written as a summary reaction. The real process has many steps, but the summary equation records the atoms before and after the reaction. Photosynthesis uses carbon dioxide and water to produce sugar and oxygen. [OpenStax Concepts of Biology](https://openstax.org/books/concepts-biology/pages/5-1-overview-of-photosynthesis)

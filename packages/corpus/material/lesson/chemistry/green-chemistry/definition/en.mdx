...
Waste treatment reduces harm after waste has formed. Green chemistry changes the materials or process before production so less hazardous waste forms in the first place. EPA calls this **source reduction**. Green chemistry therefore evaluates the starting materials, solvent, energy use, catalyst, product, and end of use. [EPA](https://www.epa.gov/greenchemistry/basics-green-chemistry)
...
Water electrolysis shows why a green chemistry assessment must include the energy source. The process splits water into hydrogen and oxygen. [University of Washington](https://chem.washington.edu/lecture-demos/electrolysis-water)
...
<InlineMath math="\mathrm{CO_2}" /> is relatively stable, so methanol synthesis from <InlineMath math="\mathrm{CO_2}" /> needs energy input and an efficient catalyst. [MDPI](https://www.mdpi.com/1996-1944/12/23/3902)

...
This formal summary represents carbohydrate as glucose and omits its phase because photosynthesis is a multistep biological process, not one elementary reaction. It is not an industrial green chemistry example, but it helps separate "chemical reaction" from images of smoke, sharp odors, or toxic waste.

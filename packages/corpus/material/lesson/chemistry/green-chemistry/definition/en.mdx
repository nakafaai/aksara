...
Green chemistry applies across the [life cycle of a chemical product](https://www.epa.gov/greenchemistry/basics-green-chemistry), from design and manufacture to use and final fate.
...
Chemical reactions can be designed to perform a useful function <Highlight>while reducing hazards, waste, and energy use</Highlight>.
...
<BlockMath math="\begin{aligned} &amp;2\mathrm{H_2O(l)} \\ &amp;\xrightarrow{\text{electrical energy}} 2\mathrm{H_2(g)} + \mathrm{O_2(g)} \end{aligned}" />

This reaction does not directly produce carbon dioxide. Its life-cycle emissions depend on how the electricity is generated. [Electrolysis](https://www.energy.gov/cmei/fuels/hydrogen-production-electrolysis) can have very low emissions when powered by renewable or nuclear electricity. Electricity from fossil-fuel power plants gives the process higher life-cycle emissions.

Compare two electricity supplies for the same reaction. The direct products remain hydrogen and oxygen, but the emission sources outside the electrolyser differ.

| Assessment boundary | Electricity from coal combustion | Electricity from solar panels |
| :--- | :--- | :--- |
| At the electrolyser | Hydrogen and oxygen | Hydrogen and oxygen |
| At the generator | Combustion releases carbon dioxide | No fuel combustion during panel operation |
| Across the life cycle | Mining, materials, construction, operation, waste | Materials, panel manufacture, construction, end of use |
...
<BlockMath math="\begin{aligned} &amp;\mathrm{CO_2(g)} + 3\mathrm{H_2(g)} \\ &amp;\xrightarrow{\text{catalyst}} \mathrm{CH_3OH(l)} + \mathrm{H_2O(l)} \end{aligned}" />
...
The [twelve green chemistry principles](https://www.acs.org/green-chemistry-sustainability/principles/12-principles-of-green-chemistry.html) include waste prevention, atom economy, safer solvents, catalysts, energy efficiency, and design for degradation.

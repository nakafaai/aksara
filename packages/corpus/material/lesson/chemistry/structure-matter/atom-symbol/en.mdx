...
NIST's column notes explain that an element's relative atomic mass depends on isotope masses and isotopic composition. The [NIST notes](https://www.physics.nist.gov/PhysRefData/Compositions/notes.html) also explain that composition can vary with a material's origin and treatment.

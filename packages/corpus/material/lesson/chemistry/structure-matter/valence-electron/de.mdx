...
Wasserstoff ist eine wichtige Einschränkung: Er besitzt ebenfalls <InlineMath math="1" /> Valenzelektron, verhält sich aber nicht wie ein typisches Alkalimetall. Die Valenzelektronenzahl gibt einen starken Hinweis auf die Eigenschaften eines Elements. Andere Teile der Atomstruktur spielen ebenfalls eine Rolle.

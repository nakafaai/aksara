...
Pada unsur golongan utama, elektron valensi adalah <Highlight>elektron pada kulit terluar yang masih terisi</Highlight>.
...
- Unsur gas mulia seperti helium dan argon memiliki konfigurasi elektron valensi yang stabil, sehingga sangat sukar bereaksi.
...
Bacalah konfigurasi kulit, lalu ambil angka pada kulit terluar sebagai jumlah elektron valensi. Untuk golongan 1 dan 2, jumlahnya sama dengan nomor golongan. Untuk golongan 13 sampai 18, kurangi nomor golongan dengan 10. Ingat **pengecualian helium**: 2 elektron valensi, tetapi golongan 18.
...
<InlineMath math="\mathrm{Na}" /> dan <InlineMath math="\mathrm{K}" /> berada pada golongan <InlineMath math="1" />, sehingga pola yang sama memberi masing-masing <InlineMath math="1" /> elektron valensi yang mudah dilepas, dan keduanya cenderung membentuk ion <InlineMath math="+1" />. Argon lebih sukar bereaksi daripada klorin karena memiliki **konfigurasi valensi oktet** yang stabil. Oktet berarti delapan elektron valensi, bukan bahwa seluruh kapasitas kulit M yang berjumlah 18 sudah terisi. Klorin sering menerima satu elektron ketika membentuk ion atau berbagi elektron dalam ikatan kovalen.

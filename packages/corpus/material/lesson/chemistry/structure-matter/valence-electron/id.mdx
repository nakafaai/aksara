...
Elektron valensi adalah elektron pada kulit terluar yang masih terisi. [OpenStax Chemistry](https://openstax.org/books/chemistry/pages/6-4-electronic-structure-of-atoms-electron-configurations) memakai definisi ini.
...
Unsur dalam satu golongan utama sering memiliki jumlah elektron valensi yang sama. Karena itulah sifat kimianya dapat mirip. [OpenStax Chemistry 2e](https://openstax.org/books/chemistry-2e/pages/6-5-periodic-variations-in-element-properties) menjelaskan bahwa unsur dalam satu golongan memiliki jumlah elektron valensi yang sama, dan kesamaan sifat kimia muncul karena kesamaan ini.
...
Catatan kecil: hidrogen juga memiliki <InlineMath math="1" /> elektron valensi, tetapi sifatnya tidak sama dengan logam alkali. Jumlah elektron valensi memberi petunjuk kuat tentang sifat unsur. Bagian lain dari struktur atom juga berpengaruh.

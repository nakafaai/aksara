...
To picture Thomson's model, imagine plum pudding. The pudding represents spread-out positive charge, while the plums represent embedded negative electrons. This picture only helps us read the model rather than the real shape of an atom. Rutherford later improved Thomson's model.

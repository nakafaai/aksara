...
The evidence sequence runs from Thomson's cathode ray experiment through Rutherford's gold foil experiment to Chadwick's discovery of the neutron. [OpenStax Chemistry: Atoms First 2e](https://openstax.org/books/chemistry-atoms-first-2e/pages/2-2-evolution-of-atomic-theory)

J. J. Thomson discovered the electron in <InlineMath math="1897" /> and showed that this particle was far lighter than an atom. [Britannica](https://www.britannica.com/biography/J-J-Thomson)
...
These observations led to two conclusions. Atoms are mostly empty space, and their positive charge is concentrated in a tiny, relatively massive center called the **atomic nucleus**.

An atom is about <InlineMath math="10^{-10}\ \text{m}" /> across, while its nucleus is about <InlineMath math="10^{-15}\ \text{m}" /> across. The nuclear diameter is therefore about <InlineMath math="10^5" /> times smaller than the atomic diameter. [OpenStax Chemistry Atoms First 2e](https://openstax.org/books/chemistry-atoms-first-2e/pages/2-3-atomic-structure-and-symbolism)
...
Rutherford interpreted the nuclear atom in <InlineMath math="1911" /> and demonstrated free protons in <InlineMath math="1919" />. The two steps are related but distinct events. [Nobel Prize](https://www.nobelprize.org/prizes/physics/1990/9592-the-nobel-prize-in-physics-1990/)
...
Chadwick showed that radiation from beryllium bombarded with alpha particles consisted of neutral particles with about the same mass as protons. [Nobel Prize](https://www.nobelprize.org/prizes/physics/1935/chadwick/facts/)

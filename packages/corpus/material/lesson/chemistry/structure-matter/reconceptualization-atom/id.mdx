...
Dalton tidak dapat melihat atom secara langsung. Karena itu, ia mempelajari massa zat sebelum dan sesudah reaksi. Dari hasil pengukuran tersebut, ia menyusun model yang menjelaskan <Highlight>mengapa senyawa memiliki komposisi tetap</Highlight> dan mengapa massanya sering membentuk perbandingan sederhana.
  ...
  labels={{
    ...
    modes: {
      conservation: {
        ...
        facts: [
          { label: "Jumlah atom karbon", value: "2 = 2" },
          { label: "Jumlah atom oksigen", value: "4 = 4" },
      ...
      multiple: {
        ...
        facts: [
          { label: "Massa oksigen", value: "16:32" },
...
| Atom unsur yang sama dianggap identik. | Dalam model ini, dua atom karbon dianggap memiliki massa dan sifat yang sama. |

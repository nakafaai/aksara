...
Panel air memakai massa relatif bilangan bulat untuk pengantar, yaitu <InlineMath math="H \approx 1" /> dan <InlineMath math="O \approx 16" />. Karena itu, <InlineMath math="2(1):16=1:8" /> adalah pendekatan kelas, bukan klaim bahwa setiap sampel air yang diukur memiliki rasio massa tanpa desimal yang persis sama. Bobot atom standar terkini beserta rentang yang dipengaruhi komposisi isotop dikelola oleh [CIAAW](https://ciaaw.org/atomic-weights.htm).

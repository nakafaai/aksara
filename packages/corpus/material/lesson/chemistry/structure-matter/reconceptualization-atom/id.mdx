...
Panel air memakai massa relatif bilangan bulat untuk pengantar, yaitu <InlineMath math="H \approx 1" /> dan <InlineMath math="O \approx 16" />. Karena itu, <InlineMath math="2(1):16=1:8" /> adalah pendekatan kelas dan bukan klaim bahwa setiap sampel air yang diukur memiliki rasio massa tanpa desimal yang persis sama. Bobot atom standar terkini beserta rentang yang dipengaruhi komposisi isotop dikelola oleh [CIAAW](https://ciaaw.org/atomic-weights.htm).

## Lima Pernyataan yang Membuat Kimia Lebih Terukur
...
| Pernyataan Dalton | Cara membaca idenya |
| :------------ | :----------------------------- |
...
| Atom tidak berubah menjadi atom unsur lain dalam reaksi kimia biasa. | Reaksi kimia menyusun ulang atom dan bukan membuat atom baru dari nol. |
...
Bagian yang kuat dari teori Dalton adalah idenya tentang **atom sebagai unit diskret**. Diskret artinya dihitung satu-satu, seperti kelereng dan bukan mengalir bebas seperti air. Jika atom memang bergabung dalam hitungan bulat, wajar jika data massa juga sering membentuk rasio sederhana.
...
Kata **bagian** berarti satuan pembanding. Yang penting adalah perbandingannya dan bukan satuan timbang tertentu di laboratorium kelas.

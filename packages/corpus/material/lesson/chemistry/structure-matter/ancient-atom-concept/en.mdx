...
The ancient debate raised questions that later atomic theories answered with experimental evidence. [OpenStax Chemistry: Atoms First 2e](https://openstax.org/books/chemistry-atoms-first-2e/pages/2-1-early-ideas-in-atomic-theory)
...
Democritus called the smallest part *atomos*, a Greek term meaning uncuttable. [Britannica](https://www.britannica.com/biography/Democritus) [SEP](https://plato.stanford.edu/entries/atomism-ancient/)

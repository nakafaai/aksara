...
Democritus was broadly right that matter is made of very small units. However, the details are different from modern chemistry. Modern atoms still contain subatomic particles such as protons, neutrons, and electrons, so the word “indivisible” should be read as a historical idea rather than a final definition.
...
More than two thousand years later, John Dalton brought the atomic idea into modern chemistry in a new way. He used reaction mass data to answer questions about the structure of matter and build an atomic model for calculations. That is where the discussion of atoms began moving from philosophy toward chemical theory.

...
[OpenStax Chemistry: Atoms First 2e](https://openstax.org/books/chemistry-atoms-first-2e/pages/2-1-early-ideas-in-atomic-theory) menjelaskan sejarah awal teori atom. Perdebatan kuno tersebut memperkenalkan pertanyaan yang kemudian dijawab teori atom melalui bukti eksperimen.
...
Demokritos menyebut bagian terkecil itu *atomos*, istilah Yunani yang berarti tidak dapat dipotong. [Britannica](https://www.britannica.com/biography/Democritus) membahas gagasan Demokritos, sedangkan [Stanford Encyclopedia of Philosophy](https://plato.stanford.edu/entries/atomism-ancient/) membahas atomisme Yunani kuno.

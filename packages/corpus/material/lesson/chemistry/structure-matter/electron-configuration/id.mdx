...
Catatan penting: kulit <InlineMath math="\mathrm{M}" /> dapat dibahas lebih rinci pada materi lanjutan. Di sini, pola <InlineMath math="2, 8, 8, 2" /> membantu kita membaca unsur ringan. Unsur yang lebih berat memerlukan aturan pengisian yang lebih lengkap.

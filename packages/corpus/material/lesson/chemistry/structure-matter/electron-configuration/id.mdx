...
Catatan penting: kulit <InlineMath math="\mathrm{M}" /> dapat dibahas lebih rinci pada materi lanjutan. Di sini, pola <InlineMath math="2, 8, 8, 2" /> dipakai sebagai jembatan untuk membaca unsur ringan dan bukan sebagai aturan lengkap untuk semua unsur.

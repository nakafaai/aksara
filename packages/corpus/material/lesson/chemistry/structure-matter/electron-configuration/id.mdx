...
Model Bohr memakai tingkat energi diskret untuk menjelaskan spektrum garis atom hidrogen. [OpenStax Chemistry Atoms First 2e](https://openstax.org/books/chemistry-atoms-first-2e/pages/3-2-the-bohr-model)
...
Model kulit sederhana ini dibatasi pada unsur ringan sampai kalsium, yaitu <InlineMath math="Z \le 20" />. Untuk unsur yang lebih berat, kita perlu memakai subkulit dan orbital. [OpenStax Chemistry: Atoms First 2e](https://openstax.org/books/chemistry-atoms-first-2e/pages/3-4-electronic-structure-of-atoms-electron-configurations)

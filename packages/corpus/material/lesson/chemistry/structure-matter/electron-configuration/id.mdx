...
[OpenStax Chemistry Atoms First 2e](https://openstax.org/books/chemistry-atoms-first-2e/pages/3-2-the-bohr-model) menjelaskan bahwa model Bohr memakai tingkat energi diskret untuk menjelaskan spektrum garis atom hidrogen.
...
Pada tingkat ini, pola kulit sederhana <InlineMath math="2, 8, 8, 2" /> digunakan untuk <InlineMath math="20" /> unsur pertama. Unsur yang lebih berat memerlukan pembahasan subkulit yang lebih lengkap, termasuk kapasitas kulit <InlineMath math="\mathrm{M}" /> yang lebih besar.

...
Jadi, <InlineMath math="\mathrm{Na}" /> dan <InlineMath math="\mathrm{Na}^{+}" /> sama-sama unsur natrium karena jumlah protonnya tetap <InlineMath math="11" />. Bedanya, <InlineMath math="\mathrm{Na}^{+}" /> memiliki <InlineMath math="10" /> elektron dan bukan <InlineMath math="11" /> elektron.

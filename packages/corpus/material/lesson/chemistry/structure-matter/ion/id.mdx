...
export const metadata = {
  title: "Ion",
  description:
    "Atom menjadi ion, cara membedakan kation dan anion, serta cara menghitung elektron dari muatan ion.",
...
[OpenStax Chemistry Atoms First 2e](https://openstax.org/books/chemistry-atoms-first-2e/pages/2-3-atomic-structure-and-symbolism) menjelaskan bahwa ion terbentuk ketika jumlah elektron tidak sama dengan jumlah proton.
...
[IUPAC Gold Book](https://goldbook.iupac.org/terms/view/I03158) mendefinisikan ion sebagai partikel atomik atau molekuler yang memiliki muatan listrik total.

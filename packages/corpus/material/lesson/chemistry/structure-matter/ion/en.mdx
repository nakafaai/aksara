...
export const metadata = {
  title: "Ions",
  description:
    "Atoms become ions, how to distinguish cations and anions, and how to calculate electrons from ion charge.",
...
[OpenStax Chemistry Atoms First 2e](https://openstax.org/books/chemistry-atoms-first-2e/pages/2-3-atomic-structure-and-symbolism) explains that ions form when the number of electrons is not equal to the number of protons.
...
The [IUPAC Gold Book](https://goldbook.iupac.org/terms/view/I03158) defines an ion as an atomic or molecular particle that has a net electric charge.

...
So <InlineMath math="\mathrm{Na}" /> and <InlineMath math="\mathrm{Na}^{+}" /> are both sodium because the proton count stays <InlineMath math="11" />. The difference is that <InlineMath math="\mathrm{Na}^{+}" /> has <InlineMath math="10" /> electrons rather than <InlineMath math="11" /> electrons.

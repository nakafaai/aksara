...
<Highlight>A quantity value is the numerical value multiplied by the unit.</Highlight>
...
A dimension records <Highlight>which base quantities and powers form another quantity</Highlight>. Units state a measurement, while dimensions test whether the quantities on both sides of a formula are compatible.

...
Dimension is a compact way to see which base quantities build a quantity. We still need units to state measurements, while dimensions help us check whether a formula makes sense.
...
The terminology follows the JCGM International Vocabulary of Metrology definition of [quantity value](https://jcgm.bipm.org/vim/en/1.19.html).

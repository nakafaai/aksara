...
A quantity value is <Highlight>the numerical value multiplied by the unit</Highlight>.
...
A dimension records <Highlight>which base quantities and powers form another quantity</Highlight>. Units provide a reference for a measured value, while dimensions test whether the quantities on both sides of a formula are compatible.
...
The term [quantity value](https://jcgm.bipm.org/vim/en/1.19.html) used here follows the International Vocabulary of Metrology.

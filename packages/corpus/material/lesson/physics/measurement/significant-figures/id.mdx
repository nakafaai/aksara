...
Pada notasi ilmiah, pangkat seperti <InlineMath math="10^{-5}" /> hanya menunjukkan skala dan bukan angka penting baru.
...
Pada perkalian dan pembagian, aturan angka penting di tingkat sekolah memakai jumlah angka penting paling sedikit di antara data ukur. Aturan ini adalah cara ringkas untuk melaporkan hasil dan bukan pengganti perambatan ketidakpastian jika nilai ketidakpastian pengukuran tersedia.

...
For multiplication and division, the classroom significant-figure rule uses the smallest number of significant figures among the measured data. It is a reporting shortcut, not a replacement for uncertainty propagation when measured uncertainties are available.

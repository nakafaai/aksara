...
For addition and subtraction, round by decimal position. For multiplication and division, round by the fewest significant figures among the measured values. Round-to-even and one-step rounding prevent repeated rounding from biasing the result. [OpenStax University Physics](https://openstax.org/books/university-physics-volume-1/pages/1-6-significant-figures) [Handbook 130](https://www.nist.gov/document/2023-nist-hb130-uniform-packaging-and-labeling-regulation)

...
Das Internationale Einheitensystem, kurz SI, verwendet <InlineMath math="7" /> Grundgrößen. In der Dimensionsanalyse bilden sie ein Alphabet, aus dem sich weitere Größen zusammensetzen lassen.
...
[OpenStax University Physics](https://openstax.org/books/university-physics-volume-1/pages/1-4-dimensional-analysis) erklärt die Dimensionsanalyse ausführlicher.

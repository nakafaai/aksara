...
export const metadata = {
  ...
  description:
    "Verstehe physikalische Dimensionen als Bauplan aus Grundgrößen, leite die Dimensionen abgeleiteter Größen her und prüfe Formeln ohne Zahlenwerte.",
  authors: [{ name: "Nabil Akbarazzima Fatih" }],
  date: "2026-04-25",
  subject: "Messen in der Naturwissenschaft",
};

## Dimension bedeutet mehr als räumliche Größe

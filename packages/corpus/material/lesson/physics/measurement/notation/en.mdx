...
In scientific notation, the number of significant figures is read from the coefficient rather than from the power of <InlineMath math="10" />.
...
Measurement-value writing references from the NIST Guide to the SI and OpenStax Significant Figures can be opened through [the NIST writing rules](https://www.nist.gov/pml/special-publication-811/nist-guide-si-chapter-7-rules-and-style-conventions-expressing-values), [the NIST conversion procedure](https://www.nist.gov/pml/special-publication-811/nist-guide-si-appendix-b-conversion-factors), and [the OpenStax lesson](https://openstax.org/books/university-physics-volume-1/pages/1-6-significant-figures).

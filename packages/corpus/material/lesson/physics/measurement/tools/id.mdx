...
Setiap kali kita menimbang bahan makanan, melihat speedometer, membaca suhu tubuh, atau mengukur panjang meja, kita sedang melakukan pengukuran. Dalam fisika, pengukuran adalah <Highlight>proses eksperimental untuk memperoleh satu atau beberapa nilai besaran</Highlight>. Satuan pengukuran menyediakan <Highlight>acuan bersama</Highlight>.
...
Simbol <InlineMath math="\tau" /> menyatakan besar momen gaya, yaitu efek gaya yang memutar neraca. Panjang lengan kedua sisi adalah <InlineMath math="r" />, dan <InlineMath math="g" /> adalah besar percepatan gravitasi. Karena lengan sama panjang, massa yang sama menghasilkan momen gaya berlawanan arah dengan besar yang sama.
...
Banyak besaran sehari-hari dapat dibaca langsung pada alat ukur. Besaran lain, seperti massa jenis, dapat dihitung dari beberapa hasil pengukuran. Tabel berikut memasangkan alat ukur yang umum dengan besaran yang dilaporkannya, supaya kamu memilih alat dari besaran yang ingin diukur.
...
| Speedometer | <Highlight>Kelajuan kendaraan</Highlight> |
...
Definisi [pengukuran](https://jcgm.bipm.org/vim/en/2.1.html) dan [nilai besaran](https://jcgm.bipm.org/vim/en/1.19.html) mengikuti dua entri dalam International Vocabulary of Metrology.

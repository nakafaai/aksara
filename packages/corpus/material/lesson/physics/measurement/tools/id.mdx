...
export const metadata = {
  ...
  description:
    "Alat ukur fisika dipilih berdasarkan besaran dan rentang yang diukur, lalu hasil pengukurannya ditulis bersama satuannya.",
...
> Pilih alat yang besaran, rentang, dan skalanya sesuai dengan tugas pengukuran. Angka yang terbaca rapi dari alat yang salah tetap tidak menjawab pertanyaan pengukuran.
...
Tentukan dulu besaran yang akan diukur. Perkiraan rentang dan ketelitian yang dibutuhkan menentukan alat ukurnya, sedangkan jenis besaran menentukan satuan untuk melaporkan hasil.
...
Massa menunjukkan seberapa kuat benda menolak perubahan gerak. Neraca mengukurnya dengan membandingkan benda terhadap massa acuan. Jika neraca menunjukkan <InlineMath math="250 \text{ g}" />, maka massa benda tersebut adalah:
...
Contoh pensil tadi memuat tiga bagian: panjang sebagai besaran yang dicari, penggaris sebagai alat ukur, dan <InlineMath math="13\text{ cm}" /> sebagai hasil beserta satuannya. Ketiga bagian ini menjelaskan apa yang diukur dan memungkinkan pembaca membandingkannya dengan panjang lain yang memakai satuan sama.

Definisi pengukuran dari [JCGM VIM](https://jcgm.bipm.org/vim/en/2.1.html) dan definisi nilai besaran dari [JCGM VIM](https://jcgm.bipm.org/vim/en/1.19.html) mengikuti International Vocabulary of Metrology.

...
Tiga contoh berikut melatih cara membaca alat ukur dari titik awal, nilai yang ditunjuk, dan satuan yang dipakai. Tujuannya adalah mendapatkan angka sekaligus memahami artinya.
...
Dari contoh pensil tadi, pola kerja pengukuran jadi terlihat: tentukan dulu besaran yang dicari, pilih alat yang sesuai, lalu tulis hasilnya bersama satuan. Kalau <InlineMath math="3" /> hal itu jelas, hasil pengukuran dapat dibandingkan dan dipakai untuk kerja ilmiah berikutnya.

Istilah yang dipakai mengikuti definisi [pengukuran](https://jcgm.bipm.org/vim/en/2.1.html) dan [nilai besaran](https://jcgm.bipm.org/vim/en/1.19.html) dalam International Vocabulary of Metrology dari JCGM.

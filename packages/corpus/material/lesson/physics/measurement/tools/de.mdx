...
Beim Ablesen eines Lineals zählt nicht nur die Zahl am rechten Ende. Prüfe auch die Anfangsposition. Beginnt der Gegenstand bei <InlineMath math="0 \text{ cm}" /> und endet bei <InlineMath math="8 \text{ cm}" />, ergibt sich:

...
The pencil example shows the measurement pattern: identify the quantity, choose a suitable tool, and write the result with its unit. A result with all <InlineMath math="3" /> parts can be compared and used in later scientific work.

The terminology follows the JCGM International Vocabulary of Metrology definitions of [measurement](https://jcgm.bipm.org/vim/en/2.1.html) and [quantity value](https://jcgm.bipm.org/vim/en/1.19.html).

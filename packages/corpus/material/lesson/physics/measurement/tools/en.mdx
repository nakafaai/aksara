...
<Highlight>Every time we weigh food ingredients, look at a speedometer, read body temperature, or measure the length of a table, we are measuring something.</Highlight> In physics, measurement is the experimental process of obtaining one or more quantity values. A measurement unit supplies the shared reference.

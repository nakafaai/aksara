...
Every physical quantity has tools that read it directly. The table pairs a common instrument with the quantity it reports, so you can choose the tool from the quantity you need instead of from habit.

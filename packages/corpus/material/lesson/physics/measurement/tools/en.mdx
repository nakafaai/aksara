...
The definitions of measurement and quantity value follow separate entries in the International Vocabulary of Metrology. [JCGM VIM Measurement](https://jcgm.bipm.org/vim/en/2.1.html) [JCGM VIM Quantity Value](https://jcgm.bipm.org/vim/en/1.19.html)

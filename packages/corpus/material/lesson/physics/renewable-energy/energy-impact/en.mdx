...
<BlockMath math="\text{resource exploration}\rightarrow\text{resource extraction}\rightarrow\text{conversion}\rightarrow\text{distribution}\rightarrow\text{use}\rightarrow\text{residue}" />

...
The symbol <InlineMath math="\gg" /> means "much greater than". <Highlight>To judge a fuel supply, check how much is available and how quickly it is being used.</Highlight>

## Fossil Fuels and Nuclear Fuel

The two main groups of non-renewable sources are fossil fuels and nuclear fuel. [**Fossil fuels**](https://www.eia.gov/energyexplained/what-is-energy/sources-of-energy.php) formed from ancient living remains that were buried, then changed by pressure and heat over <InlineMath math="\text{millions of years}" />.

...
The U.S. Energy Information Administration (EIA) explains that the total amount of energy stays constant while energy changes form. Every conversion produces useful energy along with energy that the device cannot use for its purpose. EIA's Laws of Energy page can be opened through [this source link](https://www.eia.gov/energyexplained/what-is-energy/laws-of-energy.php).
...
| :--------- | :------------------- | :------------------------- |
| Hydropower plant | <InlineMath math="\text{gravitational potential of water}\rightarrow\text{water motion}\rightarrow\text{turbine}\rightarrow\text{generator}\rightarrow\text{electricity}" /> | shaft heat, sound, vibration |
| Wind turbine | <InlineMath math="\text{wind kinetic energy}\rightarrow\text{turbine}\rightarrow\text{generator}\rightarrow\text{electricity}" /> | sound, vibration, component heat |
...
| Geothermal power | <InlineMath math="\text{reservoir thermal energy}\rightarrow\text{moving steam or working fluid}\rightarrow\text{turbine}\rightarrow\text{generator}\rightarrow\text{electricity}" /> | waste heat and system friction |

...
[Pengelola proyek PLTMH di sekitar Air Terjun Kali Pedati](https://paitonenergy.com/en/energy-learning-house-program-for-climate-change-mitigation/) melaporkan kapasitas terpasang sebesar <InlineMath math="7 \text{ kW}" />. Proyek ini dikelola oleh kelompok yang terdiri atas <InlineMath math="14" /> rumah tangga, dan pengelola yang sama menyebut sekitar <InlineMath math="500 \text{ W}" /> per rumah tangga. Coba cek apakah kedua angka itu cocok: <InlineMath math="14\times500 \text{ W}=7\,000 \text{ W}" />, atau <InlineMath math="7 \text{ kW}" />. Angka tersebut berasal dari pengelola proyek, bukan dari pengukuran jangka panjang oleh pihak independen. Data produksi listrik yang independen masih diperlukan untuk menilai kinerja pembangkit dari waktu ke waktu.

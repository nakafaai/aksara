export const metadata = {
  ...
  description:
    "Rencanakan sistem listrik yang andal, terawat, dan adil berdasarkan kebutuhan energi, sumber lokal, dan kondisi operasi sistem.",
...
[DOE](https://www.energy.gov/cmei/water/how-hydropower-works) menjelaskan prinsip tenaga air. Air mengalir menuju turbin, turbin berputar, lalu generator menghasilkan listrik.
...
Rumus tersebut memperkirakan daya dari massa jenis air, gravitasi, debit, beda tinggi, dan efisiensi. Debit dan beda tinggi yang lebih besar menaikkan hasil perkiraan, tetapi rancangan teknik lengkap juga memerlukan data lokasi dan keselamatan.

Untuk proyek Desa Plaosan, [Paiton Energy](https://paitonenergy.com/en/energy-learning-house-program-for-climate-change-mitigation/) melaporkan kapasitas terpasang PLTMH sebesar <InlineMath math="7 \text{ kW}" /> yang dikelola kelompok beranggotakan <InlineMath math="14" /> rumah tangga di sekitar Air Terjun Kali Pedati. Paiton Energy juga menyebut alokasi sekitar <InlineMath math="500 \text{ W}" /> per rumah tangga, sesuai dengan <InlineMath math="14\times500 \text{ W}=7\,000 \text{ W}" />. Angka tersebut menggambarkan proyek menurut laporan Paiton Energy. Data produksi listrik jangka panjang dari pihak independen masih diperlukan untuk memastikan kinerja pembangkit dari waktu ke waktu.
...
[IEA](https://www.iea.org/energy-system/energy-efficiency-and-demand/energy-efficiency) menjelaskan bahwa efisiensi energi dapat menurunkan permintaan energi dan emisi.
...
Sustainable Development Goals (SDGs), atau Tujuan Pembangunan Berkelanjutan, adalah agenda global yang disepakati negara-negara anggota Perserikatan Bangsa-Bangsa untuk memperbaiki kesejahteraan manusia dan menjaga lingkungan. Dalam [Agenda 2030](https://sdgs.un.org/2030agenda), United Nations menetapkan <InlineMath math="17" /> tujuan pembangunan berkelanjutan yang saling terhubung.

Pada topik energi, tujuan yang paling dekat adalah SDG <InlineMath math="7" />, yaitu energi bersih dan terjangkau.

[United Nations](https://sdgs.un.org/goals/goal7) menjelaskan bahwa SDG <InlineMath math="7" /> menargetkan akses energi yang terjangkau, andal, berkelanjutan, dan modern untuk semua.

...
Begin with the demand, <Highlight>identify a suitable local source</Highlight>, and plan how its energy will be converted. Then decide how to distribute or store the energy so it can provide the required service.
...
[Water flows toward a turbine](https://www.energy.gov/cmei/water/how-hydropower-works), the turbine spins, and the generator produces electricity.
...
[Energy efficiency](https://www.iea.org/energy-system/energy-efficiency-and-demand/energy-efficiency) can reduce energy demand and emissions.
...
The [Sustainable Development Goals](https://sdgs.un.org/2030agenda) are a global agenda agreed by United Nations member states to improve human well-being and protect the environment. The <InlineMath math="2030" /> Agenda contains <InlineMath math="17" /> connected goals.

Meeting energy demand relates directly to SDG <InlineMath math="7" />, which focuses on **affordable and clean energy**.

SDG <InlineMath math="7" /> aims to ensure [access to affordable, reliable, sustainable, and modern energy](https://sdgs.un.org/goals/goal7) for all.

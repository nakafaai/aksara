...
The project page reports an installed microhydropower capacity of <InlineMath math="7 \text{ kW}" /> near Kali Pedati Waterfall, managed by a group of <InlineMath math="14" /> households. It also reports about <InlineMath math="500 \text{ W}" /> per household, consistent with <InlineMath math="14\times500 \text{ W}=7\,000 \text{ W}" />. These are figures reported by the project operator. Independent long-term electricity-production data would be needed to confirm performance over time. [Paiton Energy](https://paitonenergy.com/en/energy-learning-house-program-for-climate-change-mitigation/)

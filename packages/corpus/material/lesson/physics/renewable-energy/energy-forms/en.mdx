...
Heat is energy transferred because of a temperature difference. So an object does not "store heat" like it stores an item in a drawer. An object has internal energy, and heat flows when there is a temperature difference. If the substance does not change phase and its specific heat is treated as constant over the temperature interval, the transferred energy is:

...
<Mermaid
  ...
  description="Ikuti contoh sehari-hari untuk melihat energi berpindah bentuk dan tempat dan bukan hilang begitu saja."
  chart={`flowchart TD
...
Inilah alasan tagihan listrik memakai <InlineMath math="\text{kWh}" /> atau kilowatt-jam. Walaupun ada kata watt, <InlineMath math="\text{kWh}" /> adalah satuan energi dan bukan satuan daya.

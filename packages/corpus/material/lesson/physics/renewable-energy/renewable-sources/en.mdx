...
Renewability describes how the source is replenished. It does not promise unlimited power at every place and time.

<BlockMath math="\text{renewable source}\neq\text{unlimited power at every place and time}" />
...
| Ocean | Start from mechanical energy in waves, tides, and currents, or thermal energy in the difference between warm surface water and cold deep water. Then check whether the local resource is usable. |

This table turns energy choice into a field check. It asks whether sunlight, space, weather, maintenance, and electricity needs make solar panels a sensible choice.
...
This way, you can judge renewable energy as a real system with a natural source, conversion path, useful energy, site limits, and impacts that still need to be measured.

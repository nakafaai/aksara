...
<Highlight>An energy supply must be available when people need it and reach the places where it is used.</Highlight> Cost and environmental effects also matter. If the supply fails, lighting, water pumps, medical devices, food cooling, and communication networks can stop working.

...
A posted limit of <InlineMath math="80 \text{ km/h}" /> constrains a vehicle's speed at each moment, not its average speed over the whole trip. A roadside detector therefore reads an instantaneous state as the vehicle passes.

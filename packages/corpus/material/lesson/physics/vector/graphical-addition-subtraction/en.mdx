...
For more than two vectors, use the polygon method. The rule is still the same: <Highlight>place the tail of each next vector</Highlight> at the tip of the previous vector.

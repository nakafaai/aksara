...
### Genom Kapsid und optionale Hülle
...
Genomtyp, Kapsidstruktur, das Vorhandensein einer Hülle, Genexpressionsstrategie, Wirtsspektrum und Sequenzverwandtschaft können zur Klassifikation von Viren beitragen. Das International Committee on Taxonomy of Viruses, kurz [ICTV](https://ictv.global/about/taxonomy), erläutert den Vergleich dieser Merkmale. [OpenStax Biology 2e](https://openstax.org/books/biology-2e/pages/21-1-viral-evolution-morphology-and-classification) bietet eine kompakte Einführung.

### Jeder Bestandteil des Virions hat eine Funktion

In der Forschung werden Viren anhand ihrer Zusammensetzung, Struktur, Klassifikation und Wirkung auf Wirte verglichen. Eine virologische Übersichtsarbeit in [NCBI PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC7148634/) beschreibt diese Merkmale. Die folgende Tabelle vergleicht Hauptbestandteile, die bei vielen Viren vorkommen.
...
Das nächste Modell zeigt die Oberfläche von **SARS-CoV-2** genauer als die allgemeine Darstellung darüber. Kryoelektronentomografie intakter Virionen zeigte eine Lipiddoppelschicht, aus der Spike-Trimere herausragen. Diese Spikes binden an den ACE2-Rezeptor und vermitteln den Eintritt in geeignete Zielzellen, wie eine Studie in [Nature](https://www.nature.com/articles/s41586-020-2665-2) berichtet. Dieses Modell steht für ein umhülltes Virus. Andere Viren können anders geformt und aufgebaut sein.
...
## Einem Virus fehlt die vollständige Zellmaschinerie
...
Außerhalb einer Wirtszelle kann ein Virion eine Zeit lang bestehen, an eine geeignete Zelle binden und sein Genom übertragen. Erst dann kann die Zellmaschinerie die Virusinformation umsetzen.

### Die Abhängigkeit begrenzt die Aktivität außerhalb von Zellen

Viren stehen an der Grenze zwischen Chemie und Leben. Außerhalb einer Zelle nimmt ein Virion keine Nahrung auf, betreibt keine Zellatmung und repariert sich nicht selbst. In einer geeigneten Zelle kann sein Genom dagegen Proteinproduktion und Genomkopie umlenken. Das Virus trägt also genetische Informationen, besitzt aber nicht die vollständige Maschinerie, um sie allein umzusetzen.

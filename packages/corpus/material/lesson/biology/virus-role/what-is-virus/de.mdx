...
Das nächste Modell unterscheidet sich von der allgemeinen Übersicht. Es zeigt die Oberfläche von **SARS-CoV-2** etwas realistischer. Kryoelektronentomografie intakter Virionen zeigte eine Lipiddoppelschicht, aus der Spike-Trimere herausragen. Diese Spikes binden an den ACE2-Rezeptor und vermitteln den Eintritt in geeignete Zielzellen, wie eine [primäre Strukturstudie in Nature](https://www.nature.com/articles/s41586-020-2665-2) berichtet. Dieses Modell steht für ein umhülltes Virus. Andere Viren können anders geformt und aufgebaut sein.

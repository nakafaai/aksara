...
Genomtyp, Kapsidstruktur, das Vorhandensein einer Hülle, Genexpressionsstrategie, Wirtsspektrum und Sequenzverwandtschaft dienen zur Klassifikation von Viren. [ICTV](https://ictv.global/about/taxonomy) [OpenStax Biology 2e](https://openstax.org/books/biology-2e/pages/21-1-viral-evolution-morphology-and-classification)

### Jeder Bestandteil des Virions hat eine Funktion

Viren lassen sich anhand ihrer Zusammensetzung, Struktur, Klassifikation und Wirkung auf Wirte vergleichen. Die folgende Tabelle zeigt die Hauptbestandteile vieler Viren. [NCBI PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC7148634/)

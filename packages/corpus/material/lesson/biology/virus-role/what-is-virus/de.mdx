...
Ein Virion enthält Erbmaterial in schützenden Strukturen. Für die Herstellung neuer Virusbestandteile ist es auf eine Wirtszelle angewiesen, denn ein Virion besitzt keine Ribosomen und kann selbst keine Energie gewinnen. Die Abschnitte unten trennen die Bestandteile eines Virions von ihren Aufgaben.
...
Genomtyp, Kapsidstruktur, das Vorhandensein einer Hülle, Genexpressionsstrategie, Wirtsspektrum und Sequenzverwandtschaft dienen zur [Klassifikation von Viren](https://ictv.global/about/taxonomy).
...
Das nächste Modell zeigt die Oberfläche von **SARS-CoV-2** genauer als die allgemeine Darstellung darüber. [Kryoelektronentomografie intakter Virionen](https://www.nature.com/articles/s41586-020-2665-2) zeigte eine Lipiddoppelschicht, aus der Spike-Trimere herausragen. Diese Spikes binden an den ACE2-Rezeptor und vermitteln den Eintritt in geeignete Zielzellen. Dieses Modell steht für ein umhülltes Virus. Andere Viren können anders geformt und aufgebaut sein.
...
Lebende Zellen besitzen normalerweise eine Zellmembran, Zytoplasma, Ribosomen und einen eigenen Stoffwechsel. Als **Stoffwechsel** bezeichnet man die chemischen Reaktionen, mit denen eine Zelle Energie gewinnt und ihre Bestandteile aufbaut. <Highlight>Ein Virus besitzt weder Ribosomen</Highlight> noch einen vollständigen eigenen Stoffwechsel.

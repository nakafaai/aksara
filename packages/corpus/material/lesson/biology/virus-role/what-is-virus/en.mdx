...
A virion contains genetic material inside protective structures. It depends on a host cell to produce new viral components, because a virion has no ribosomes and cannot generate energy on its own.

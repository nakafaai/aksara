...
A virion cannot reproduce on its own. <Highlight>It has no ribosomes and cannot generate energy, so the host cell copies the viral genome and builds the protein coat around it.</Highlight>

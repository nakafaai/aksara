...
A virion **cannot reproduce on its own** because it lacks ribosomes and a complete energy-supplying system. Inside a host cell, viral enzymes, host enzymes, or both copy the genome. Host ribosomes produce viral proteins, which are then assembled with genome copies.
  ...
  labels={{
    ...
    items: [
      ...
      },
      {
        ...
        takeaway: <>The viral genome carries genetic information. Viral or host enzymes copy it inside the cell, while host ribosomes make viral proteins.</>,
      },
      {
        tab: "Envelope",

...
A virion contains genetic material inside protective structures. It depends on a host cell to produce new viral components, because a virion has no ribosomes and cannot generate energy on its own. The sections below separate the parts of a virion from the functions they perform.
...
[Virus classification](https://ictv.global/about/taxonomy) compares genome type, capsid structure, the presence of an envelope, gene-expression strategy, host range, and sequence relationships.
...
Living cells usually have a cell membrane, cytoplasm, ribosomes, and metabolic reactions. **Metabolism** is the set of chemical reactions that lets a cell obtain energy and build its own parts. <Highlight>A virus has no ribosomes</Highlight> or complete metabolic system of its own.

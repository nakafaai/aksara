...
The lytic and lysogenic cycles in this lesson are bacteriophage models, not a universal two-way scheme for every virus. Animal viruses use more varied replication strategies, and latency or persistent infection should not be renamed lysogeny.

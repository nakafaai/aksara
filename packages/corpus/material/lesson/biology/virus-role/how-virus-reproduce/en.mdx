...
The lytic and lysogenic cycles in this lesson are bacteriophage models rather than a universal two-way scheme for every virus. Animal viruses use more varied replication strategies, and latency or persistent infection should not be renamed lysogeny.
    ...
    items: [
      {
        ...
        focus: <>Notice that the key material entering first is the viral genome rather than the whole phage body.</>,
...
| Synthesis | Viral genomes and proteins are made | Parts are being produced rather than assembled yet |
| Assembly and release | New virions form and leave | New viruses are built from parts rather than by one virus splitting |

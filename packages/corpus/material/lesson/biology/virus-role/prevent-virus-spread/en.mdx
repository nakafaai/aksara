...
[CDC](https://www.cdc.gov/infection-control/hcp/isolation-precautions/scientific-review.html) distinguishes transmission through contact, droplets, air, blood or body fluids, and other routes. Knowing the route helps us choose a measure that can interrupt it.
...
Every transmission route has a point where it can be interrupted. Understanding those points turns prevention into a clear use of biology.

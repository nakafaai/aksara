...
First determine how the virus spreads. The route may involve respiratory droplets and aerosols, hands and surfaces, blood or body fluids, food and water, or a vector such as a mosquito. A **vector** is an organism that carries a pathogen from one host to another.
...
Viruses can spread through contact, droplets, air, blood or body fluids, and other [routes](https://www.cdc.gov/infection-control/hcp/isolation-precautions/scientific-review.html). <Highlight>The route determines which measure can interrupt transmission</Highlight>.

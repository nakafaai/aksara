...
[CDC](https://www.cdc.gov/infection-control/hcp/isolation-precautions/scientific-review.html) distinguishes transmission through contact, droplets, air, blood or body fluids, and other routes. The route determines which measure can interrupt transmission.
...
<Mermaid
  ...
  chart={`flowchart TD
    A["Identify the route"] --> B["Respiratory particles"]
    A --> C["Surface contact"]

...
Diese ökologische Rolle ist nicht bloß eine Vermutung. Eine [wissenschaftliche Übersichtsarbeit über marine Phagen](https://www.nature.com/articles/s41564-018-0166-y) beschreibt ihre Auswirkungen auf die Sterblichkeit von Bakterien, den Wirtsstoffwechsel, Nährstoffkreisläufe und horizontalen Gentransfer.
    ...
    items: [
      {
        ...
        focus: <>Der Schaden entsteht durch Replikation in der Wirtszelle, nicht durch bloßen Kontakt mit ihrer Oberfläche.</>,
      ...
      },
      {
        ...
        takeaway: <>In der Natur interagieren Viren nicht nur mit Menschen, sondern auch mit Bakterien, Tieren, Pflanzen und anderen Mikroorganismen.</>,
      },
      {
        tab: "Biotechnologie",
        caption: <>Ein viraler Vektor trägt genetisches Material zu einer Zielzelle und verdeutlicht den kontrollierten Transport.</>,
        ...
        takeaway: <>Die Biotechnologie nutzt den Transport genetischer Information, nicht die unkontrollierte Ausbreitung eines Virus.</>,
      },
    ],
  }}
/>

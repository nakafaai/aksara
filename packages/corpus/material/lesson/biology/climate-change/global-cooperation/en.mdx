...
[UNFCCC](https://unfccc.int/process-and-meetings/the-paris-agreement/nationally-determined-contributions-ndcs) calls these country plans NDCs, contributions that include efforts to reduce emissions and adapt to climate impacts. NDCs make cooperation more concrete because each country must state the steps it will take toward the shared goal.

The cycle does not end when an NDC is submitted. Under the enhanced transparency framework, countries report actions, progress, and support. The [global stocktake](https://unfccc.int/topics/global-stocktake) then assesses collective progress every five years and informs the next round of plans. It checks the world together rather than a league table that ranks one country against another.

...
Human-caused carbon dioxide emissions come mainly from [burning fossil fuels and biological materials](https://www.epa.gov/ghgemissions/overview-greenhouse-gases). Methane is linked to **energy production, agriculture, and organic waste decay**. Nitrous oxide can come from agriculture, industry, combustion, and wastewater treatment.
...
<Mermaid
  ...
  chart={`flowchart LR
    ...
    C["Organic waste decays with little oxygen"] --> D["Methane"]

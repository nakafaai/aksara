...
Perubahan iklim dinilai dari **pola jangka panjang**, dengan membandingkan beberapa indikator yang independen. Satu kejadian cuaca hanya menggambarkan kondisi sesaat. Catatan yang panjang membantu membedakan perubahan yang menetap dari naik turunnya cuaca lokal.

### Cuaca Berubah Cepat dan Iklim Diukur Selama Puluhan Tahun

Cuaca adalah kondisi atmosfer dalam waktu pendek, misalnya hari ini hujan, panas, atau berawan. **Iklim** dijelaskan melalui statistik dan pola cuaca selama puluhan tahun. [Nilai normal iklim standar](https://wmo.int/wmo-climatological-normals) memakai periode <InlineMath math="30" /> tahun. Perubahan iklim dinilai melalui perubahan yang bertahan dalam catatan panjang. <Highlight>Satu hari yang panas belum menunjukkan perubahan iklim</Highlight>.
...
Pemanasan global, peningkatan panas laut, penyusutan es, dan kenaikan muka laut menjadi [bukti perubahan iklim](https://science.nasa.gov/climate-change/evidence/) dari beberapa pengukuran yang berbeda.

### Indikator Berbeda Dapat Mendukung Kesimpulan yang Sama

Laut telah menyerap lebih dari <InlineMath math="90\%" /> [kelebihan panas dalam sistem Bumi](https://www.climate.gov/news-features/understanding-climate/climate-change-ocean-heat-content) akibat pemanasan oleh manusia. Karena itu, penilaian iklim mengukur panas laut bersama suhu di daratan.

Ilmuwan membandingkan data satelit, pengukuran laut, catatan suhu, dan pengamatan es. Suhu laut dapat **meningkat sementara massa es menurun**. Arah angkanya berbeda, tetapi kedua perubahan dapat mendukung kesimpulan yang sama tentang pemanasan jangka panjang.

...
Mitigation works on the source of the problem. Improving energy efficiency, shifting to low-emission energy, reducing fossil fuel combustion, cutting methane from organic waste, and protecting carbon-rich ecosystems are examples. Judge the effect from measured life-cycle emissions and carbon storage. A green label alone gives too little evidence.

...
Mitigation works on the source of the problem. Improving energy efficiency, shifting to low-emission energy, reducing fossil fuel combustion, cutting methane from organic waste, and protecting carbon-rich ecosystems are examples. The effect must be checked from actual life-cycle emissions and carbon storage, not from a green label.
...
Reducing unnecessary single-use plastic can support mitigation when it lowers life-cycle production and waste emissions. The alternative must also be assessed across its life cycle so the action does not merely move emissions or other environmental harm elsewhere.
...
Adaptation is not giving up, but it is not automatically beneficial either. A poorly designed action can shift risk to another place or group, creating maladaptation. Without mitigation, risks grow and adaptation becomes less effective. Without adaptation, communities and ecosystems remain more exposed to impacts that can no longer be avoided.

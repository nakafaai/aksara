...
### Biodiversity Includes Organism Names and Their Relationships
...
Then widen the view. Around the rice, we may find fungi, small fish, frogs, aquatic insects, and other plants. We are now reading the different species present together. If the view widens again to wet soil, water current, light, and shelter, we are reading the ecosystem.
...
Indonesia is a strong example because it is large, tropical, and rich in habitat types. Much of western Indonesia lies on the Sunda Shelf and has strong Asian biogeographic affinities, while Papua lies on the Sahul Shelf and has strong Australasian affinities. Wallacea lies between them as a complex transition zone. Its boundaries are not absolute for every organism group, so biologists compare evidence from particular taxa rather than forcing all distributions onto one line. A peer-reviewed review of [Wallace's Line and the surrounding transition zones](https://doi.org/10.1111/brv.12683) explains this history and its limits. Indonesia's biodiversity reflects its environment, geological history, dispersal, evolution, and long biological interactions.
...
This scale makes observation neater. One wet field edge, garden, or forest can contain all three levels at once. The object can stay the same while the question and scale of comparison change.

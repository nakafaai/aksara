...
Indonesia is a strong example because it is large, tropical, and rich in habitat types. Much of western Indonesia lies on the Sunda Shelf and has strong Asian biogeographic affinities, while Papua lies on the Sahul Shelf and has strong Australasian affinities. Wallacea lies between them as a complex transition zone. Its boundaries differ among groups of organisms, so biologists compare evidence from each group. A peer-reviewed review of [Wallace's Line and the surrounding transition zones](https://doi.org/10.1111/brv.12683) explains this history and its limits. Indonesia's biodiversity reflects its environment, geological history, dispersal, evolution, and long biological interactions.

export const metadata = {
  ...
  description:
    "Distinguish genetic, species, and ecosystem biodiversity through rice, organisms at a rice field edge, and flowing water as habitat.",

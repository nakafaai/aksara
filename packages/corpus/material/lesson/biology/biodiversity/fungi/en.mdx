    ...
    items: [
      {
        ...
        focus: <>Branching hyphae form mycelium rather than plant roots.</>,
...
Fungal cell walls contain **chitin** rather than cellulose like plant cell walls. Chitin is also found in insect exoskeletons, so fungi should not be read as tiny plants.

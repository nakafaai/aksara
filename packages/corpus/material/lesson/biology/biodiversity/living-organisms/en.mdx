export const metadata = {
  ...
  description:
    "Explain the roles of producers, consumers, and decomposers, then trace energy flow, matter cycling, and relationships in ecosystems.",
...
### Roles Connect Organisms in an Ecosystem

[OpenStax Biology 2e](https://openstax.org/books/biology-2e/pages/46-1-ecology-of-ecosystems) explains how energy and matter move through ecosystems. Energy enters many ecosystems as sunlight and eventually dissipates as heat, while chemical elements circulate among organisms, air, water, and soil.
...
> Quick check: trace two pathways through the ecosystem. Follow energy from a food source to its consumers. Follow matter as decomposers return it to the environment for organisms to use again.
...
<Mermaid
  ...
  description="Follow energy through consumers and trace matter through decomposers to compare the two pathways in one ecosystem."
  chart={`flowchart TB

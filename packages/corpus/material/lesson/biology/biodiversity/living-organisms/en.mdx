...
<Highlight>Energy flows, but matter cycles</Highlight>. When leaves fall, animals die, or food remains are left behind, decomposers such as bacteria and fungi break them down. The products return as nutrients in soil or water.
...
Many plants [depend on pollinators](https://www.fao.org/pollination/). When pollinator numbers fall, plants reproduce less successfully and food supplies can become less stable.

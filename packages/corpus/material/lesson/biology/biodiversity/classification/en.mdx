...
For example, flight groups these animals together, but other traits separate them:

| Animal | A comparison beyond flight | Group |
| --- | --- | --- |
| Bird | Feathers and a beak | Birds |
| Bat | Hair and mammary glands | Mammals |
| Insect | Three pairs of legs and an exoskeleton | Insects |

...
export const metadata = {
  title: "Bacteria",
  description:
    "Bacteria are prokaryotic cells with varied shapes, nucleoids, ribosomes, diverse cell envelopes, and many ecological roles.",
...
Bacteria are often noticed through changes in food before their cells are seen under a microscope.
...
Prokaryotic cells contain structures such as a plasma membrane, nucleoid, and ribosomes, while their cell envelopes vary among species. Bacteria and Archaea are separate prokaryotic domains, so the term bacteria does not refer to every prokaryote. [OpenStax Biology 2e](https://openstax.org/books/biology-2e/pages/22-2-structure-of-prokaryotes-bacteria-and-archaea)
...
<BacteriaStructureLab
  ...
  description={
    <>
      ...
      Rotate the model to see the arrangement of each part from different sides.
    </>
  }
  labels={{
    chooseMode: "Choose a bacterial view",
    focusLabel: "Part to observe",
    takeawayLabel: "Function of each part",
...
The human body contains microbial communities linked to health. Studies of healthy people have mapped this microbial diversity and examined possible links with disease. Bacteria are therefore part of the body's ecosystem and can have many different roles. [NIH Human Microbiome Project](https://irp.nih.gov/catalyst/21/6/the-human-microbiome-project)

...
<Highlight>Bacteria are often noticed through changes in food before their cells are seen under a microscope.</Highlight> Souring, spoiling, and fermentation all show that a bacterial population grew, even though the cells themselves stay invisible at that scale.
...
**Bacteria** are <Highlight>unicellular prokaryotic organisms</Highlight>. **Unicellular** means the body consists of one cell. **Prokaryotic** means the genetic material is not enclosed by a nuclear membrane. Bacteria are living cells, but their internal organization differs from animal, plant, or fungal cells.
  ...
  labels={{
    ...
    items: [
      ...
      },
      {
        ...
        takeaway: <>A bacterium stays alive because its membrane, cytoplasm, DNA, ribosomes, and metabolism work together.</>,
      },
      {
        tab: "Wall",
        scene: {
...
The human body contains microbial communities linked to health. [Studies of healthy people](https://irp.nih.gov/catalyst/21/6/the-human-microbiome-project) have mapped this microbial diversity and examined possible links with disease. Bacteria are therefore part of the body's ecosystem and can have many different roles.

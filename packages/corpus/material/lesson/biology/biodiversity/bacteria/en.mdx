    ...
    items: [
      {
        ...
        focus: <>Shape shows morphology rather than the entire bacterial identity.</>,
...
Think of the nucleoid as the DNA work area rather than a closed room like a nucleus. The DNA can still be copied and used to guide cell activity without being wrapped in a nuclear membrane.
...
Their compact organization does not prevent enormous metabolic and ecological diversity. Bacteria are therefore better understood as complete, highly varied cells rather than as empty or unfinished cells.

...
Milk can become yogurt, coconut water can become nata de coco, and food kept too long can spoil. Bacteria participate in each example, although different species and processes are involved. The microorganisms are too small to see directly, yet we can observe the changes they cause.
...
Think of the nucleoid as an open work area for DNA. The DNA can be copied and used to guide cell activity without a nuclear membrane around it.
...
So bacteria should be studied with balance. Ask: "Where does this bacterium live, what process does it use, and what effect does it have on other organisms?"
...
## Bacteria Are Simple, Complete Cells

Prokaryotic cells are organized even though they have no membrane-bound nucleus. Bacteria still have a membrane, cytoplasm, DNA, ribosomes, cell walls in many types, and metabolic processes.

Their compact organization does not prevent enormous metabolic and ecological diversity. Bacteria are complete cells with many different ways to live and interact with their environment.

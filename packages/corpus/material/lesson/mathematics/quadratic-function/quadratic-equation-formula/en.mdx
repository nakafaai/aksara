...
The expression <InlineMath math="b^2 - 4ac" /> in the quadratic formula is called [the discriminant](/en/subjects/mathematics/quadratic-function/quadratic-equation-types-of-root), often denoted by <InlineMath math="D" /> or <InlineMath math="\Delta" />.
...
If <InlineMath math="p" /> and <InlineMath math="q" /> are known roots, one monic quadratic equation with those roots is:

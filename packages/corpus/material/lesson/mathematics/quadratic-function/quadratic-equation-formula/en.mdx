export const metadata = {
  ...
  description: "Learn how to derive and use the quadratic formula, interpret the discriminant, and apply both ideas to real-world problems.",
...
The quadratic formula can be derived from the method of completing the square. See how:

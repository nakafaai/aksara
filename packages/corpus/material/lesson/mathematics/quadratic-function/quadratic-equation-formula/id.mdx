...
Bagian <InlineMath math="b^2 - 4ac" /> pada rumus persamaan kuadrat disebut [diskriminan](/id/materi/matematika/persamaan-dan-fungsi-kuadrat/jenis-jenis-akar-persamaan-kuadrat), biasanya dilambangkan dengan <InlineMath math="D" /> atau <InlineMath math="\Delta" />.
...
Jika <InlineMath math="p" /> dan <InlineMath math="q" /> adalah akar yang diketahui, salah satu persamaan kuadrat monik dengan akar-akar tersebut adalah:

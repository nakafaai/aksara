...
Di dalam bilangan kompleks, kedua tanda memberikan dua akar yang dihitung beserta kelipatannya. Jika diskriminan bernilai nol, kedua bentuk tersebut memberikan akar kembar yang sama:
...
Bagian <InlineMath math="b^2 - 4ac" /> disebut diskriminan dan <Highlight>menentukan jenis akar-akar persamaan</Highlight>:

export const metadata = {
  ...
  description: "Pelajari cara menurunkan dan menggunakan rumus kuadrat, menafsirkan diskriminan, serta menerapkan keduanya pada masalah nyata.",
...
Rumus persamaan kuadrat dapat diturunkan dari metode melengkapi kuadrat sempurna. Lihat bagaimana caranya:

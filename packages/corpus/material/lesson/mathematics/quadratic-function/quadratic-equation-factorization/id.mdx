export const metadata = {
  ...
  description: "Faktorkan persamaan kuadrat dengan sifat hasil kali nol, pengelompokan, dan pola khusus, lalu periksa hasilnya melalui contoh serta latihan dengan pembahasan lengkap.",
...
Akar persamaan adalah nilai <InlineMath math="x" /> yang membuat persamaan bernilai nol. Bentuk perkalian memperlihatkan nilai tersebut karena setiap faktor dapat disamakan dengan nol.

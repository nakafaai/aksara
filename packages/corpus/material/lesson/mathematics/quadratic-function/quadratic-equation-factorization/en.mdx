export const metadata = {
  ...
  description: "Factor quadratic equations with the zero-product property, grouping, and special patterns, then check each result through worked examples and practice problems.",
...
The roots are the values of <InlineMath math="x" /> that make the equation equal to zero. Product form makes those values visible because each factor can be set equal to zero.

...
1. Menentukan operasi penjumlahan <InlineMath math="x + 3" /> sebagai <InlineMath math="3x" />.
   ...
   **Contoh konkret**: Jika panjang ruangan <InlineMath math="x \text{ meter}" />, dan bertambah <InlineMath math="3 \text{ meter}" />, maka panjangnya menjadi <InlineMath math="(x + 3) \text{ meter}" /> dan bukan <InlineMath math="3x \text{ meter}" />.

...
<Highlight>Persamaan kuadrat adalah persamaan polinom dalam satu variabel</Highlight>: ia memuat <InlineMath math="x^2" /> tetapi tidak memuat pangkat <InlineMath math="x" /> yang lebih tinggi. Bentuk umum persamaan kuadrat adalah:

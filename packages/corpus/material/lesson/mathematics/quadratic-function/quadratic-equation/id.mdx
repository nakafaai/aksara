...
<Highlight>Persamaan kuadrat adalah persamaan matematika yang melibatkan bentuk kuadrat.</Highlight> Persamaan ini mengandung variabel dengan pangkat tertinggi adalah <InlineMath math="2" />. Bentuk umum persamaan kuadrat adalah:
...
Istilah kuadrat berasal dari kata bahasa Latin, yaitu _quadratus_, yang berarti membuat persegi. Dalam geometri, <InlineMath math="x^2" /> dapat menyatakan luas persegi dengan panjang sisi <InlineMath math="x" />.

## Cara Menyelesaikan Persamaan Kuadrat

Tidak semua persamaan kuadrat cocok diselesaikan dengan cara yang sama, jadi pilihan metodenya bergantung pada bentuk persamaannya. Pemfaktoran paling cepat ketika faktornya bilangan bulat, rumus kuadrat selalu bisa dipakai, dan [melengkapi kuadrat](/id/materi/matematika/persamaan-dan-fungsi-kuadrat/melengkapi-kuadrat-sempurna) sekaligus menunjukkan titik puncaknya.

...
No single method fits every quadratic equation, so the shape of the equation decides which one to use. Factorisation is quickest when the factors are whole numbers, the formula always works, and completing the square also reveals the vertex.

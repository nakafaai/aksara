...
<Highlight>A quadratic equation is a mathematical equation involving a quadratic form.</Highlight> This equation contains a variable with the highest power of <InlineMath math="2" />. The general form of a quadratic equation is:

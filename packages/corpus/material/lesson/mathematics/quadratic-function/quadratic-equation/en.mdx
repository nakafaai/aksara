...
1. Identifying the addition operation <InlineMath math="x + 3" /> as <InlineMath math="3x" />.
   ...
   **Concrete example**: If a room's length is <InlineMath math="x \text{ meters}" />, and increases by <InlineMath math="3 \text{ meters}" />, then its length becomes <InlineMath math="(x + 3) \text{ meters}" /> rather than <InlineMath math="3x \text{ meters}" />.

...
<Highlight>A quadratic equation is a polynomial equation in one variable</Highlight>: it contains <InlineMath math="x^2" /> but no higher power of <InlineMath math="x" />. The general form of a quadratic equation is:

...
Ingat bahwa bentuk kuadrat sempurna memiliki pola <InlineMath math="x^2 + 2px + p^2 = (x + p)^2" />. Kita memanfaatkan pola ini untuk mengubah persamaan kuadrat menjadi bentuk yang lebih mudah diselesaikan. Jika suku tengahnya <InlineMath math="2px" />, suku yang diperlukan untuk melengkapkan kuadrat adalah <InlineMath math="p^2" />.

...
<MathContainer>
  ...
  <BlockMath math="\begin{aligned}x &= \frac{\sqrt{3}}{2} - \frac{3}{2} \\ &= -\frac{3}{2} + \frac{\sqrt{3}}{2} \quad \text{atau} \quad x \\ &= -\frac{\sqrt{3}}{2} - \frac{3}{2} \\ &= -\frac{3}{2} - \frac{\sqrt{3}}{2}\end{aligned}" />
</MathContainer>

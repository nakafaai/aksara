...
<MathContainer>
  ...
  <BlockMath math="\begin{aligned} &amp;\text{The square of this value} \\ &amp;= \left(\frac{5}{2}\right)^2 \\ &amp;= \frac{25}{4} \end{aligned}" />
...
<MathContainer>
  ...
  <BlockMath math="\begin{aligned} &amp;\text{The square of this value} \\ &amp;= \left(\frac{3}{2}\right)^2 \\ &amp;= \frac{9}{4} \end{aligned}" />
  <BlockMath math="x^2 + 3x + \frac{9}{4} = -\frac{3}{2} + \frac{9}{4}" />
</MathContainer>
...
Not every quadratic equation produces two real solutions. The subsections below handle a negative discriminant and the remaining variations.
...
3. <InlineMath math="6x^2 + 2x + \frac{1}{6} = 0" />
   ...
   3. Add the square of half the coefficient of <InlineMath math="x" /> to both sides:
      ...
      <MathContainer>
        ...
        <BlockMath math="\begin{aligned} &amp;\text{The square of this value} \\ &amp;= \left(\frac{1}{6}\right)^2 \\ &amp;= \frac{1}{36} \end{aligned}" />
...
4. <InlineMath math="x^2 - 12x - 15 = 0" />
   ...
   2. Add the square of half the coefficient of <InlineMath math="x" /> to both sides:
      ...
      <MathContainer>
        <BlockMath math="\begin{aligned} &amp;\text{The square of this value} \\ &amp;= (-6)^2 \\ &amp;= 36 \end{aligned}" />
...
5. <InlineMath math="\frac{3}{2}x^2 - 8x - 6 = 0" />
   ...
   3. Add the square of half the coefficient of <InlineMath math="x" /> to both sides:
      ...
      <MathContainer>
        <BlockMath math="\begin{aligned} &amp;\text{The square of this value} \\ &amp;= \left(-\frac{8}{3}\right)^2 \\ &amp;= \frac{64}{9} \end{aligned}" />

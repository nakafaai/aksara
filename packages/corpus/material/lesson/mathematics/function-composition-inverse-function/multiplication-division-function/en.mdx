...
<Highlight>As with a sum or difference, the product is defined only where both original functions are defined.</Highlight> Its domain is the intersection of their domains.

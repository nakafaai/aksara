...
export const metadata = {
  ...
  description: "Learn inverse functions step by step, from their bijective requirement and formula to the reflection of their graphs.",
...
whose inverse is <InlineMath math="q^{-1}(x)=\sqrt{x}" />.

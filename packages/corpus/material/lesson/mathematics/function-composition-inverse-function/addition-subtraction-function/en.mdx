...
Substitute the requested input into the **sum already calculated**: <InlineMath math="(f+g)(x) = x^2 + 2x + 2" />
...
### Difference at minus one

Substitute the requested input into the **difference already calculated**: <InlineMath math="(f-g)(x) = -x^2 + 2x - 4" />

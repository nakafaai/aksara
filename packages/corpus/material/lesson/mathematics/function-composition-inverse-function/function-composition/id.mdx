...
Mari kita hitung hasil akhir untuk barang seharga <InlineMath math="\text{Rp}200{.}000{,}00" />. Contoh sederhana ini mengabaikan pajak, syarat pembelian minimum, dan batas harga terendah agar hanya urutan kedua operasi yang berubah.

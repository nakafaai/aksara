export const metadata = {
  ...
  description: "Learn function composition through a shopping example, sequential application, and the effect of reversing the order.",
...
Let's calculate the final price for an item worth <InlineMath math="\text{Rp}200{,}000.00" />. This simplified example ignores taxes, minimum-purchase rules, and price floors so that only the order of the two operations changes.

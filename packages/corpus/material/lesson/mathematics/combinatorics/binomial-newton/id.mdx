...
Dua pemeriksaan membantu menemukan kesalahan: **setiap suku dalam ekspansi** memiliki derajat total <InlineMath math="n" />, dan koefisien binomial bersifat simetris: <InlineMath math="\binom{n}{k} = \binom{n}{n-k}" />.

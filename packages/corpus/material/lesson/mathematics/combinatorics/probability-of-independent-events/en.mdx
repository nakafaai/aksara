...
Most mistakes in these problems come from multiplying before checking independence. The steps below put that check first and end by verifying the answer.

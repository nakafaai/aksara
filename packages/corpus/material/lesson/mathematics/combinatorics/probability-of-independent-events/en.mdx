...
Events <InlineMath math="A" /> and <InlineMath math="B" /> are **independent** when conditioning on either event <Highlight>leaves the probability of the other unchanged</Highlight>. The probability model determines this property. Timing alone does not.

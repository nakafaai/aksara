...
Die Ereignisse <InlineMath math="A" /> und <InlineMath math="B" /> sind **unabhängig**, wenn <Highlight>die Wahrscheinlichkeit des jeweils anderen unverändert bleibt</Highlight>, sobald wir eines als Bedingung voraussetzen. Unabhängigkeit ist eine Eigenschaft des Wahrscheinlichkeitsmodells. Gleichzeitig stattfindende Ereignisse sind nicht automatisch unabhängig.
...
Als Beispiel aus **einem einzigen fairen Würfelwurf** betrachten wir <InlineMath math="A=\{2,4,6\}" /> und <InlineMath math="B=\{3,6\}" />. Die Tabelle zeigt die Zugehörigkeit aller sechs Ergebnisse.
...
Die Ereignisse sind unabhängig, obwohl sie aus einem Wurf stammen und die Schnittmenge <InlineMath math="\{6\}" /> haben.
...
Bei unabhängigen Ereignissen stimmt die **bedingte Wahrscheinlichkeit** mit der gewöhnlichen Wahrscheinlichkeit überein. Wegen <InlineMath math="P(A|B) = P(A)" /> lautet die Multiplikationsregel:

<BlockMath math="P(A \cap B) = P(A|B) \times P(B) = P(A) \times P(B)" />

Setzen wir <InlineMath math="P(A|B)=P(A)" /> in die Multiplikationsregel ein, erhalten wir <InlineMath math="P(A\cap B)=P(A)P(B)" />.
...
Ein roter und ein weißer fairer Würfel werden unabhängig voneinander geworfen. Gesucht ist die Wahrscheinlichkeit dafür, dass der rote Würfel <InlineMath math="2" /> und der weiße <InlineMath math="5" /> zeigt.
...
Beim Sensorbeispiel gilt <InlineMath math="0{,}9016\le0{,}92" />, die Schranke ist also erfüllt. Sie **beweist keine Unabhängigkeit**. Diese muss weiterhin aus dem Modell oder der Gleichheit bedingter Wahrscheinlichkeiten folgen.
...
Verwende <InlineMath math="0" /> für Kopf und <InlineMath math="1" /> für Zahl. Der Ergebnisraum für <InlineMath math="3" /> Münzen enthält <InlineMath math="8" /> Ergebnisse:

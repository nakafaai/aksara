...
In the figure above, <InlineMath math="\angle ACB = \angle ADB" /> because both vertices lie on the same side of chord <InlineMath math="AB" /> and both angles subtend that chord.

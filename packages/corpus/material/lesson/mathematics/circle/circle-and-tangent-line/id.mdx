...
<LineEquation
  ...
  data={[
    ...
    },
    {
      ...
      color: "#0891b2",
      showPoints: false,
      labels: [{ text: "Garis singgung", at: 1, offset: [-1.1, 0.8, 0] }],
    },
  ]}
...
<LineEquation
  ...
  data={[
    ...
    },
    {
      ...
      color: "#0891b2",
      showPoints: false,
      labels: [{ text: <InlineMath math="\mathrm{GSPL}" />, at: 1, offset: [-5.8, 0.8, 0] }],
    },
    {
      points: (() => {
        const O1 = { x: -3, y: 0 };
...
<LineEquation
  ...
  data={[
    ...
    },
    {
      ...
      color: "#db2777",
      showPoints: false,
      labels: [{ text: <InlineMath math="\mathrm{GSPD}" />, at: 0, offset: [0.6, 0.8, 0] }],
    },
    {
      points: (() => {
        const O1 = { x: -3, y: 0 };

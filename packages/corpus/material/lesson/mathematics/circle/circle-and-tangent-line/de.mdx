...
wobei <InlineMath math="d" /> der Abstand zwischen den beiden Kreismittelpunkten ist.
...
Bestimmen Sie die Gleichung der Tangente an den Kreis <InlineMath math="x^2 + y^2 = 25" /> am Punkt <InlineMath math="(3, 4)" />.
...
Bestimmen Sie die Gleichung der Tangente an den Kreis <InlineMath math="x^2 + y^2 = 16" />, die parallel zur Geraden <InlineMath math="3x - 4y + 5 = 0" /> verläuft.
...
Bestimmen Sie die Länge der Tangente vom Punkt <InlineMath math="P(7, 1)" /> zum Kreis <InlineMath math="x^2 + y^2 = 25" />.
...
1. Bestimmen Sie die Gleichung der Tangente an den Kreis <InlineMath math="x^2 + y^2 = 36" /> im Punkt <InlineMath math="(-3, 3\sqrt{3})" />!

2. Bestimmen Sie die Gleichung der Tangente an den Kreis <InlineMath math="(x - 2)^2 + (y + 3)^2 = 25" />, die senkrecht zur Geraden <InlineMath math="2x + y - 5 = 0" /> steht!

3. Vom Punkt <InlineMath math="A(10, 0)" /> werden Tangenten zum Kreis <InlineMath math="x^2 + y^2 = 36" /> gezogen. Bestimmen Sie:

   - Länge der Tangente
   - Koordinaten von Tangentenpunkten

4. Zwei Kreise haben die Mittelpunkte <InlineMath math="O_1(-4, 0)" /> und <InlineMath math="O_2(4, 0)" /> sowie die Radien <InlineMath math="2" /> und <InlineMath math="3" />. Bestimmen Sie die Länge der äußeren gemeinsamen Tangente!

5. Bestimmen Sie die Gleichung der Tangente an den Kreis <InlineMath math="x^2 + y^2 - 6x + 4y - 12 = 0" />, die durch den Punkt <InlineMath math="(8, -2)" /> verläuft!

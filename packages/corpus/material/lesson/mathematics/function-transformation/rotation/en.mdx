...
A wheel illustrates the geometry: every point travels along a circle centered at the axle. A graph rotates in the same point-by-point way, with every point keeping its distance from the rotation center.

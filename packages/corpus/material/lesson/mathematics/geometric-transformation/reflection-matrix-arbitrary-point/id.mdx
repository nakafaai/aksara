...
2. <Highlight>Cerminkan titik yang sudah ditranslasikan terhadap titik asal</Highlight> menggunakan matriks berikut:
...
Hasil ini sama dengan aturan koordinat <InlineMath math="(x,y) \mapsto (2a-x,2b-y)" />. Dalam bentuk vektor, hubungan yang sama ditulis <InlineMath math="Q'=2P-Q" />: titik pusat merupakan <Highlight>titik tengah antara titik asal dan bayangannya</Highlight>.

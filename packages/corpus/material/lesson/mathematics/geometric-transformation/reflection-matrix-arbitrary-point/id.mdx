...
## Mencerminkan Titik terhadap Pusat Sembarang dengan Matriks
  ...
  data={[
    {
      ...
      color: "#e11d48",
      showPoints: true,
      labels: [{ text: <><InlineMath math="P(1,1)" /> - Pusat</>, at: 0, offset: [0.3, -0.5, 0] }],
    },
    {
      points: [{ x: 2, y: 3, z: 0 }],
      color: "#0891b2",
      showPoints: true,
      labels: [{ text: <><InlineMath math="Q(2,3)" /> - Asli</>, at: 0, offset: [0.3, 0.3, 0] }],
    },
    {
      points: [{ x: 0, y: -1, z: 0 }],
      color: "#059669",
      showPoints: true,
      labels: [{ text: <><InlineMath math="Q'(0,-1)" /> - Bayangan</>, at: 0, offset: [-0.8, -0.2, 0] }],
    },
    {
      points: [
        { x: 2, y: 3, z: 0 },

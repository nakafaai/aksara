...
Reflection over the line <InlineMath math="y = -x" /> <Highlight>is a geometric transformation where each point of an object is mapped to a new position</Highlight>, with the line <InlineMath math="y = -x" /> acting as a mirror.

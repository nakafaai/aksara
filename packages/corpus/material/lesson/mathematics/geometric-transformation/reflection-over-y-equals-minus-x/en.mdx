...
The image of point <InlineMath math="P(x, y)" /> is <InlineMath math="P'(-y, -x)" />. The <InlineMath math="x" /> and <InlineMath math="y" /> coordinates swap places, and both signs change.

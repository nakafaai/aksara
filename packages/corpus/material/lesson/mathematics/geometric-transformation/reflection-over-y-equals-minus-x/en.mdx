...
export const metadata = {
  ...
  description: "Reflect points, triangles, and lines across the falling diagonal using coordinate rules and worked examples.",
...
## Swapping Coordinates and Reversing Both Signs
...
The image of point <InlineMath math="P(x, y)" /> is <InlineMath math="P'(-y, -x)" />. The <InlineMath math="x" /> and <InlineMath math="y" /> coordinates swap places, and <Highlight>both signs change</Highlight>.
...
The image of point <InlineMath math="D" /> is <InlineMath math="D'(-1, -2)" />.

The following point pairs show both steps of reflection across <InlineMath math="y = -x" />:
...
<LineEquation
  ...
  description={
    <>
      ...
      <InlineMath math="A'B'C'" /> lie symmetrically about the line{" "}
      <InlineMath math="y=-x" />.
    </>
  }
  data={[
...
The line <InlineMath math="y = -4x - 2" /> is reflected across <InlineMath math="y=-x" />. Determine the equation of its image.
...
Solve the equation for <InlineMath math="y" /> to obtain the image line:
...
The image of point <InlineMath math="S(5, -9)" /> is <InlineMath math="S'(9, -5)" />.
...
The equation of the image of the line <InlineMath math="4x + 3y - 2 = 0" /> is <InlineMath math="4(-y) + 3(-x) - 2 = 0" />.

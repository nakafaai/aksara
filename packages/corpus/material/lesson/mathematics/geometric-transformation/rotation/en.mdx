...
Rotation turns every point of a figure <Highlight>through the same angle around a fixed center</Highlight>. The figure changes position and turns, while distances, angles, shape, size, and the order of its vertices are preserved.

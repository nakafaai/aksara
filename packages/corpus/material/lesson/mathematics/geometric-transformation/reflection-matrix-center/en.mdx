...
Now, we will find the <InlineMath math="2 \times 2" /> matrix, say <InlineMath math="\begin{pmatrix} r & s \\ t & u \end{pmatrix}" />, that represents this transformation.
...
2.  Matrix of <InlineMath math="PQR" /> vertices: <InlineMath math="\begin{pmatrix} 2 & 5 & 3 \\ 2 & 2 & 5 \end{pmatrix}" />.

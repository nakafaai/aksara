...
Applied systems start from a description rather than from ready-made equations. This section shows how to build the model, solve it, and then check that the solution answers the original question.

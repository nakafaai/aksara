...
A linear inequality system describes which combinations are allowed, not which single combination is correct. The two subsections below build such a model from a word problem and then compare it with a linear equation system.

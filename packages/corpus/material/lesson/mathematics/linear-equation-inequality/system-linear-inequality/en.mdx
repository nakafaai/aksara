...
<Highlight>A plan may need to stay within a budget and meet a minimum attendance target at the same time.</Highlight> Each condition removes part of the possible choices. A linear inequality system describes the choices that satisfy every condition together.

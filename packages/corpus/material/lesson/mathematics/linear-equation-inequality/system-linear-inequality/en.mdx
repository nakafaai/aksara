...
A linear inequality system describes the set of combinations that are allowed together. The two subsections below build such a model from a word problem and then compare it with a linear equation system.

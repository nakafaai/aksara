...
Ein lineares Ungleichungssystem beschreibt, welche Kombinationen zulässig sind, und nicht eine einzige richtige Kombination. Die beiden folgenden Unterabschnitte bauen ein solches Modell aus einer Textaufgabe auf und vergleichen es danach mit einem linearen Gleichungssystem.

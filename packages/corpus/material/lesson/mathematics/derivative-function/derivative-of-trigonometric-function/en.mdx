...
The sine and cosine formulas <Highlight>follow from the limit definition of the derivative</Highlight>. The remaining four can then be derived from trigonometric identities together with the product or quotient rule.

...
<MathContainer>
    <BlockMath math="\begin{aligned} &amp;y' = (2 \cos x)(\tan x) \\ &amp;+ (2 \sin x)(\sec^2 x) \end{aligned}" />
    <BlockMath math="\begin{aligned} &amp;y' = (2 \cos x)\left(\frac{\sin x}{\cos x}\right) \\ &amp;+ (2 \sin x)(\sec^2 x) \end{aligned}" />
...
<MathContainer>
  <BlockMath math="\begin{aligned} &amp;N=(-\sin x)(\sin x) \\ &amp;-(1+\cos x)(\cos x) \end{aligned}" />
...
2.  **Lösung:**
    ...
    **Schritt** 2: Produktregel anwenden
    ...
    <MathContainer>
        <BlockMath math="\begin{aligned} &amp;f'(x) = (\cos x)(\cos x) \\ &amp;+ (\sin x)(-\sin x) \end{aligned}" />

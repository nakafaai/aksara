...
> Kedua cara memberikan hasil yang sama. Penyederhanaan lebih singkat untuk contoh ini, sedangkan aturan hasil kali memperlihatkan mengapa hasilnya benar. Sebagai fungsi bernilai real, bentuk asalnya memiliki domain <InlineMath math="x \ge 0" />; proses penurunan di atas dilakukan pada bagian dalam domainnya, yaitu <InlineMath math="x>0" />.

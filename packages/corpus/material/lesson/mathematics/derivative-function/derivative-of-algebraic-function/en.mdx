...
The [derivative rules](/en/subjects/mathematics/derivative-function/properties-of-derivative-function) apply to many algebraic forms. <Highlight>For a polynomial, rational function, or expression containing a radical, first identify the structure and then choose the matching rule.</Highlight> The examples below make that decision explicit.

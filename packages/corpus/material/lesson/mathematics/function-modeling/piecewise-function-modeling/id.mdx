...
5. **Fungsi upah harian:**
   ...
   <MathContainer>
     <BlockMath math="U(t) = \begin{cases} 50000t, & \text{jika } 0 \leq t \leq 8 \\ 400000 + 75000(t-8), & \text{jika } 8 < t \leq 12 \end{cases}" />
   </MathContainer>

   Atau disederhanakan:

   <MathContainer>
     <BlockMath math="U(t) = \begin{cases} 50000t, & \text{jika } 0 \leq t \leq 8 \\ 75000t - 200000, & \text{jika } 8 < t \leq 12 \end{cases}" />
   </MathContainer>

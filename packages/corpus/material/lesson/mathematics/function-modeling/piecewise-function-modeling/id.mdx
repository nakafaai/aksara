...
Fungsi piecewise juga bisa memakai potongan kuadratik. Ini berguna ketika salah satu bagian model berubah melengkung dan bukan mengikuti garis lurus.
...
Konstanta <InlineMath math="2{,}5" /> dan <InlineMath math="17{,}5" /> menjaga agar jarak total terus bertambah dari posisi terakhir dan bukan kembali ke <InlineMath math="0" /> saat moda transportasi berubah.

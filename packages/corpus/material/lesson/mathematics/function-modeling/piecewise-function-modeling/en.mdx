...
5. **Daily wage function:**
   ...
   <MathContainer>
     <BlockMath math="U(t) = \begin{cases} 50000t, & \text{if } 0 \leq t \leq 8 \\ 400000 + 75000(t-8), & \text{if } 8 < t \leq 12 \end{cases}" />
   </MathContainer>

   Or simplified:

   <MathContainer>
     <BlockMath math="U(t) = \begin{cases} 50000t, & \text{if } 0 \leq t \leq 8 \\ 75000t - 200000, & \text{if } 8 < t \leq 12 \end{cases}" />
   </MathContainer>

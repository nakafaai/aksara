...
The constants <InlineMath math="2.5" /> and <InlineMath math="17.5" /> carry the last position into the next piece. The total distance therefore continues from the distance already traveled when the transportation mode changes.

...
### All Values in Quadrant Four

Given <InlineMath math="\cos \theta = \frac{5}{13}" /> in **quadrant** IV.
...
### Finding the Quadrant from Signs

Given <InlineMath math="\tan \theta = \frac{4}{3}" /> and <InlineMath math="\sin \theta < 0" />.

...
The identities below hold for every angle in their domain. The subsections start from the unit circle and then list the reciprocal, quotient, and parity identities.

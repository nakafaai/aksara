...
In trigonometry, an equation that is true for every angle in its domain is a **trigonometric identity**. Identities let us rewrite expressions, prove equivalent forms, and solve equations without changing their value.

## Basic Trigonometric Identities

### Pythagorean Identity

Start with the most fundamental identity. Consider a unit circle with point <InlineMath math="P(x, y)" /> that forms angle <InlineMath math="\theta" /> with the positive <InlineMath math="x" />-axis.

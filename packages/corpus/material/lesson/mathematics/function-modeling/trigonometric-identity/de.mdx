...
Die folgenden Identitäten gelten für jeden Winkel in ihrem Definitionsbereich. Die Unterabschnitte unten beginnen beim Einheitskreis und listen dann die reziproken, die Quotienten- und die Paritätsidentitäten auf.
...
Aus einem bekannten Funktionswert lassen sich die übrigen Werte ableiten, wenn du die Lage des Winkels kennst. Die Beispiele unten wählen die Identität, die den gesuchten Wert direkt liefert.

...
Jede Identität gilt für jeden Winkel in ihrem Definitionsbereich, sodass du eine Seite überall durch die andere ersetzen darfst. Alle folgen aus dem Einheitskreis, und jede ersetzt einen schwierigen Ausdruck durch einen einfacheren.
...
Ein Beweis beginnt mit einer Seite der Gleichung und formt sie mit bekannten Identitäten um, bis sie der anderen Seite entspricht. Schreibe jeden Schritt auf, damit nachvollziehbar bleibt, welche Identität du benutzt hast.
...
<MathContainer>
  <BlockMath math="= \frac{1}{\cos \theta}" />
...
Ist der Wert einer trigonometrischen Funktion bekannt, lassen sich die übrigen Werte bestimmen, sobald der Quadrant des Winkels feststeht. Für jede Aufgabe liefert die passende Identität den fehlenden Wert direkt.

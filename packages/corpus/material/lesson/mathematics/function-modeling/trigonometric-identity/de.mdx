...
**Aufgabe 3**. Gegeben <InlineMath math="\cos \theta = \frac{5}{13}" /> im Quadranten IV.
...
**Aufgabe 5**. Gegeben sind <InlineMath math="\tan \theta = \frac{4}{3}" /> und <InlineMath math="\sin \theta < 0" />.

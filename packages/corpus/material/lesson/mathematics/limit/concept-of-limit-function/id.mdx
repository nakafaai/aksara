export const metadata = {
    ...
    description: "Pahami limit melalui tabel nilai, perilaku satu sisi, definisi epsilon-delta, dan contoh yang dibahas tuntas.",
...
**Limit** menanyakan perilaku nilai keluaran di sekitar suatu titik ketika input mendekati titik tersebut. Pertanyaan awalnya **bukan** nilai fungsi tepat di titik itu. Perbedaan ini memungkinkan kita membahas lubang yang dapat dihilangkan, lompatan, atau asimtot tegak tanpa menganggap fungsi harus terdefinisi di titik tersebut.

Limit menjadi bahasa untuk mendefinisikan kontinuitas, turunan, dan integral tentu. Kita akan membaca perilakunya terlebih dahulu dari tabel nilai, lalu menghubungkan intuisi itu dengan limit satu sisi dan definisi epsilon-delta yang tepat.

## Pendekatan Melalui Tabel Nilai

Untuk memahami limit secara lebih konkret, lihat bagaimana nilai fungsi berubah ketika variabel mendekati suatu titik. Misalkan kita memiliki fungsi <InlineMath math="f(x) = x + 2" /> dan ingin melihat apa yang terjadi ketika <InlineMath math="x" /> mendekati <InlineMath math="3" />.

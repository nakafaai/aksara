...
For an **algebraic limit**, the form of the expression tells us which operation is justified. A polynomial can be evaluated by direct substitution. A rational or radical expression may instead reveal a removable factor, a domain boundary, or a vertical asymptote that must be analyzed first.

...
Langkah khusus diperlukan ketika substitusi menghasilkan bentuk tak tentu seperti <InlineMath math="\frac{0}{0}" />. Di sekitar nol, gunakan **limit sinus dasar** dan identitas trigonometri untuk mengubah ekspresi menjadi bentuk yang limitnya dapat dihitung.

## Limit Sinus di Nol

Ketika sudut dalam radian mendekati nol, <Highlight>perbandingan sinus sudut dengan sudut itu sendiri</Highlight> mendekati satu.
...
Limit dasar tersebut menghasilkan beberapa limit terkait berikut:
...
Sebagian limit trigonometri selesai dengan substitusi, sebagian lagi memerlukan identitas atau limit yang sudah dikenal. Subbagian berikut mengerjakan setiap teknik.
...
Rumus jumlah atau selisih mengubah bentuk menjadi limit yang sudah dikenal. Subbagian berikut menerapkan identitas itu pada suatu limit.
...
Setiap soal meminta limit trigonometri. Tentukan apakah substitusi cukup atau identitas diperlukan sebelum menghitung.

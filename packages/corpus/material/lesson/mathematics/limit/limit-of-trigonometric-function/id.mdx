...
**Soal 1**. Gunakan manipulasi aljabar untuk memperoleh **bentuk standar**:
...
**Soal 2**. Gunakan sifat **perbandingan trigonometri**:
...
**Soal 3**. Gunakan **identitas setengah sudut** untuk menulis selisih cosinus sebagai kuadrat sinus:
...
**Soal 4**. Ganti variabel agar **sudut mendekati nol**, lalu gunakan limit dasar sinus. Misalkan <InlineMath math="h = x - \frac{\pi}{6}" />, maka <InlineMath math="x = h + \frac{\pi}{6}" /> dan ketika <InlineMath math="x \to \frac{\pi}{6}" />, kita punya <InlineMath math="h \to 0" />:
...
**Soal 5**. Gunakan **identitas sudut ganda** sebelum mencoret faktor yang sama:

...
Langkah khusus diperlukan ketika substitusi menghasilkan bentuk tak tentu seperti <InlineMath math="\frac{0}{0}" />. Di sekitar nol, satu **limit sinus fundamental** dan identitas trigonometri yang sudah dikenal membantu kita mengubah bentuk tersebut menjadi bentuk yang dapat dinilai.

## Teorema Fundamental Limit Trigonometri

Dasar terpenting limit trigonometri adalah teorema yang menyatakan bahwa perbandingan sinus suatu sudut dengan sudut itu sendiri mendekati satu ketika sudut mendekati nol.
...
> Dalam teorema ini, <InlineMath math="x" /> harus dalam **radian** dan bukan derajat. Jika menggunakan derajat, hasilnya akan berbeda.

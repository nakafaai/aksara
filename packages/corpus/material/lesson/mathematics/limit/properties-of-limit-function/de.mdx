...
<MathContainer>
<BlockMath math="\begin{aligned} &amp;\lim_{x \to 2} (3x^2 + 5x - 1) = \lim_{x \to 2} 3x^2 \\ &amp;+ \lim_{x \to 2} 5x - \lim_{x \to 2} 1 \end{aligned}" />
...
1. **Lösung:**
   ...
   <MathContainer>
   <BlockMath math="\begin{aligned} &amp;\lim_{x \to 3} (2x^2 - 4x + 1) = 2\lim_{x \to 3} x^2 \\ &amp;- 4\lim_{x \to 3} x + \lim_{x \to 3} 1 \end{aligned}" />
   </MathContainer>

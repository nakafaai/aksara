...
Setelah mempelajari [konsep dasar limit](/id/subjects/mathematics/limit/concept-of-limit-function), kita dapat menggunakan **sifat-sifat limit** untuk memecah perhitungan limit yang kompleks menjadi bagian-bagian yang lebih sederhana.
...
dengan <InlineMath math="n" /> adalah bilangan bulat positif.
...
**Syarat penting:** Fungsi akar harus terdefinisi untuk input di sekitar titik yang didekati.

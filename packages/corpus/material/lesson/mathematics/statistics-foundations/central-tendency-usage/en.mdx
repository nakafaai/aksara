...
The three measures react differently to the same change, so each subsection below works through one measure and repeats the same five scores, then the same added outlier.
...
The subsections below show where each of those results comes from.

...
Determinan <Highlight>memetakan setiap matriks persegi ke satu nilai skalar</Highlight>. Nilai ini, antara lain, menunjukkan apakah matriks tersebut memiliki invers dan apakah suatu sistem persamaan linear memiliki solusi tunggal.

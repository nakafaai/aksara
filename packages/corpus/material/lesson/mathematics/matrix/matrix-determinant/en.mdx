...
The determinant <Highlight>assigns one scalar value to each square matrix</Highlight>. That value tells us, among other things, whether the matrix is invertible and whether a linear system has a unique solution.

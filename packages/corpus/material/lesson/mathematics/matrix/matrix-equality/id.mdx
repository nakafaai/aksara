...
2.  **Salah**. Dua matriks yang tidak sama dapat memiliki ordo yang sama, tetapi berbeda pada satu atau beberapa elemen seletak, seperti pada Contoh <InlineMath math="3" />.

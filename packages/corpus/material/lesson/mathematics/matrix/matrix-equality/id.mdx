...
5.  Matriks <InlineMath math="I" /> adalah matriks identitas berordo <InlineMath math="2 \times 2" />, dan <InlineMath math="A = \begin{bmatrix} -x-3y & 0 \\ (x-2y)^2 & 1 \end{bmatrix}" />. Jika <InlineMath math="A = I" />, tentukan nilai <InlineMath math="x+y" />.

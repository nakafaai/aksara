...
Jika <InlineMath math="P = \begin{bmatrix} 1 & -2 \\ 3 & 0 \end{bmatrix}" />, tentukan matriks <InlineMath math="-P" /> sebagai invers aditif dari <InlineMath math="P" />, lalu buktikan bahwa <InlineMath math="P + (-P) = O" />. Simbol <InlineMath math="O" /> menyatakan matriks nol yang seordo.

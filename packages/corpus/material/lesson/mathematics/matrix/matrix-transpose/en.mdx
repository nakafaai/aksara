...
Formally, if matrix <InlineMath math="A" /> has dimensions <InlineMath math="m \times n" /> with entries <InlineMath math="a_{ij}" /> in row <InlineMath math="i" /> and column <InlineMath math="j" />, then its transpose <InlineMath math="A^T" /> has dimensions <InlineMath math="n \times m" /> and satisfies <InlineMath math="(A^T)_{ji} = a_{ij}" />.

...
A matrix transpose is formed by swapping rows and columns. If entry <InlineMath math="a_{ij}" /> is in row <InlineMath math="i" /> and column <InlineMath math="j" /> of <InlineMath math="A" />, the same entry is in row <InlineMath math="j" /> and column <InlineMath math="i" /> of <InlineMath math="A^T" />.

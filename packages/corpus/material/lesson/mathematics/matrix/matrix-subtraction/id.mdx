...
<Highlight>Pengurangan matriks adalah operasi untuk menemukan selisih antara dua matriks.</Highlight> Sama seperti [penjumlahan matriks](/id/materi/matematika/matriks/penjumlahan-matriks), operasi pengurangan hanya dapat dilakukan jika kedua matriks yang terlibat memiliki ukuran atau ordo yang sama.

export const metadata = {
  ...
  description: "Kurangkan elemen matriks yang seletak, periksa syarat ordonya, lalu terapkan operasi tersebut pada contoh dan latihan.",
...
## Selisih Elemen Matriks yang Seletak

Pengurangan matriks menghitung **selisih elemen yang seletak** dari dua matriks. Sama seperti [penjumlahan matriks](/id/materi/matematika/matriks/penjumlahan-matriks), operasi pengurangan hanya dapat dilakukan jika kedua matriks yang terlibat memiliki ukuran atau ordo yang sama.

Hasil pengurangan memiliki ordo yang sama dengan kedua matriks awal. Setiap elemennya diperoleh dengan mengurangkan elemen-elemen yang letaknya sama.
...
1.  **Pastikan Ordo Sama**: Periksa bahwa kedua matriks memiliki jumlah baris dan kolom yang sama. Jika ordonya berbeda, pengurangan tidak terdefinisi.
...
Orde kedua matriks ini **tidak sama**:
...
Penjumlahan matriks bersifat komutatif dan asosiatif, sedangkan <Highlight>pengurangan matriks umumnya tidak memiliki kedua sifat tersebut</Highlight>.

Perhatikan **tanda negatif di depan matriks**. Tanda itu berlaku untuk setiap entri. Mengubah urutan atau membuka tanda kurung dapat mengubah entri mana yang dikurangkan.

### Tidak Komutatif

Secara umum, **urutan pengurangan** matriks sangat berpengaruh. Artinya, <InlineMath math="A - B" /> tidak sama dengan <InlineMath math="B - A" />, kecuali dalam kasus-kasus khusus (misalnya jika <InlineMath math="A=B" />).
...
**Pengelompokan** dalam pengurangan tiga matriks atau lebih juga berpengaruh pada hasil akhir. Secara umum, <InlineMath math="(A - B) - C" /> tidak sama dengan <InlineMath math="A - (B - C)" />.
...
Pengurangan matriks dapat ditulis sebagai penjumlahan dengan matriks lawannya: <InlineMath math="A - B = A + (-B)" />.
...
Dari elemen baris <InlineMath math="2" />, kolom <InlineMath math="2" />: <InlineMath math="5+2x = 13" />.

Substitusi <InlineMath math="x=4" /> dari persamaan pertama menghasilkan <InlineMath math="5+2(4) = 13" />.

Jadi, nilai kanan bawah <InlineMath math="13" /> mengonfirmasi nilai <InlineMath math="x" />.

Dengan demikian, penyelesaiannya adalah <InlineMath math="x=4" />, <InlineMath math="y=2" />, dan <InlineMath math="z=-3" />.

Substitusi ketiga nilai tersebut ke persamaan awal memverifikasi keempat elemen yang bersesuaian.
...
Kedua hasil berbeda: <InlineMath math="(A-B)-C \neq A-(B-C)" />.

Jadi, pengurangan matriks tidak bersifat asosiatif.

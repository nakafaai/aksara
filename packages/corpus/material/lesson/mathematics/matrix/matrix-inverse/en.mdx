...
A fuller discussion on how to calculate the determinant and adjugate of a <InlineMath math="3 \times 3" /> matrix will usually be studied separately because it involves more steps.
...
This is the matrix analogue of division: once <InlineMath math="A^{-1}" /> is known, it isolates the unknown matrix without solving each equation separately.

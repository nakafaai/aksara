...
Some school texts further describe rectangular matrices by their shape: wide matrices have more columns than rows, while tall matrices have more rows than columns. The terms horizontal and vertical matrix are also used in some curricula.

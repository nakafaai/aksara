...
2. Substitute one value for the variable, for instance <InlineMath math="a = 0" />, into both sides.
   ...
   The correct identity for <InlineMath math="(2a-5)(2a+5)" /> is <InlineMath math="(2a)^2 - 5^2 = 4a^2 - 25" />, using <InlineMath math="(A-B)(A+B)=A^2-B^2" />.
...
1. Test with the value <InlineMath math="m = 1" />.
...
2. We will expand the left-hand side using the identity <InlineMath math="(A - B)^2 = A^2 - 2AB + B^2" />, with <InlineMath math="A = 2x" /> and <InlineMath math="B = 3" />.
   ...
   Name the expanded square <InlineMath math="B" />, then retain the added constant:

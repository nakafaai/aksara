...
5.  **Test Possible Roots:** Test each value <InlineMath math="\frac{p}{q}" /> from the list by substituting it into <InlineMath math="P(x)" /> (using the Remainder Theorem) or using [Horner's method](/en/subjects/mathematics/polynomial/horner-method). If the result is <InlineMath math="P(\frac{p}{q}) = 0" />, then <InlineMath math="\frac{p}{q}" /> is a rational root, and <InlineMath math="(x - \frac{p}{q})" /> (or the form <InlineMath math="(qx - p)" />) is a factor (Factor Theorem).
...
5.  **Test Possible Roots:** Test some values from the list.
...
2.  **Factors of <InlineMath math="p" /> (from <InlineMath math="20" />):** <InlineMath math="\pm 1" />, <InlineMath math="\pm 2" />, <InlineMath math="\pm 4" />, <InlineMath math="\pm 5" />, <InlineMath math="\pm 10" />, <InlineMath math="\pm 20" />.
3.  **Factors of <InlineMath math="q" /> (from <InlineMath math="2" />):** <InlineMath math="\pm 1" />, <InlineMath math="\pm 2" />.
4.  **Possible Roots <InlineMath math="\frac{p}{q}" />:** <InlineMath math="\pm 1" />, <InlineMath math="\pm 2" />, <InlineMath math="\pm 4" />, <InlineMath math="\pm 5" />, <InlineMath math="\pm 10" />, <InlineMath math="\pm 20" />, <InlineMath math="\pm 1/2" />, <InlineMath math="\pm 5/2" />.
5.  **Test Roots:**

...
5.  **Uji Kemungkinan Akar:** Substitusikan setiap nilai <InlineMath math="\frac{p}{q}" /> ke <InlineMath math="P(x)" />, atau uji dengan metode Horner. Jika <InlineMath math="P(\frac{p}{q}) = 0" />, maka <InlineMath math="\frac{p}{q}" /> adalah akar rasional dan <InlineMath math="(x - \frac{p}{q})" /> atau <InlineMath math="(qx - p)" /> adalah faktor dari <InlineMath math="P(x)" />.

...
5.  **Uji Kemungkinan Akar:** Substitusikan setiap nilai <InlineMath math="\frac{p}{q}" /> ke <InlineMath math="P(x)" />, atau uji dengan [metode Horner](/id/materi/matematika/polinomial/metode-horner). Jika <InlineMath math="P(\frac{p}{q}) = 0" />, maka <InlineMath math="\frac{p}{q}" /> adalah akar rasional dan <InlineMath math="(x - \frac{p}{q})" /> atau <InlineMath math="(qx - p)" /> adalah faktor dari <InlineMath math="P(x)" />.
...
2.  **Faktor <InlineMath math="p" /> (dari <InlineMath math="20" />):** <InlineMath math="\pm 1" />, <InlineMath math="\pm 2" />, <InlineMath math="\pm 4" />, <InlineMath math="\pm 5" />, <InlineMath math="\pm 10" />, <InlineMath math="\pm 20" />.
3.  **Faktor <InlineMath math="q" /> (dari <InlineMath math="2" />):** <InlineMath math="\pm 1" />, <InlineMath math="\pm 2" />.
4.  **Kemungkinan Akar <InlineMath math="\frac{p}{q}" />:** <InlineMath math="\pm 1" />, <InlineMath math="\pm 2" />, <InlineMath math="\pm 4" />, <InlineMath math="\pm 5" />, <InlineMath math="\pm 10" />, <InlineMath math="\pm 20" />, <InlineMath math="\pm 1/2" />, <InlineMath math="\pm 5/2" />.
5.  **Uji Akar:**

...
The **end behavior** of a polynomial graph describes its direction as <InlineMath math="x" /> approaches positive infinity (<InlineMath math="x \to \infty" />) or negative infinity (<InlineMath math="x \to -\infty" />).

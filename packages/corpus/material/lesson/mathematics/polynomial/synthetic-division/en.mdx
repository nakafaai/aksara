...
Polynomial long division finds the quotient and remainder by repeating the same divide, multiply, subtract, and bring-down pattern used in integer long division.

...
Pada monomial, <Highlight>pangkat setiap variabel harus berupa bilangan cacah</Highlight>. Bilangan yang mengalikan variabel, seperti <InlineMath math="2" /> pada <InlineMath math="2x^2y" />, disebut **koefisien**.

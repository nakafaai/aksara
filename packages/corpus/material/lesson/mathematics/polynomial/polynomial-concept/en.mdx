...
A monomial has <Highlight>non-negative integer exponents on every variable</Highlight>. The number multiplying the variables, such as <InlineMath math="2" /> in <InlineMath math="2x^2y" />, is called the **coefficient**.

...
The scheme omits the repeated variables and powers required by long division. Its bottom row already contains the quotient coefficients followed by the remainder.

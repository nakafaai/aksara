...
Metode Horner membagi polinomial dengan pembagi linear seperti <InlineMath math="(x-c)" /> hanya dari urutan koefisiennya. Pada setiap langkah, hasil terakhir dikalikan dengan <InlineMath math="c" /> lalu ditambah dengan koefisien berikutnya. Karena itu, kita tidak perlu menulis ulang variabel dan pangkat seperti pada pembagian bersusun.

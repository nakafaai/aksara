...
the common difference is <InlineMath math="b=3" />, so:
...
the common ratio is <InlineMath math="r=2" />, so:
...
The name of a series therefore refers to its sequence of terms rather than to whether <InlineMath math="S_1,S_2,S_3,\ldots" /> itself forms an arithmetic or geometric sequence.

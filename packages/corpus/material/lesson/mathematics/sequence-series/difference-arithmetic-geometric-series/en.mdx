...
The name of a series therefore refers to its sequence of terms, not to whether <InlineMath math="S_1,S_2,S_3,\ldots" /> itself forms an arithmetic or geometric sequence.

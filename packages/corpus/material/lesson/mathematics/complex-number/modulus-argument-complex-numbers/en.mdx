...
To calculate the modulus, <Highlight>we can use the Pythagorean Theorem</Highlight> on the right-angled triangle formed by the real part (<InlineMath math="x" />), the imaginary part (<InlineMath math="y" />), and the modulus (<InlineMath math="|z|" />) as the hypotenuse.

...
export const metadata = {
  ...
  description: "Calculate reciprocals of complex numbers using conjugates and moduli, then apply the method to division through worked examples.",
...
<ContentStack>
  ...
  Verify the result by multiplying it by the original number:
  ...
  <LineEquation
    ...
    description={
      <>
        ...
        opposite sides of the real axis; their moduli are reciprocals.
      </>
    }

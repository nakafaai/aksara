...
Changing form is therefore a problem-solving choice, not a separate operation on the number.
...
2.  **False.** The three standard forms used here are Cartesian, polar, and exponential. A logarithm is an operation on a complex number, not a replacement for the omitted polar form in this list.

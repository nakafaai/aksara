...
There is one more important form: the **exponential form**. It follows from **Euler's formula**:
...
Changing form is therefore a problem-solving choice rather than a separate operation on the number.
...
2.  **False.** The three standard forms used here are Cartesian, polar, and exponential. A logarithm is an operation on a complex number rather than a replacement for the omitted polar form in this list.

...
When a complex number <InlineMath math="z = x + iy" /> is multiplied by a real scalar <InlineMath math="c" />, the scalar multiplies both the real and imaginary parts.
...
Work through the three parts in order. The first two parts separate the real and the imaginary components, and the third part shows why the sum is the diagonal of the parallelogram.

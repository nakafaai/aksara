...
export const metadata = {
  ...
  description: "Add complex numbers by combining their real and imaginary parts, then interpret the result with the parallelogram rule.",
...
The same idea can now be applied to three combined expressions:

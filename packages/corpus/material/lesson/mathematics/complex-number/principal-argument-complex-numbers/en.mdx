...
Find any argument first, then add or subtract full turns until the result lies in <InlineMath math="(-\pi, \pi]" /> or <InlineMath math="(-180^\circ, 180^\circ]" />. An angle of <InlineMath math="300^\circ" /> lies outside both intervals, and subtracting one full turn brings it to <InlineMath math="-60^\circ" />, which is the principal value.

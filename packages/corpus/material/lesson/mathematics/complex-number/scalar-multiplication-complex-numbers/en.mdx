...
A real scalar changes the length of the arrow and can also turn it around. The cases here separate <Highlight>the effects of stretching, shrinking, and reversing direction</Highlight>, so the size and the sign of the scalar each get their own picture.

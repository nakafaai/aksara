...
Terapkan definisi tersebut pada beberapa bentuk bilangan kompleks:
...
Misalkan <InlineMath math="z, z_1," /> dan <InlineMath math="z_2" /> adalah bilangan kompleks. Operasi konjugat memenuhi aturan berikut. Semua aturan itu berasal dari satu sifat yang sama: menerapkan konjugat dua kali mengembalikan bilangan asalnya, dan perubahan tanda itu mengikuti penjumlahan, perkalian, serta pembagian tanpa mengubah bagian realnya.
...
Penjumlahan dan pengurangan bilangan kompleks dengan konjugatnya memisahkan bagian real dan imajiner:

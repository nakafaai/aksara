...
Addition and scalar multiplication of complex numbers obey the same familiar algebraic rules as real numbers. Those rules let us rearrange and simplify expressions without changing their value.

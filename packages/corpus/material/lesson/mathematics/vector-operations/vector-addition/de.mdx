...
export const metadata = {
  ...
  description: "Lerne die Vektoraddition mit Dreiecks-, Parallelogramm-, Polygon- und Komponentenverfahren und deute Resultierende in physikalischen Situationen.",

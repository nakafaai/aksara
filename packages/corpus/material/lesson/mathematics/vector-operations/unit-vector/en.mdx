...
Say we have vector <InlineMath math="\vec{v} = (3, 6, 4)" />
...
In physics, when we want to decompose a vector into its components, unit vectors are very helpful. For instance, a force can be decomposed into components along the <InlineMath math="x" />, <InlineMath math="y" />, and <InlineMath math="z" /> axes using unit vectors.

...
The sign of the multiplier decides whether the result keeps the original direction. The two examples below work one positive and one negative multiplier.

...
A vector has magnitude and direction. In coordinate calculations, we commonly arrange its components as either a **column vector** or a **row vector**. These are component representations, not the only ways to draw or write a vector.

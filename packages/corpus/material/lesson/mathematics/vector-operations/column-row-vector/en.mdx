...
Every coordinate axis carries exactly one basis vector, and those basis vectors express the coordinates of every other vector. The subsections below list them for the plane and for space.

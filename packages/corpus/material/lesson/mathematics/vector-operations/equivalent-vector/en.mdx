...
Two vectors are equivalent when they share the same length and the same direction, so either one can stand in for the other. The subsections below state that condition in component form and with position vectors.

...
export const metadata = {
  title: "Equivalent Vectors",
    description: "Decide whether vectors are equal from their components and explain why moving a vector does not change it.",
...
### Equality Despite Different Starting Points

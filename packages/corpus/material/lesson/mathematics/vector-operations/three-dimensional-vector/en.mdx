...
A three-dimensional vector <Highlight>needs a third coordinate</Highlight>, and several notations record it. The subsections below give the common notations and then read their components.
...
Addition, subtraction, and scalar multiplication on three-dimensional vectors follow the same component rules as in two dimensions. The subsections below apply each operation.

...
export const metadata = {
  ...
  description: "Learn three-dimensional vectors through interactive visualizations, then explore their components, magnitude, operations, dot product, and cross product.",

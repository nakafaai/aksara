export const metadata = {
  ...
  description: "Learn how standard and general circle equations relate, then find the center and radius and convert between both forms.",
...
The graph makes the radius constraint visible.

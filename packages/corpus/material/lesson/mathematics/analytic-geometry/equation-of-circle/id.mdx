...
Untuk lingkaran yang berpusat di <InlineMath math="P(a,b)" />, bukan di titik asal, misalkan jari-jarinya <InlineMath math="r" />.
...
Setiap soal memberikan pusat dan jari-jari, tiga titik, atau persamaan umum, lalu meminta persamaan lingkarannya, jadi pilih bentuk yang sesuai dengan informasi yang diberikan.
...
4. **Penyelesaian**:
   ...
   <MathContainer>
     <BlockMath math="\begin{aligned} &amp;\text{Panjang } AB \\ &amp;= \sqrt{(x_B-x_A)^2 + (y_B-y_A)^2} \\ &amp;= \sqrt{(7-1)^2 + (-1-3)^2} \end{aligned}" />

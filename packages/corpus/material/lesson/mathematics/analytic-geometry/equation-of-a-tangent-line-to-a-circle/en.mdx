...
The geometry is the same in each situation. A tangent touches the circle at <Highlight>exactly one point</Highlight>, while the radius to the point of tangency supplies the perpendicular direction or the required distance.
...
<LineEquation
  ...
  data={[
    ...
    },
    {
      ...
      showPoints: false,
      smooth: false,
      labels: [{ text: "Tangent", at: 2, offset: [0.5, 0.5, 0] }],
    },
    {
      points: (() => {
        const angle = Math.PI * 5/6;
...
<LineEquation
  ...
  data={[
    ...
    },
    {
      ...
      showPoints: false,
      smooth: false,
      labels: [{ text: "Upper Tangent", at: 2, offset: [-3, 4.8, 0] }],
    },
    {
      points: (() => {
        const m = -0.75; // desired gradient
      ...
      showPoints: false,
      smooth: false,
      labels: [{ text: "Lower Tangent", at: 1, offset: [1, -2.4, 0] }],
    },
    {
      points: (() => {
        const m = -0.75;
...
<LineEquation
  ...
  data={[
    ...
    },
    {
      ...
      showPoints: false,
      smooth: false,
      labels: [{ text: "Tangent 1", at: 1, offset: [0.5, -1, 0] }],
    },
    {
      points: (() => {
        // Second tangent line
      ...
      showPoints: false,
      smooth: false,
      labels: [{ text: "Tangent 2", at: 1, offset: [0.5, 1, 0] }],
    },
    {
      points: [
        { x: -5, y: 0, z: 0 },
...
Substitute this expression into the circle. A tangent meets the circle at one repeated point, so the resulting quadratic in <InlineMath math="x" /> must have [discriminant](/en/subjects/mathematics/quadratic-function/quadratic-equation-types-of-root) zero:
...
**Step 1**: Check that <InlineMath math="A" /> lies **outside the circle**.

<BlockMath math="7^2 + 1^2 = 49 + 1 = 50 > 25 \quad \checkmark" />

**Step 2**: Substitute <InlineMath math="x_0=7" />, <InlineMath math="y_0=1" />, and <InlineMath math="r^2=25" /> into the quadratic for <InlineMath math="m" />:
...
**Step 4**: Use each slope in the **point-slope equation** through <InlineMath math="A" />.
...
**Step 2**: **Translate the center to the origin**. Relative to the center, point <InlineMath math="(11,10)" /> has coordinates <InlineMath math="(8,6)" />.

**Step 3**: Form the quadratic for the slopes from <InlineMath math="(8,6)" /> to circle <InlineMath math="x^2 + y^2 = 25" />.
...
**Step 5**: Simplify the slopes and use point-slope form through <InlineMath math="(11,10)" />.

<MathContainer>
  <BlockMath math="\begin{aligned} &amp;m_1 = \frac{48 + 25\sqrt{3}}{39} \\ &amp;\text{and} \\ &amp;m_2 = \frac{48 - 25\sqrt{3}}{39} \end{aligned}" />
...
**Step 2**: Read the slope of the given line. Since <InlineMath math="3x + 4y = 7" /> is <InlineMath math="y = -\frac{3}{4}x + \frac{7}{4}" />, **every parallel line** has slope <InlineMath math="m = -\frac{3}{4}" />.

**Step 3**: Substitute center <InlineMath math="(3,4)" />, radius, and slope into the tangent formula.

...
The geometry is the same in each situation. <Highlight>A tangent touches the circle once</Highlight>, while the radius to the point of tangency supplies the perpendicular direction or the required distance.
...
<LineEquation
  ...
  data={[
    ...
    },
    {
      ...
      showPoints: false,
      smooth: false,
      labels: [{ text: "Tangent", at: 1, offset: [4, 3.5, 0] }],
    },
    {
      points: (() => {
        const angle = Math.PI * 5/6;

...
Gagasan geometrinya tetap sama pada ketiga keadaan. <Highlight>Garis singgung berpotongan dengan lingkaran di satu titik</Highlight>, sedangkan jari-jari menuju titik itu memberi arah tegak lurus atau jarak yang dibutuhkan.
...
<LineEquation
  ...
  data={[
    ...
    },
    {
      ...
      showPoints: false,
      smooth: false,
      labels: [{ text: "Singgung", at: 1, offset: [4, 3.5, 0] }],
    },
    {
      points: (() => {
        const angle = Math.PI * 5/6;

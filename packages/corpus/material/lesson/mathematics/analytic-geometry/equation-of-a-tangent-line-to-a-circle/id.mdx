...
Gagasan geometrinya tetap sama pada ketiga keadaan. Garis singgung berpotongan dengan lingkaran di <Highlight>tepat satu titik</Highlight>, sedangkan jari-jari menuju titik itu memberi arah tegak lurus atau jarak yang dibutuhkan.
...
<LineEquation
  ...
  data={[
    ...
    },
    {
      ...
      showPoints: false,
      smooth: false,
      labels: [{ text: "Singgung", at: 2, offset: [0.5, 0.5, 0] }],
    },
    {
      points: (() => {
        const angle = Math.PI * 5/6;
...
<LineEquation
  ...
  data={[
    ...
    },
    {
      ...
      showPoints: false,
      smooth: false,
      labels: [{ text: "Singgung Atas", at: 2, offset: [-3, 4.8, 0] }],
    },
    {
      points: (() => {
        const m = -0.75; // gradien yang diinginkan
      ...
      showPoints: false,
      smooth: false,
      labels: [{ text: "Singgung Bawah", at: 1, offset: [1, -2.4, 0] }],
    },
    {
      points: (() => {
        const m = -0.75;
...
<LineEquation
  ...
  data={[
    ...
    },
    {
      ...
      showPoints: false,
      smooth: false,
      labels: [{ text: "Singgung 1", at: 1, offset: [0.5, -1, 0] }],
    },
    {
      points: (() => {
      ...
      showPoints: false,
      smooth: false,
      labels: [{ text: "Singgung 2", at: 1, offset: [0.5, 1, 0] }],
    },
    {
      points: [
        { x: -5, y: 0, z: 0 },
...
Substitusikan bentuk tersebut ke persamaan lingkaran. Garis singgung bertemu lingkaran pada satu titik kembar, sehingga persamaan kuadrat dalam <InlineMath math="x" /> harus memiliki [diskriminan](/id/materi/matematika/persamaan-dan-fungsi-kuadrat/jenis-jenis-akar-persamaan-kuadrat) nol:
...
**Langkah 1**: Pastikan <InlineMath math="A" /> berada di luar lingkaran.

<BlockMath math="7^2 + 1^2 = 49 + 1 = 50 > 25 \quad \checkmark" />

**Langkah 2**: Substitusikan <InlineMath math="x_0=7" />, <InlineMath math="y_0=1" />, dan <InlineMath math="r^2=25" /> ke persamaan kuadrat untuk <InlineMath math="m" />:
...
**Langkah 4**: Gunakan setiap gradien pada persamaan titik-gradien yang melalui <InlineMath math="A" />.
...
**Langkah 2**: Geser pusat ke titik asal. Relatif terhadap pusat, titik <InlineMath math="(11,10)" /> memiliki koordinat <InlineMath math="(8,6)" />.

**Langkah 3**: Susun persamaan kuadrat untuk gradien dari <InlineMath math="(8,6)" /> ke lingkaran <InlineMath math="x^2 + y^2 = 25" />.
...
**Langkah 5**: Sederhanakan gradien dan gunakan bentuk titik-gradien melalui <InlineMath math="(11,10)" />.

<MathContainer>
  <BlockMath math="\begin{aligned} &amp;m_1 = \frac{48 + 25\sqrt{3}}{39} \\ &amp;\text{dan} \\ &amp;m_2 = \frac{48 - 25\sqrt{3}}{39} \end{aligned}" />
...
**Langkah 2**: Baca gradien garis yang diberikan. Karena <InlineMath math="3x + 4y = 7" /> dapat ditulis sebagai <InlineMath math="y = -\frac{3}{4}x + \frac{7}{4}" />, setiap garis sejajar memiliki gradien <InlineMath math="m = -\frac{3}{4}" />.

**Langkah 3**: Substitusikan pusat <InlineMath math="(3,4)" />, jari-jari, dan gradien ke rumus garis singgung.

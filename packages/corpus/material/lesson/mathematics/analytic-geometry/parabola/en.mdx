...
<LineEquation
  ...
  data={[
    ...
    },
    {
      ...
      showPoints: false,
      smooth: false,
      labels: [{ text: "Directrix", at: 2, offset: [-3.2, -1, 0] }],
    },
  ]}
...
This definition works for every position and orientation. The defining condition is always the same: <Highlight>equal distance to the focus and the directrix</Highlight>.

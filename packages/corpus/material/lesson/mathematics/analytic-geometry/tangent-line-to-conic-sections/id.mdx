...
Pada parabola <InlineMath math="y = x^2" />, perbedaannya terlihat jelas: garis singgung memiliki satu titik potong berulang, sedangkan garis sekan memiliki dua titik potong berbeda.
...
Kadang titik singgung tidak diketahui, tetapi **kemiringan** atau gradien garis singgung tersedia. Dalam kasus ini, persamaan garis bergradien <InlineMath math="m" /> disubstitusikan ke persamaan irisan kerucut.

Sebagai contoh, kita akan menentukan garis singgung hiperbola <InlineMath math="4x^2 - 9y^2 = 36" /> yang tegak lurus terhadap garis <InlineMath math="x + 4y + 10 = 0" />.

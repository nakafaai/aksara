...
Imagine riding around a circular track. If you leave the track without turning the handlebars, your direction at that instant follows the track's **tangent line**. This unique line passes through that point and is perpendicular to the radius there.

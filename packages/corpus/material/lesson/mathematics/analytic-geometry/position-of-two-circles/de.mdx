...
- **Untere Grenze**: Bei <InlineMath math="|r_1 - r_2|>0" /> berührt der kleinere Kreis den größeren von innen
...
Ein Kreis kann **ohne Berührung innerhalb eines anderen** liegen, obwohl die Mittelpunkte verschieden sind. Im Diagramm beträgt der größere Radius <InlineMath math="4" />, der kleinere Radius <InlineMath math="1" /> und der Mittelpunktsabstand <InlineMath math="1" />.

<LineEquation
  title="Ineinanderliegende Kreise ohne Berührung"
  description="Die Mittelpunkte unterscheiden sich und die Kreislinien treffen sich nicht."
  cameraPosition={[0, 0, 12]}
  showZAxis={false}
  data={[
    {
...
Wegen <InlineMath math="0<1<4-1" /> liegt der kleine Kreis vollständig im großen. Ihre Mittelpunkte sind verschieden, deshalb sind die Kreise nicht konzentrisch.

...
In analytic geometry, the centers and radii are enough to determine the relationship precisely. The decisive quantity is <Highlight>the distance between the two centers</Highlight>.

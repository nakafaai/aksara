...
<LineEquation
  ...
  data={[
    ...
    },
    {
      ...
      showPoints: false,
      smooth: false,
      labels: [{ text: "Tidak berpotongan", at: 2, offset: [-2, 0.5, 0] }],
    },
    {
      points: (() => {
        const points = Array.from({ length: 2 }, (_, i) => {
      ...
      showPoints: false,
      smooth: false,
      labels: [{ text: "Menyinggung", at: 2, offset: [-2, 0.5, 0] }],
    },
    {
      points: (() => {
        const points = Array.from({ length: 2 }, (_, i) => {
      ...
      showPoints: false,
      smooth: false,
      labels: [{ text: "Memotong", at: 2, offset: [-2, 0.5, 0] }],
    },
    {
...
Sekarang hitung <Highlight>diskriminan dari koefisien A, B, C</Highlight> di atas:

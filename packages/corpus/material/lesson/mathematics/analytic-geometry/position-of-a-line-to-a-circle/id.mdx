...
Gambarlah sebuah lingkaran dan garis lurus pada bidang yang sama. <Highlight>Tepat ada tiga kemungkinan kedudukan</Highlight>.
...
Sekarang hitung **diskriminan** dari koefisien <InlineMath math="A" />, <InlineMath math="B" />, dan <InlineMath math="C" /> di atas:

<BlockMath math="\Delta = B^2 - 4AC" />

> Untuk **garis vertikal**, bentuk <InlineMath math="y=mx+c" /> tidak berlaku. Substitusikan <InlineMath math="x=k" /> langsung ke lingkaran dan selesaikan persamaan kuadrat dalam <InlineMath math="y" />. Misalnya, <InlineMath math="x=3" /> pada <InlineMath math="x^2+y^2=9" /> memberikan <InlineMath math="9+y^2=9" />, sehingga <InlineMath math="y=0" />. Garis itu menyinggung di <InlineMath math="(3,0)" />.
...
| Nilai diskriminan | Akar real | Kedudukan garis |
| --- | --- | --- |
| <InlineMath math="\Delta>0" /> | Dua akar berbeda | **Memotong di dua titik** |
| <InlineMath math="\Delta=0" /> | Satu akar kembar | **Menyinggung di satu titik** |
| <InlineMath math="\Delta<0" /> | Tidak ada | **Tidak berpotongan** |
...
Kita dapat **menentukan titik potongnya** dengan rumus kuadrat, lalu memasukkan kembali nilai absis ke persamaan garis:
...
Tanda atas dipasangkan dengan tanda atas, dan tanda bawah dengan tanda bawah. Kedua pasangan koordinat memenuhi persamaan garis sekaligus persamaan lingkaran.
...
Kesimpulannya sama seperti sebelumnya: <InlineMath math="\Delta > 0" /> berarti garis memotong lingkaran di dua titik, <InlineMath math="\Delta = 0" /> berarti menyinggung di satu titik, dan <InlineMath math="\Delta < 0" /> berarti tidak berpotongan.

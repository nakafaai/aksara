...
<LineEquation
  ...
  data={[
    ...
    },
    {
      ...
      showPoints: false,
      smooth: false,
      labels: [{ text: "No intersection", at: 2, offset: [-2, 0.5, 0] }],
    },
    {
      points: (() => {
        const points = Array.from({ length: 2 }, (_, i) => {
      ...
      showPoints: false,
      smooth: false,
      labels: [{ text: "Tangent", at: 2, offset: [-2, 0.5, 0] }],
    },
    {
      points: (() => {
        const points = Array.from({ length: 2 }, (_, i) => {
      ...
      showPoints: false,
      smooth: false,
      labels: [{ text: "Intersects", at: 2, offset: [-2, 0.5, 0] }],
    },
    {
...
Now calculate the <Highlight>discriminant from the coefficients A, B, C</Highlight> above:

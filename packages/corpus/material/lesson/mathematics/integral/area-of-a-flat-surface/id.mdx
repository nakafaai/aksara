...
Terapkan konsep ini pada contoh konkret. Misalkan kita ingin menghitung luas daerah yang dibatasi oleh kurva <InlineMath math="f(x) = x^2 - 4x" /> dan sumbu <InlineMath math="x" /> antara <InlineMath math="x = 1" /> dan <InlineMath math="x = 3" />.

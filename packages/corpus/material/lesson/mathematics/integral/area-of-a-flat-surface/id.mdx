...
Langkah pertama adalah menentukan batas bawah dan batas atas integrasi. Batas ini menunjukkan rentang nilai <InlineMath math="x" /> yang membatasi daerah yang ingin kita hitung luasnya. Tentukan batasnya dari titik potong atau dari keterangan soal sebelum menyusun integralnya.
...
Pada rumus ini, <InlineMath math="F(x)" /> adalah [antiturunan](/id/materi/matematika/integral/definisi-integral-tak-tentu) dari <InlineMath math="f(x)" />.

...
Itulah ide dasar **jumlahan Riemann**. Metode ini memperkirakan **akumulasi bertanda** dengan membagi interval menjadi beberapa subinterval, lalu menjumlahkan kontribusi setiap persegi panjang. Jika fungsinya tidak negatif, akumulasi tersebut sama dengan luas daerah di bawah kurva. Untuk fungsi yang terintegralkan secara Riemann, jumlahan ini konvergen ke integral tentu ketika lebar subinterval terbesarnya mendekati nol. Pada partisi sama lebar, menambah jumlah persegi panjang akan memperkecil lebarnya, meskipun setiap penambahan belum tentu langsung menghasilkan taksiran yang lebih dekat.

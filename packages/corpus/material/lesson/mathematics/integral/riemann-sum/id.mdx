...
Notasi sigma (<InlineMath math="\sum" />) berarti "jumlahkan semua luas persegi panjang". Luas setiap persegi panjang adalah **tinggi** (<InlineMath math="f(x_i^*)" />) dikali **lebar** (<InlineMath math="\Delta x" />).
...
5.  **Hitung Jumlahan Riemann:**
    ...
    <BlockMath math="R_7 = \sum_{i=1}^{7} f(x_i^*) \Delta x" />
        Nyatakan jumlah ketujuh nilai sampel sebagai <InlineMath math="S" />:

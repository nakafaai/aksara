export const metadata = {
  title: "KIM Plus, the Empty Ballot Option, and Jakarta’s Independent Candidacy Debate",
  description: "Analysis of KIM Plus and the independent-candidacy controversy in August 2024, with subsequent nomination-rule changes and Jakarta election results.",
  authors: [
    {
...
## Poll Leads Did Not Guarantee Candidacy

This article examines the nomination debate in August 2024. An election against an empty ballot option was a concern at that time, rather than the eventual outcome. The Constitutional Court changed nomination thresholds on August 20, and three pairs ultimately contested Jakarta’s election. On January 9, 2025, the election commission declared Pramono Anung and Rano Karno elected with 50.07% of valid votes. [KPU Jakarta](https://jakarta.kpu.go.id/blog/read/kpu-provinsi-daerah-khusus-jakarta-resmi-tetapkan-pramono-anung-rano-karno-gubernur-dan-wakil-gubernur-terpilih-provinsi-daerah-khusus-jakarta).

Jakarta, as a barometer of democracy for other regions, was under the spotlight ahead of the 2024 Governor Election,
with several events showing how its politics changed. Political maneuvers for the 2024
...
However, as of August 19, 2024, only <Highlight>Ridwan Kamil has been officially declared as a candidate for Jakarta Governor</Highlight>, paired with Suswono.
...
## Motives Behind the KIM Plus Coalition

The Indonesia Maju Plus Coalition (KIM Plus) has officially endorsed Ridwan Kamil and Suswono in the
2024 Jakarta Governor Election. With the support of <InlineMath math="12" /> political parties, this coalition provides
...
This opportunity allowed PKS to nominate one of its cadres, Suswono, for the vice-governor slot in the 2024
...
support from PKS's base, which holds the most seats in Jakarta’s DPRD and is capable of drawing substantial
...
## The Puppet Candidate Accusation

The term "puppet candidate" has been applied to the pair Dharma Pongrekun-Kun Wardana Abyoto
by several parties. The <Highlight>empty box option</Highlight>, which was anticipated to be a rival to Ridwan Kamil
...
On the August 19, 2024 "Panggung Demokrasi" broadcast, Ray Rangkuti argued that Anies Baswedan, Ahok, and an empty ballot option posed greater threats to Ridwan Kamil than Dharma-Kun (Metro TV, 2024b). This was Rangkuti’s political assessment. At that time, party nominations required at least 20% of regional legislative seats or 25% of valid regional legislative votes, making party support decisive for nomination prospects.

Concerns that PDIP could not nominate its own pair must be read in the context before [Constitutional Court Decision No. 60/PUU-XXII/2024](https://www.mkri.id/berita/-21501). On August 20, 2024, the Court introduced valid-vote thresholds tiered by the number of registered voters. PDIP subsequently nominated Pramono Anung and Rano Karno. Dharma-Kun’s absence from a survey’s list of names cannot establish support below 1% or prove that KIM Plus arranged their candidacy.

## Misuse of Identity Numbers in Candidate Endorsement
...
can proceed. If a criminal element is found, the police will then follow up on the case. At the time of the August 2024 report,
the complaints were under investigation by Bawaslu (Maharso, 2024).

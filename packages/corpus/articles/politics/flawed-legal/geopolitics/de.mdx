export const metadata = {
  ...
  description:
    "Eine Analyse des IKN-Rechtsrahmens, der verfassungsgerichtlichen Prüfung des Gesetzes Nr. 3 von 2022 und sicherheitspolitischer Fragen anhand früherer Studien.",
  authors: [
    {
...
Diese Untersuchung analysiert **den Rechtsrahmen und die sicherheitspolitischen Fragen von IKN** anhand von Gesetzen, Gerichtsentscheidungen, Forschung und früheren Berichten. Sie unterscheidet die Kritik am Gesetz Nr. 3 von 2022 von den Ergebnissen seiner Prüfung durch das Verfassungsgericht. Frühere extremistische Netzwerke auf Kalimantan dienen als Kontext für die Sicherheitsplanung. Sie belegen nicht, dass der Umzug der Hauptstadt terroristische Gewalt verstärkt. Eine aktuelle Bedrohungsbewertung erfordert neuere Daten als die hier behandelten historischen Quellen.

...
| Regelungsbereich | Regionalwahlgesetz und ursprüngliche PKPU 8/2024 | Entscheidung des Verfassungsgerichts | Änderungsvorschlag des Gesetzgebungsausschusses, nicht in Kraft getreten |
| --- | --- | --- | --- |
| Nominierungsschwelle | <InlineMath math="20\%" /> der DPRD-Sitze oder <InlineMath math="25\%" /> der gültigen Stimmen | <InlineMath math="6{,}5\%\text{-}10\%" />, abhängig von der Zahl der registrierten Wähler im endgültigen Wählerverzeichnis | Gilt nur für Parteien ohne DPRD-Sitze |
| Mindestalter für Gouverneure | Mindestens <InlineMath math="30 \text{ Jahre}" /> | Vor der Feststellung des Kandidatenpaars durch die KPU mindestens <InlineMath math="30 \text{ Jahre}" /> | Bei der Amtseinführung mindestens <InlineMath math="30 \text{ Jahre}" /> |
| Mindestalter für Regenten und Bürgermeister | Mindestens <InlineMath math="25 \text{ Jahre}" /> | Vor der Feststellung des Kandidatenpaars durch die KPU mindestens <InlineMath math="25 \text{ Jahre}" /> | Bei der Amtseinführung mindestens <InlineMath math="25 \text{ Jahre}" /> |

In einer Konsultationssitzung stimmte die Kommission II des DPR dem Entwurf einer KPU-Verordnung zu, der die Verfassungsgerichtsentscheidungen Nr. 60/PUU-XXII/2024 zur Nominierungsschwelle und Nr. 70/PUU-XXII/2024 zum Zeitpunkt der Altersprüfung umsetzte (BBC, 2024; BeritaSatu, 2024). Die KPU erließ die Änderungen anschließend mit der [Verordnung Nr. 10/2024](https://jdih.kpu.go.id/peraturan-kpu/download/445). Diese Zustimmung in der Konsultation war von einer Verabschiedung des zuvor von Baleg vorgeschlagenen Änderungsgesetzes zu unterscheiden.
...
Die Änderung behielt die Altersgrenzen von 30 Jahren für Gouverneure und Vizegouverneure sowie 25 Jahren für Regenten, stellvertretende Regenten, Bürgermeister und stellvertretende Bürgermeister bei. Geändert wurde der maßgebliche Zeitpunkt: von der Amtseinführung auf die Zeit vor der Feststellung der Kandidatenpaare durch die KPU. ([Entscheidung Nr. 70/PUU-XXII/2024](https://www.mkri.id/berita/mk%3A-persyaratan-harus-dipenuhi-sebelum-penetapan-calon-kepala-daerah-21467); [PKPU 8/2024](https://jdih.kpu.go.id/data/data_pkpu/2024pkpu008.pdf)).

## Zurückgezogene Kandidaturen und Parteistrategien

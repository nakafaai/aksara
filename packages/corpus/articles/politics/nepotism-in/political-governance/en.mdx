...
for Experience in Office from Election Eligibility in the Minimum Age Requirements for Presidential
...
build dynastic politics during elections, candidate selection, and decision-making.
...
(Suzeeta & Lewoleba, 2023). The way this regulation was changed therefore raises the possibility of
interference from other parties with different interests. The democratic process that should guide
such a change is no longer followed.

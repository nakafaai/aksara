...
export function verifyConsumer(args: readonly string[]): void {
  ...
  process.stdout.write(
    `Verified ${sourceManifest.name} as an isolated pnpm release consumer.\n`
  );
}

verifyConsumer(process.argv.slice(2));

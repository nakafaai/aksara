...
import { verifyProtectedContentRuntimeExchange } from "#contracts/adoption/protected";
...
/** Runs the original retained-runtime assertions through the adoption seam. */
function verifyProtectedExchange(input: {

...
/** Maximum signed artifacts accepted by one staging request. */
...
/** Maximum ordered release items accepted by one staging request. */
export const MAX_ITEM_BATCH_COUNT = 100;

/** Maximum complete projection batch accepted by publication ingress. */
export const MAX_PROJECTION_BATCH_BYTES = 4 * 1024 * 1024;

/** Maximum canonical projections accepted by one staging request. */
export const MAX_PROJECTION_BATCH_COUNT = 100;

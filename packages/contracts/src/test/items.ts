...
const fixtureReleaseId =
  Schema.decodeSync(ReleaseIdSchema)("test-release-items");

/** Builds one complete upsert change for release-item assertions. */
...
const fixtureChanges = Schema.decodeUnknownSync(
...
export const items = makeReleaseItems(fixtureReleaseId, fixtureChanges);

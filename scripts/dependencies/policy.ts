...
export const DEPENDENCY_HOLDS: readonly DependencyHold[] = [
  {
    approvedCurrent: "4.0.0-rc.112",
    cohort: "Effect",
    dependency: "effect",
    reason: "The signed-content rollout requires the exact RC112 peer cohort.",
    registry: "effect@rc",
    reviewedLatest: "4.0.0-rc.112",
    source: "catalog",
  },
  {
    approvedCurrent: "4.0.0-rc.112",
  ...
  {
    approvedCurrent: "4.1.11",
    cohort: "Effect testing",
    dependency: "vitest",
    reason: "The Effect RC112 test adapter requires Vitest below version 5.",

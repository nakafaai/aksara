...
/** Builds the canonical content-addressed endpoint for one signed hash. */
export function previewArtifactPath(artifactHash: Sha256Hash) {
  return `${ARTIFACT_PREFIX}${encodeURIComponent(artifactHash)}`;
}
